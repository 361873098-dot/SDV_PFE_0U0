...
typedef enum {
    ...
    PICC_APP_TIMESYNC_CLI = 6U, /**< TimeSync client role (ConsumerID: 0x3D) */
    PICC_APP_TIMESYNC_SRV = 7U, /**< TimeSync server role (ProviderID: 0x3F) */
    PICC_APP_SOA      = 8U,   /**< SOA Module          (ProviderID: 0x71) */
    PICC_APP_RSV0     = 9U,   /**< Reserved 0 */
    PICC_APP_RSV1     = 10U,  /**< Reserved 1 */
 ...
 *
 * @param[in] appIndex Application index (e.g., PICC_APP_PWR, PICC_APP_TIMESYNC_CLI).
 ...
 *
 * @param[in]  appIndex    M-Core Application index (e.g., PICC_APP_TIMESYNC_CLI).
