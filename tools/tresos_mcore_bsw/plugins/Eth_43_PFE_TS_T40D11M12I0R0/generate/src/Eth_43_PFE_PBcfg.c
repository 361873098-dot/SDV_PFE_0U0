...
#define ETH_43_PFE_SW_MINOR_VERSION_C               2
...
[!NOCODE!]
    ...
    [!IF "node:empty(../../../EthGeneral/EthVendorSpecific/EthPfeSlaveMode)=false() and (../../../EthGeneral/EthVendorSpecific/EthPfeSlaveMode)='true' or EthVendorSpecific/EthCtrlHwPort='AUX' or EthVendorSpecific/EthCtrlHwPort='HIF0' or EthVendorSpecific/EthCtrlHwPort='HIF1' or EthVendorSpecific/EthCtrlHwPort='HIF2' or EthVendorSpecific/EthCtrlHwPort='HIF3' or EthVendorSpecific/EthCtrlHwPort='HIF_NOCPY'"!]
        [!VAR "MacLayer" = "'INVALID'"!]
    [!ELSE!]
        [!IF "substring-after(EthCtrlMacLayerType, 'ETH_MAC_LAYER_TYPE_') = 'XMII'"!]
            [!IF "EthCtrlMacLayerSubType = 'STANDARD'"!]
...
static const Eth_43_PFE_CtrlCfgType Pfe[!"$ConfigSet"!]_[!"$CtrlConfigName"!] =
{
    ...
    "pfe0", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'EMAC1'"!]
    "pfe1", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'EMAC2'"!]
    "pfe2", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'AUX'"!]
    "aux", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'HIF0'"!]
    "hif0", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'HIF1'"!]
    "hif1", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'HIF2'"!]
    "hif2", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'HIF3'"!]
    "hif3", /**< Port to be attached to the controller */
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthCtrlHwPort = 'HIF_NOCPY'"!]
    "hifnocpy", /**< Port to be attached to the controller */
    [!ENDIF!]
    ...
    [!ENDIF!]
    [!IF "EthVendorSpecific/EthReceiveBroadcast='true'"!]
    ((boolean)TRUE), /**< Reception of broadcast frames is enabled */
    [!ELSE!]
    ((boolean)FALSE),  /**< Reception of broadcast frames is disabled */
    [!ENDIF!]
