...
--------  -----------------  ----------  ----------  ----------  ----------------  --------------------  --------------------  -----------  ------------  -------------------  ---------------------
       ...
       6  RAM(1MB)           0x34400000  0x344FFFFF        1024  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
...
static const uint32 rasr[CPU_MPU_MEMORY_COUNT] = {0x1004003FUL, 0x03080039UL, 0x0308001FUL, 0x130C001BUL, 0x030B001DUL, 0x030B002BUL, 0x030B0027UL, 0x130C0027UL, 0x13040039UL, 0x1304002FUL, 0x13040027UL};
#else
#if defined(CORE0)
...
static const uint32 rasr[CPU_MPU_MEMORY_COUNT] = {0x1004003FUL, 0x03080039UL, 0x0308001FUL, 0x130C001BUL, 0x030B001DUL, 0x030B0027UL, 0x030B0025UL, 0x130C0025UL, 0x13040039UL, 0x1304002FUL, 0x13040027UL};
#elif defined(CORE1)
/* Multiple core approach */
/* Number of entries in the memory tables */
#define CPU_MPU_MEMORY_COUNT (11U)
