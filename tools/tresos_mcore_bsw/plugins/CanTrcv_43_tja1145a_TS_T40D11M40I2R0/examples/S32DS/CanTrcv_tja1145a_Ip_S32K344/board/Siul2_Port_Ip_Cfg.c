...
- pin_list:
  - {pin_num: M16, peripheral: CAN0, signal: can0_tx, pin_signal: PTA7, pullSelect: pullDown, InitValue: state_0}
  ...
  - {pin_num: J17, peripheral: LPSPI1, signal: lpspi1_sck, pin_signal: PTB14, direction: OUTPUT}
  - {pin_num: J16, peripheral: LPSPI1, signal: lpspi1_sin, pin_signal: PTB15, direction: INPUT}
  - {pin_num: K17, peripheral: LPSPI1, signal: lpspi1_sout, pin_signal: PTB16, direction: OUTPUT}
  - {pin_num: K16, peripheral: LPSPI1, signal: lpspi1_pcs3, pin_signal: PTB17, direction: OUTPUT}
