...
typedef struct
{
    ...
    uint8                           instanceNo;
    /** @brief Index in the Ftm IP specific configuration table - aligned to respect Misra 11.5 */
    const Ftm_Icu_Ip_ChannelConfigType    *pFtmHwChannelConfig;
...
typedef struct
{
    ...
    uint8                   instanceNo;
    /** @brief Pointer to Ftm IP specific configuration aligned to respect MISRA 11.5 */
    const Ftm_Icu_Ip_ConfigType   *pFtmHwIpConfig;
