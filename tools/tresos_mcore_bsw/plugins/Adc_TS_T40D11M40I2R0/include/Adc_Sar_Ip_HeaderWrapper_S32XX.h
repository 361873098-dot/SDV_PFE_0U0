...
#define ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_HEADERWRAPPER_S32XX       4
#define ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_HEADERWRAPPER_S32XX    0
#define ADC_SAR_IP_SW_MAJOR_VERSION_HEADERWRAPPER_S32XX               4
#define ADC_SAR_IP_SW_MINOR_VERSION_HEADERWRAPPER_S32XX               0
#define ADC_SAR_IP_SW_PATCH_VERSION_HEADERWRAPPER_S32XX               2

/*==================================================================================================
*                                     DEFINITIONS
==================================================================================================*/

#define ADC_SAR_IP_DEF_SAMPLE_TIME            (0x14U) /* Default values for sample time. */
...
#define FEATURE_ADC_HAS_CLKSEL_EXTENDED       (0U)
#define FEATURE_ADC_SAR_DECODE_DELAY          (0U)
#define FEATURE_ADC_HAS_AVERAGING             (0U)
#define FEATURE_ADC_SAR_W1C_ABORT             (0U)
#define FEATURE_ADC_HAS_TEMPSENSE_CHN         (0U)
#define FEATURE_ADC_SELFTEST_FULL_CLK         (1U)
...
#define FEATURE_ADC_FEAT_AVAIL_BITMAP   {0x00000006U, /* 0 */ \
                                         0x00000006U, /* 1 */ \
                                        }
#else
                                      /* 31-28   3-0  63-60  35-32 95-92  67-64
