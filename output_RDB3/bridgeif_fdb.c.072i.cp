...
bridgeif_age_tmr.part.0/10 (bridgeif_age_tmr.part.0) @06f00620
...
sys_timeout/9 (sys_timeout) @070a5460
  Type: function
  ...
  Called by: bridgeif_fdb_init/5 (23032 (estimated locally),0.17 per call) bridgeif_age_tmr.part.0/10 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
mem_calloc/8 (mem_calloc) @070a5380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  Availability: not_available
  Function flags: optimize_size
  Called by: bridgeif_fdb_init/5 (27247 (estimated locally),0.20 per call) 
  Calls: 
memcpy/7 (memcpy) @070a50e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
memcmp/6 (memcmp) @070a5000
  ...
  Calls: 
bridgeif_fdb_init/5 (bridgeif_fdb_init) @06faee00
  Type: function definition analyzed
  ...
  Called by: 
  Calls: sys_timeout/9 (23032 (estimated locally),0.17 per call) mem_calloc/8 (27247 (estimated locally),0.20 per call) 
bridgeif_age_tmr/4 (bridgeif_age_tmr) @06faea80
  Type: function definition analyzed
...
bridgeif_fdb_age_one_second/3 (bridgeif_fdb_age_one_second) @06fae7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
  ...
  Calls: 
bridgeif_fdb_get_dst_ports/2 (bridgeif_fdb_get_dst_ports) @06fae540
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
bridgeif_fdb_update_src/1 (bridgeif_fdb_update_src) @06fae2a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function bridgeif_age_tmr (bridgeif_age_tmr, funcdef_no=4, decl_uid=6638, cgraph_uid=5, symbol_order=4)
...
;; Function bridgeif_fdb_update_src (bridgeif_fdb_update_src, funcdef_no=1, decl_uid=6448, cgraph_uid=2, symbol_order=1)
...
;; Function bridgeif_fdb_get_dst_ports (bridgeif_fdb_get_dst_ports, funcdef_no=2, decl_uid=6451, cgraph_uid=3, symbol_order=2)
...
;; Function bridgeif_fdb_init (bridgeif_fdb_init, funcdef_no=5, decl_uid=6453, cgraph_uid=6, symbol_order=5)
...
bridgeif_fdb_init (u16_t max_fdb_entries)
{
  ...
  # DEBUG BEGIN_STMT
  alloc_len_9 = (mem_size_t) alloc_len_sizet_8;
  # DEBUG alloc_len => alloc_len_9
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  _16 = alloc_len_sizet_8 & 65535;
  if (alloc_len_sizet_8 != _16)
    goto <bb 7>; [79.76%]
  else
    goto <bb 4>; [20.24%]
  ...
  <bb 6> [local count: 27247]:
  # _4 = PHI <0B(4), fdb_12(5)>
  return _4;
