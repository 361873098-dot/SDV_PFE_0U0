...
#define LINFLEXD_UART_IP_CFG_SW_PATCH_VERSION              2
...
extern void Uart_Ipw_Callback(const uint8 HwInstance,const Linflexd_Uart_Ip_EventType Event, void* UserData);
