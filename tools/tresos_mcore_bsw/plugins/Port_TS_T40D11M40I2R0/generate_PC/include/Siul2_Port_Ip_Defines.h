...
/** SIUL2_1 */
/** Peripheral PORTH base pointer */
#define PORTH                            ((Siul2_Port_Ip_PortType *)(SIUL2_1_MSCR_BASE + 0x60))
/** Peripheral PORTJ base pointer */
#define PORTJ                            ((Siul2_Port_Ip_PortType *)(SIUL2_1_MSCR_BASE + 0x70))
/** Peripheral PORTK base pointer */
#define PORTK                            ((Siul2_Port_Ip_PortType *)(SIUL2_1_MSCR_BASE + 0x80))
[!ENDIF!][!//
