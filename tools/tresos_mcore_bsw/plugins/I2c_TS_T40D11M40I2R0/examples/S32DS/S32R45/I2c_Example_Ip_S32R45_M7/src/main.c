...
int main(void)
{
    ...
    IntCtrl_Ip_EnableIrq(I2C0_IRQn);
	IntCtrl_Ip_InstallHandler(I2C0_IRQn, I2c_Ip_IRQHandler0, NULL_PTR);
	IntCtrl_Ip_EnableIrq(I2C1_IRQn);
	IntCtrl_Ip_InstallHandler(I2C1_IRQn, I2c_Ip_IRQHandler1, NULL_PTR);
