...
IntCtrl_Ip_InstallHandler/17 (IntCtrl_Ip_InstallHandler) @075a98c0
  Type: function
  ...
  Calls: 
IntCtrl_Ip_GetPriority/16 (IntCtrl_Ip_GetPriority) @075a9620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
IntCtrl_Ip_SetPriority/15 (IntCtrl_Ip_SetPriority) @075a9380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
IntCtrl_Ip_DisableIrq/14 (IntCtrl_Ip_DisableIrq) @075a90e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
IntCtrl_Ip_EnableIrq/13 (IntCtrl_Ip_EnableIrq) @075a9000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: Platform_Ipw_SetIrq/1 (536870913 (estimated locally),0.50 per call) 
  Calls: 
Platform_Ipw_Init/12 (Platform_Ipw_Init) @075a18c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Platform_Config/11 (Platform_Config) @075a7288
  Type: variable
...
Det_ReportError/10 (Det_ReportError) @075a1620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Platform_InstallIrqHandler/9 (Platform_InstallIrqHandler) @075a1d20
...
Platform_GetIrqPriority/8 (Platform_GetIrqPriority) @075a1a80
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Platform_SetIrqPriority/7 (Platform_SetIrqPriority) @075a17e0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Platform_SetIrq/6 (Platform_SetIrq) @075a1540
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Platform_Init/5 (Platform_Init) @075a12a0
  Type: function definition analyzed
  Visibility: externally_visible public
...
Platform_Ipw_SetIrq/1 (Platform_Ipw_SetIrq) @0759d1c0
  Type: function definition analyzed
...
;; Function Platform_Init (Platform_Init, funcdef_no=5, decl_uid=6265, cgraph_uid=6, symbol_order=5)
...
;; Function Platform_SetIrq (Platform_SetIrq, funcdef_no=6, decl_uid=6268, cgraph_uid=7, symbol_order=6)
...
;; Function Platform_SetIrqPriority (Platform_SetIrqPriority, funcdef_no=7, decl_uid=6271, cgraph_uid=8, symbol_order=7)
...
;; Function Platform_GetIrqPriority (Platform_GetIrqPriority, funcdef_no=8, decl_uid=6274, cgraph_uid=9, symbol_order=8)
...
;; Function Platform_InstallIrqHandler (Platform_InstallIrqHandler, funcdef_no=9, decl_uid=6278, cgraph_uid=10, symbol_order=9)
