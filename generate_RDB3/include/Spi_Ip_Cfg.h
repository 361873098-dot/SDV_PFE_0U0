...
/* Check if Spi_Ip_VS_0_PBcfg header file and Spi configuration header file are of the same vendor */
#if (SPI_IP_VS_0_VENDOR_ID_PBCFG != SPI_IP_VENDOR_ID_CFG)
    #error "Spi_Ip_VS_0_PBcfg.h and Spi_Ip_Cfg.h have different vendor IDs"
#endif
    /* Check if Spi_Ip_VS_0_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((SPI_IP_VS_0_AR_RELEASE_MAJOR_VERSION_PBCFG != SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (SPI_IP_VS_0_AR_RELEASE_MINOR_VERSION_PBCFG != SPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (SPI_IP_VS_0_AR_RELEASE_REVISION_VERSION_PBCFG != SPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Spi_Ip_VS_0_PBcfg.h and Spi_Ip_Cfg.h are different"
#endif
/* Check if Spi_Ip_VS_0_PBcfg header file and Spi configuration header file are of the same software version */
#if ((SPI_IP_VS_0_SW_MAJOR_VERSION_PBCFG != SPI_IP_SW_MAJOR_VERSION_CFG) || \
     (SPI_IP_VS_0_SW_MINOR_VERSION_PBCFG != SPI_IP_SW_MINOR_VERSION_CFG) || \
     (SPI_IP_VS_0_SW_PATCH_VERSION_PBCFG != SPI_IP_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Spi_Ip_VS_0_PBcfg.h and Spi_Ip_Cfg.h are different"
#endif
...
*/
#define SPI_IP_REG_PROT_AVAILABLE   (STD_ON)
