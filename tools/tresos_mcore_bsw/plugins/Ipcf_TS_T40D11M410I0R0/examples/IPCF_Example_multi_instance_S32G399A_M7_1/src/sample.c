...
void shm_demo(void)
{
	...
	/* application: echo reply for every message received using polling method */
	while (1) {

		/* wait for incoming message by using polling method */
		while (app.tx_count == app.rx_count)
