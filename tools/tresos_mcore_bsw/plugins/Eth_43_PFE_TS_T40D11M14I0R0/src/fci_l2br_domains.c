...
static errno_t fci_l2br_domain_cmd_register(const fci_t *fci_context, uint16_t *fci_ret, fpp_l2_bd_cmd_t *bd_cmd);
static errno_t fci_l2br_domain_cmd_deregister(const fci_t *fci_context, uint16_t *fci_ret, fpp_l2_bd_cmd_t *bd_cmd);
static errno_t fci_l2br_domain_cmd_update_check_if_list(pfe_l2br_domain_t *domain, const fci_t *fci_context, uint32_t session_id, uint16_t *fci_ret,const fpp_l2_bd_cmd_t *bd_cmd);
static errno_t fci_l2br_domain_cmd_update_set_action(pfe_l2br_domain_t **domain, const fci_t *fci_context, uint16_t *fci_ret, const fpp_l2_bd_cmd_t *bd_cmd);
static errno_t fci_l2br_domain_cmd_query_cont_build_repply_buf(pfe_l2br_domain_t *domain, fpp_l2_bd_cmd_t **bd_cmd, uint16_t *fci_ret, fpp_l2_bd_cmd_t *reply_buf, const fci_t *fci_context);
static errno_t update_domain_if(pfe_l2br_domain_t *domain, pfe_phy_if_t *phy_if, const fpp_l2_bd_cmd_t *bd_cmd, bool_t tag, uint32_t ii);
static errno_t remove_if_from_domain(pfe_l2br_domain_t *domain, uint16_t *fci_ret, const fpp_l2_bd_cmd_t *bd_cmd, uint32_t ii);
static void revert_domain_creation(uint16_t *fci_ret, const fpp_l2_bd_cmd_t *bd_cmd, pfe_l2br_domain_t **domain);
static errno_t l2br_static_entry_cmd_fpp_action_register(uint16_t *fci_ret, fpp_l2_static_ent_cmd_t *br_ent_cmd);
static errno_t l2br_static_entry_cmd_fpp_action_update(uint16_t *fci_ret, fpp_l2_static_ent_cmd_t *br_ent_cmd);
static errno_t l2br_static_entry_cmd_fpp_action_deregister(uint16_t *fci_ret, fpp_l2_static_ent_cmd_t *br_ent_cmd);
static errno_t l2br_static_entry_cmd_fpp_action_query_cont(uint16_t *fci_ret, fpp_l2_static_ent_cmd_t *reply_buf, uint32_t *reply_len, fpp_l2_static_ent_cmd_t *br_ent_cmd, pfe_l2br_static_entry_t *entry);
static errno_t process_l2br_command(uint16_t *fci_ret, fpp_l2_bd_cmd_t *reply_buf, uint32_t *reply_len, fpp_l2_bd_cmd_t *bd_cmd, uint32_t session_id);
static errno_t fci_l2br_domain_cmd_update(const fci_t *fci_context, uint32_t session_id, uint16_t *fci_ret, fpp_l2_bd_cmd_t *bd_cmd);
