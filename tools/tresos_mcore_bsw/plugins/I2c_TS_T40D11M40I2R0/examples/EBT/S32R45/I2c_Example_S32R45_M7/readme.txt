1. Example Description
    ...
    The application includes an EB Tresos project that configures the BaseNXP Det Dem Rte Platform Os Mcu I2c Resource drivers.
    1.1 The application software functionality
            ...
            The application will initialize two I2C instances, one initialize as master and the other as slave. The master initiate a send transfer on the I2C bus. After the transfer is completed, and both master and slave are idle, the rx buffer 
            of the slave is checked against the master tx buffer.
2. Installation steps
    2.1 Hardware installation
        ...
        2.2.2 Connections
            - SCL: J36.1 - J37.1
            - SDA: J36.3 - J37.3
            - 1 pull up resistor of 4.7KOhms between SCL and VDD and 1 pull up resistor between SDA and VDD               
        2.2.3 Debugger
