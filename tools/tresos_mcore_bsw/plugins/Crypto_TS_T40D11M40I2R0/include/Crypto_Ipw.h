...
#define CRYPTO_SW_MAJOR_VERSION_IPW_H                4
...
#define    Crypto_Ipw_CheckKey(partitionId,                                             keyIdx) \
          (Crypto_Hse_CheckKey(Crypto_aPartitionToMuMapping[partitionId].u8MuInstance, keyIdx))
