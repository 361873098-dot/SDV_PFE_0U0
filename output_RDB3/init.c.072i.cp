...
sys_timeouts_init/10 (sys_timeouts_init) @0665c1c0
  Type: function
...
dns_init/9 (dns_init) @0665c0e0
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
igmp_init/8 (igmp_init) @0665c000
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
udp_init/6 (udp_init) @071eeee0
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
netif_init/5 (netif_init) @071eee00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
memp_init/4 (memp_init) @071eed20
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
mem_init/3 (mem_init) @071eec40
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
stats_init/2 (stats_init) @071eeb60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
lwip_init/1 (lwip_init) @071ee700
...
;; Function lwip_init (lwip_init, funcdef_no=1, decl_uid=6380, cgraph_uid=2, symbol_order=1)
