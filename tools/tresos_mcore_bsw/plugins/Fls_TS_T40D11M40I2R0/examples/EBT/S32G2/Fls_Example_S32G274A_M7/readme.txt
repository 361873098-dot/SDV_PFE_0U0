1. Example Description
    ...
    The application includes an EB Tresos project that configures the Mcu, Rm, Base, Dem, EcuC, Os, Fls, Rte, Memif and Resource drivers.
    ...
    1.1 The application software functionalities
            - Mcu_Init
                    ...
                    + QSPI_2X_CLK = 400 MHz
                    + QSPI_1X_CLK = QSPI_2X_CLK/2 = 200 MHz
...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - RDB2 boards: S32G-VNP-RDB2 PCB 47440 RevE SCH RevE
        2.2.2 Connections
            - None.
        2.2.3 Debugger
