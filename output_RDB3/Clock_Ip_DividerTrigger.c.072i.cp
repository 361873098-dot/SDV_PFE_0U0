...
Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat.part.0/9 (Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat.part.0) @071ea700
...
Clock_Ip_ReportClockErrors/8 (Clock_Ip_ReportClockErrors) @071e5380
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/7 (Clock_Ip_TimeoutExpired) @071e52a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/6 (Clock_Ip_StartTimeout) @071e51c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  Availability: not_available
  Function flags: optimize_size
  Called by: Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat/2 (114863532 (estimated locally),0.23 per call) 
  Calls: 
Clock_Ip_apxCgm/5 (Clock_Ip_apxCgm) @0716ef30
  Type: variable
...
Clock_Ip_au8ClockFeatures/4 (Clock_Ip_au8ClockFeatures) @0716eee8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axDividerTriggerCallbacks/3 (Clock_Ip_axDividerTriggerCallbacks) @0716e9d8
...
Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat/2 (Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat) @0716dee0
  Type: function definition analyzed
  ...
  Availability: available
  Function flags: count:497244728 (estimated locally) body optimize_size
  Called by: 
  Calls: Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat.part.0/9 (37904965 (estimated locally),0.08 per call) Clock_Ip_TimeoutExpired/7 (1073741824 (estimated locally),2.16 per call) Clock_Ip_StartTimeout/6 (114863532 (estimated locally),0.23 per call) 
Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat/1 (Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat) @0716db60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_Callback_DividerTriggerEmpty/0 (Clock_Ip_Callback_DividerTriggerEmpty) @0716d8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_Callback_DividerTriggerEmpty (Clock_Ip_Callback_DividerTriggerEmpty, funcdef_no=0, decl_uid=6784, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat (Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat, funcdef_no=1, decl_uid=6786, cgraph_uid=2, symbol_order=1)
...
;; Function Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat (Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat, funcdef_no=2, decl_uid=6788, cgraph_uid=3, symbol_order=2)
...
Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat (const struct Clock_Ip_DividerTriggerConfigType * Config)
{
  ...
  # TimeoutOccurred_3 = PHI <TimeoutOccurred_20(5), TimeoutOccurred_20(6)>
  # DEBUG BEGIN_STMT
