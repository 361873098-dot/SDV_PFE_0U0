...
#define SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MAJOR_VERSION_PBCFG_C                 4
#define SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MINOR_VERSION_PBCFG_C                 0
#define SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_PBCFG_C                 2
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
#if (SPI_IP_VENDOR_ID_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_VENDOR_ID_PBCFG_C)
...
#if ((SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_AR_RELEASE_MAJOR_VERSION_PBCFG_C) || \
     (SPI_IP_AR_RELEASE_MINOR_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_AR_RELEASE_MINOR_VERSION_PBCFG_C) || \
     (SPI_IP_AR_RELEASE_REVISION_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_AR_RELEASE_REVISION_VERSION_PBCFG_C))
#error "AutoSar Version Numbers of Spi_Ip_Cfg.h and Spi_Ipw_PBcfg.c are different"
#endif
#if ((SPI_IP_SW_MAJOR_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MAJOR_VERSION_PBCFG_C) || \
     (SPI_IP_SW_MINOR_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MINOR_VERSION_PBCFG_C) || \
     (SPI_IP_SW_PATCH_VERSION_CFG != SPI_IPW[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_PBCFG_C))
...
[!CODE!][!//
/* Spi_Ipw_HwUnitDmaFastCfg_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] Dma Fast transfer Configuration */
#ifdef LPSPI_IP_LLCE_SUPPORT
#if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
...
[!CODE!][!//
/* Spi_Ipw_HwUnitDmaFastCfg_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] Dma Fast transfer Configuration */
static Spi_Ip_FastTransferType Spi_Ipw_HwUnitDmaFastCfg_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][[!"num:i(SpiMaxDmaFastTransfer)"!]U];
[!ENDCODE!][!//
[!ENDIF!]
[!ENDIF!]
[!ENDLOOP!]
...
[!CODE!][!//
        ...
        {   /* ExternalDeviceConfig */
            NULL_PTR /* Don't have SPI ExternalDeviceConfig */
#ifdef LPSPI_IP_LLCE_SUPPORT
#if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
        ...
        [!ELSE!]
        {   /* ExternalDeviceConfig */
            &Spi_Ip_DeviceAttributes_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] /* SPI ExternalDeviceConfig */
#ifdef LPSPI_IP_LLCE_SUPPORT
#if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
...
[!ENDCODE!][!//
            [!IF "contains(node:value(SpiPhyUnitMapping),'LPSPI')"!]
[!CODE!][!//
            NULL_PTR /* Don't have Ipconfig of Spi */
#ifdef LPSPI_IP_LLCE_SUPPORT
#if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
...
[!ENDCODE!][!//
            [!ELSE!]
[!CODE!][!//          
            &Spi_Ip_PhyUnitConfig_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] /* SPI IpConfig */
#ifdef LPSPI_IP_LLCE_SUPPORT
#if (STD_ON == LPSPI_IP_LLCE_SUPPORT)
...
#endif
            #if ((SPI_IPW_DMA_USED == STD_ON) && (SPI_IPW_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
            ,[!IF "node:exists(SpiMaxDmaFastTransfer)"!]Spi_Ipw_HwUnitDmaFastCfg_[!"@name"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!ELSE!]NULL_PTR[!ENDIF!]
            #endif
[!ENDCODE!][!//
            [!ENDIF!]
[!CODE!][!//
