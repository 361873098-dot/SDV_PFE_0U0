...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - S32G-PROCEVB-S PCB RevX3 SCH RevB1 (Daughtercard)
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - GCC_DIR The path to the GCC installation dir
                Ex: GCC_DIR = C:/NXP.x.y/S32DS/S32DS/build_tools/gcc_vx.y/gcc-x.y-arm32-eabi
            ...
            - ADDITIONAL_INCLUDE_DIRS The list of directories in the 'interface' folder of the HSE Firmware release that was used to test the current version of the Crypto driver.
                ...
                Ex: ADDITIONAL_INCLUDE_DIRS = C:/NXP/HSE_FW_S32G3XX_x_y_z_0/interface \
                                              C:/NXP/HSE_FW_S32G3XX_x_y_z_0/interface/config \
                                              C:/NXP/HSE_FW_S32G3XX_x_y_z_0/interface/inc_common \
                                              C:/NXP/HSE_FW_S32G3XX_x_y_z_0/interface/inc_custom \
                                              C:/NXP/HSE_FW_S32G3XX_x_y_z_0/interface/inc_services
