...
#ifndef FLEXRAY_43_LLCE_IP_H
#define FLEXRAY_43_LLCE_IP_H
...
#define FLEXRAY_43_LLCE_IP_MODULE_ID                        81
#define FLEXRAY_43_LLCE_IP_VENDOR_ID                        43
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION         4
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION         4
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION      0
#define FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION                 1
#define FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION                 0
#define FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION                 7

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same vendor */
#if (FLEXRAY_43_LLCE_IP_VENDOR_ID != FLEXRAY_IP_TYPES_VENDOR_ID)
    #error "Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Types.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same Autosar version */
#if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION    != FLEXRAY_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION    != FLEXRAY_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION != FLEXRAY_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "Software Version Numbers of Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Types.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same software version */
#if ((FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION != FLEXRAY_IP_TYPES_SW_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION != FLEXRAY_IP_TYPES_SW_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION != FLEXRAY_IP_TYPES_SW_PATCH_VERSION) \
    )
    #error "Autosar Version Numbers of Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Types.h are different"
#endif

/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same vendor */
#if (FLEXRAY_43_LLCE_IP_VENDOR_ID != FLEXRAY_IP_CFG_VENDOR_ID)
    #error "Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Cfg.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same Autosar version */
#if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION    != FLEXRAY_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION    != FLEXRAY_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION != FLEXRAY_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "Software Version Numbers of Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Cfg.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same software version */
#if ((FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION != FLEXRAY_IP_CFG_SW_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION != FLEXRAY_IP_CFG_SW_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION != FLEXRAY_IP_CFG_SW_PATCH_VERSION) \
    )
    #error "Autosar Version Numbers of Flexray_43_LLCE_Ip.h and Flexray_43_LLCE_Ip_Cfg.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and StandardTypes.h header file are of the same Autosar version */
    #if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION != STD_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION != STD_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.h and StandardTypes.h are different"
    #endif
    /* Check if current file and SchM_Fr.h header file are of the same Autosar version */
    #if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION != SCHM_FR_43_LLCE_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION != SCHM_FR_43_LLCE_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.h and SchM_Fr_43_LLCE.h are different"
    #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
==================================================================================================*/
    ...
    #define FLEXRAY_43_LLCE_STRINGENT_MASK_A  0x0080U
    #define FLEXRAY_43_LLCE_STRINGENT_MASK_B  0x8000U
#else
    #define FLEXRAY_43_LLCE_STRINGENT_MASK_A  0x008EU
    #define FLEXRAY_43_LLCE_STRINGENT_MASK_B  0x8E00U
#endif

/* Number of instances of the FLEXRAY module - infix based */
#   define FLEXRAY_43_LLCE_INSTANCE_COUNT (1U)

/* FLEXRAY - Peripheral instance base addresses */
/** Peripheral FR_0 base address */
#define IP_FR_LLCE_0_BASE                       (0x43C10000u)
/** Peripheral FR_0 base pointer */
#define IP_FR_LLCE_0                            ((FLEXRAY_Type *)IP_FR_LLCE_0_BASE)
/** Array initializer of FLEXRAY peripheral base pointers */
#define IP_FLEXRAY_LLCE_BASE_PTRS                    { IP_FR_LLCE_0 }
/*==================================================================================================
...
extern FLEXRAY_Type * const Flexray_43_LLCE_Ip_apxBase[FLEXRAY_43_LLCE_INSTANCE_COUNT];
 ...
 */
void Flexray_43_LLCE_Ip_SetProtocolInterrupt(uint8 instNum,
 ...
 */
boolean Flexray_43_LLCE_Ip_GetProtocolInterruptFlag(uint8 instNum,
                                         Flexray_Ip_ProtocolIntType pInt);
 ...
 * @param[in] pInt      The protocol interrupt
 */
void Flexray_43_LLCE_Ip_ClearProtocolInterruptFlag(uint8 instNum,
                                            Flexray_Ip_ProtocolIntType pInt);
/*!
 ...
 * @return true if flag is raised; false if flag isn't raised.
 */
boolean Flexray_43_LLCE_Ip_GetGlobalInterruptFlag(uint8 instNum,
 ...
 * @param[in] enable  true if enabled; false if disabled
 */
void Flexray_43_LLCE_Ip_SetGlobalInterrupt(uint8 instNum,
                                   Flexray_Ip_GlobalIntType gInt,
                                   boolean enable);
/*!
 ...
 * @param[in] gInt    The global interrupt
 */
void Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(uint8 instNum,
                                          Flexray_Ip_GlobalIntType gInt);
 ...
 * @return true if flag is raised; false if flag isn't raised.
 */
boolean Flexray_43_LLCE_Ip_GetCHIInterruptFlag(uint8 instNum,
 ...
 * @param[in] cInt:    The chi interrupt
 */
void Flexray_43_LLCE_Ip_ClearCHIInterruptFlag(uint8 instNum,
                                       Flexray_Ip_ChiIntType cInt);
 ...
 */
void Flexray_43_LLCE_Ip_SetStatusMonitorSlot(uint8 instNum,
                                      uint8 monitorIndex,
                                      uint16 slotNumber);
 ...
 */
uint8 Flexray_43_LLCE_Ip_GetStatusMonitor(uint8 instNum,
                                     uint8 monitorIndex,
                                     boolean channelA,
                                     boolean evenCycle);
 ...
 */
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReceiveFIFO(uint8 instNum,
                                 boolean channel,
                                 Flexray_Ip_FrameHeaderType* frameHdr,
                                 uint8* pData,
                                 uint8 dataLength);
 ...
 */
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetTransferStatus(uint8 instNum,
                                       uint8 bufferId);
/*!
...
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_SetWakeupChannel( uint8 instNum, boolean bChnA, boolean bChnB );
 ...
 */
void Flexray_43_LLCE_Ip_SetBasicDynamicTxFrame(uint8 instNum, uint8 bufferId, boolean PPI, uint8 payloadLength);
 ...
 */
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReConfigIndividual(uint8 instNum,
 ...
 */
uint8 Flexray_43_LLCE_Ip_GetFifoLevel(uint8 instNum,
                              boolean isChnB);


/*  FLEXRAY_AUTOSAR_MODE_USED */
void Flexray_43_LLCE_Ip_GetPocStatus(uint8 instNum, uint16* data);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_CheckCCAccess(uint8 instNum, boolean Fr_CC_enabled, uint16 regMVR);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ClearDisableIRQs( uint8 instNum);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetGlobalTime( uint8 instNum, uint8* cyclePtr, uint16* macroTickPtr);
void Flexray_43_LLCE_Ip_GetChannelStatus( uint8 instNum, uint16* channelAStatusPtr, uint16* channelBStatusPtr);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetClockCorrection( uint8 instNum, sint16* rateCorrectionPtr, sint32* offsetCorrectionPtr);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetSyncFrameList( uint8 instNum, const Flexray_Ip_ConfigType * config, uint8 listSize, uint16* channelAEvenListPtr, uint16* channelBEvenListPtr, uint16* channelAOddListPtr, uint16* channelBOddListPtr);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetNumOfStartFrames( uint8 instNum, uint8* numOfStartupFramesPtr);
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReadbackCCConfig(uint8 instNum, const Flexray_Ip_PeConfigType* peConfig);
