...
*                                       LOCAL MACROS
==================================================================================================*/
#define LINFLEXD_LIN_INSTANCE (2U)
...
int main(void)
{
    ...
    Linflexd_Lin_Ip_Init(Linflexd_Lin_Ip_Sa_pHwConfigPB_0.Instance, &Linflexd_Lin_Ip_Sa_pHwConfigPB_0);

    /* Start of the sending frame */
    (void)Linflexd_Lin_Ip_SendFrame(Linflexd_Lin_Ip_Sa_pHwConfigPB_0.Instance, LinflexdPdu);
    ...
    do
    {
        LinflexdMasterStatus = Linflexd_Lin_Ip_GetStatus(Linflexd_Lin_Ip_Sa_pHwConfigPB_0.Instance, (uint8 **)&DummyBuffer);
    }
    while ((LINFLEXD_LIN_IP_STATUS_TX_OK != LinflexdMasterStatus) && (TimeoutValue-- > 1));
    
    /* Linflexd over Lin driver de-initialization*/
    Linflexd_Lin_Ip_Deinit(Linflexd_Lin_Ip_Sa_pHwConfigPB_0.Instance);

    /* Check if all the frames have been sent */
    Exit_Example(LINFLEXD_LIN_IP_STATUS_TX_OK == LinflexdMasterStatus);
