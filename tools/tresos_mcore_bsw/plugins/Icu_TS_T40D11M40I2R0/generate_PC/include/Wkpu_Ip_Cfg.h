...
#define WKPU_IP_CFG_SW_PATCH_VERSION                2
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
/* Check if Icu configuration header file and header file are of the same vendor */
#if (WKPU_IP_CFG_VENDOR_ID != WKPU_IP_[!"."!]_PBCFG_VENDOR_ID)
    #error "Wkpu_Ip_Cfg.h and Wkpu_Ip_[!"."!]_PBcfg.h have different vendor IDs"
#endif
/* Check if Icu configuration header file and header file are of the same Autosar version */
...
#endif
/* Check if Icu configuration header file and header file are of the same software version */
...
#endif
/* Check Icu configuration header file and header file are of the same Autosar version */
