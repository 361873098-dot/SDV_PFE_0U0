1. Example Description
    ...
    The application includes an EB Tresos project that configures the Base, EcuC, Fls, Mcu, Port, Resource, Rm module
    The Qspi region uses the default configuration by Platform: Normal type and Non-cache. The user can reconfigure this region to device-shared by setting the value of the FLS_CONFIG_QSPI_REGION_DEVICE_SHARE macro to STD_ON

    The application shows the user how to initialize the QuadSPI module and the S71KL512SC0 512Mb hyper flash memory chip to work in DDR mode at 200 MHz.

    1.1 The application software functionalities
            - Mcu_Init
                    Initialize the clock sources, the clock tree and to configure the clock gating of the peripherals.
                    Configure the QSPI_2X_CLK to 200 MHz.
            - If the value of the FLS_CONFIG_QSPI_REGION_DEVICE_SHARE macro is STD_ON
                Rm_Init
                    Initialize the RM CDD to use MPU M7 to configure the QSPI AHB address space as device memory. This prevents speculative reads in this region.
            - Port_Init
                    Initialize the pins which are used by application.
            - Fls_Init
                    Initialize the Fls driver.
                    Configure the QuadSPI controller to DDR mode with external DQS
...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - S32G2 silicon on XS32G_DDR3_FVB boards
        2.2.2 Connections
            - None.
        2.2.3 Debugger
