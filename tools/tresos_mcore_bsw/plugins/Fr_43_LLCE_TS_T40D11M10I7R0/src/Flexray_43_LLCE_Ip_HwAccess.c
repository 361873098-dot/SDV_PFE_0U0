...
/**
*   @file Flexray_43_LLCE_Ip_HwAccess.c
*
...
#define FLEXRAY_IP_HWACCESS_SW_MAJOR_VERSION_C                 1
#define FLEXRAY_IP_HWACCESS_SW_MINOR_VERSION_C                 0
#define FLEXRAY_IP_HWACCESS_SW_PATCH_VERSION_C                 7
...
/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same vendor */
    ...
    #error "Flexray_43_LLCE_Ip_HwAccess.c and Flexray_43_LLCE_Ip_HwAccess.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip_HwAccess.c and Flexray_43_LLCE_Ip_HwAccess.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same software version */
    ...
    #error "Software Version Numbers of Flexray_43_LLCE_Ip_HwAccess.c and Flexray_43_LLCE_Ip_HwAccess.h are different"
#endif
        ...
        /* Check if current file and Devassert.h header file are of the same Autosar version */
            ...
            #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip_HwAccess.c and Devassert.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
/*FUNCTION**********************************************************************
 *
 * Function Name : FLEXRAY_43_LLCE_InitPE
...
{
    FLEXRAY_Type* base = Flexray_43_LLCE_Ip_apxBase[instNum];
...
/*FUNCTION**********************************************************************
 *
 * Function Name : FLEXRAY_43_LLCE_SetFiFoRangeFilter
...
/*FUNCTION**********************************************************************
 *
 * Function Name : FLEXRAY_43_LLCE_ConfigureTimer1
...
/*FUNCTION**********************************************************************
 *
 * Function Name : FLEXRAY_43_LLCE_ConfigureTimer2
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Flexray_43_LLCE_PackMessageBufferHeader
...
{
    Flexray_43_LLCE_calCrc(pFrameHdr->payloadLength, pFrameHdr->frameID, FALSE, FALSE, &(pFrameHdr->headerCrc));
    ...
    (*pHeaderData)[2] = pFrameHdr->payloadLength;
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Flexray_43_LLCE_UnpackMessageBufferHeader
...
void Flexray_43_LLCE_UnpackMessageBufferHeader (Flexray_43_LLCE_Ip_HeaderDataType * pHeaderData, Flexray_Ip_FrameHeaderType* pFrameHdr)
{
    ...
    pFrameHdr->payloadLength = (*pHeaderData)[2];
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Flexray_43_LLCE_calCrc
