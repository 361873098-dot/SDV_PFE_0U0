...
#define SWT_43_INSTANCE1_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C              4
#define SWT_43_INSTANCE1_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C              0
#define SWT_43_INSTANCE1_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C              2
...
const Swt_Ip_ConfigType Swt_Ip_OffModeSettings_1[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]=
{
    ...
    (Swt_Ip_LockType) [!IF "node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgSettingsConfig/WdgSettingsOff/WdgSoftLockConfiguration)"!]SWT_IP_SOFTLOCK[!/*
                            */!][!ELSEIF "node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgSettingsConfig/WdgSettingsOff/WdgHardLockConfiguration)"!]SWT_IP_HARDLOCK[!/*
...
{
[!CALL "WdgModeConfig","WdgMode" = "'WdgSettingsSlow'","WdgNo" = "'_43_Instance1'"!]
...
{
[!CALL "WdgModeConfig","WdgMode" = "'WdgSettingsFast'","WdgNo" = "'_43_Instance1'"!]
    [!IF "$WdgCbkFunc != 'NULL_PTR'"!]
    (Swt_CallbackPtrType) &[!"$WdgCbkFunc"!]      /* pfSwtCallback */
    [!ELSE!]
    NULL_PTR     /* pfSwtCallback */
