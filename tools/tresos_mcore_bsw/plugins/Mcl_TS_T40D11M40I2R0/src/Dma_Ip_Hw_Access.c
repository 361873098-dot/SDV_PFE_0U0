...
#define DMA_IP_HW_ACCESS_SW_PATCH_VERSION_C                2
...
#if (STD_ON == DMA_IP_DMACRC_IS_AVAILABLE)
void HwAccDmaCh_SetCrc_ModeSelect(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue);
void HwAccDmaCh_SetCrc_PolynomialSelect(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue);
void HwAccDmaCh_SetCrc_EnableInitialValue(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue);
void HwAccDmaCh_SetCrc_InitialValue(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue);
void HwAccDmaCh_SetCrc_EnableLogic(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue);
void HwAccDmaCh_GetFinalCrc(const uint32 LocHwVers, const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, uint32 * const retValue);
#endif
...
void HwAccDmaInst_SetCrcConfig(const Dma_Ip_LogicInstanceIdType * const pxLocLogicInst, const Dma_Ip_LogicInstanceConfigType * const pxLocInstConfig)
{
    ...
    /* Configure CRC: Swap byte, Swap bit, CRC enable/disable */
    hwv3AccInlineDmaInst_SetCrcConfig(g_pDmaCrcPtrArray[LocHwInst], pxLocInstConfig);
}
#endif /* #if (STD_ON == DMA_IP_DMACRC_IS_AVAILABLE) */
...
void HwAccDmaCh_SetRequest_EnMuxSource(const uint32 LocHwVers, const uint32 LocHwInst, const uint32 LocHwCh, const uint32 LocValue)
{
    ...
    switch (LocHwVers)
    {
        ...
        case DMA_IP_HARDWARE_VERSION_3:
                ...
                #else
                    if ((DMA_IP_TCD_NOF_HWV3_CH > LocHwCh) && (DMA_IP_TCD_NOF_HWV3_CH_INST >LocHwInst))
                    {
                    ...
                    if (DMA_IP_DMAMUX_NOF_INST > LocDmaMuxInst)
                    {
                        hwv3AccInlineDmaCh_SetRequest_EnHwRequestMux((volatile Dma_Ip_MuxRegType*)&Dma_Ip_paxHwv3MuxBase[LocDmaMuxInst]->CHCFG[LocDmaMuxCh], LocValue);
                    }
                    else
...
void HwAccDmaCh_SetCrc_ModeSelect(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue)
{
    /* Select CRC Mode: Normal CRC Mode */
    hwv3AccInlineDmaCh_SetCrc_ModeSelect(g_pDmaCrcPtrArray[LocHwCrcInst] , LocHwCrcCh, LocValue);
}
void HwAccDmaCh_SetCrc_PolynomialSelect(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue)
{
    /* Polynomial Select */
    hwv3AccInlineDmaCh_SetCrc_PolynomialSelect(g_pDmaCrcPtrArray[LocHwCrcInst] , LocHwCrcCh, LocValue);
}
void HwAccDmaCh_SetCrc_EnableInitialValue(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue)
{
    /* Enable initial values of the CRC */
    hwv3AccInlineDmaCh_SetCrc_EnableInitialValue(g_pDmaCrcPtrArray[LocHwCrcInst] , LocHwCrcCh, LocValue);
}
void HwAccDmaCh_SetCrc_InitialValue(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue)
{
    /* Initial values of the CRC */
    hwv3AccInlineDmaCh_SetCrc_InitialValue(g_pDmaCrcPtrArray[LocHwCrcInst] , LocHwCrcCh, LocValue);
}
void HwAccDmaCh_SetCrc_EnableLogic(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue)
{
    /* Enables/Disables CRC logic */
    hwv3AccInlineDmaCh_SetCrc_EnableLogic(g_pDmaCrcPtrArray[LocHwCrcInst] , LocHwCrcCh, LocValue);
}
...
{
    static void (*const fpHwAcc_DmaCh_SetCrcParam[])(const uint32 LocHwCrcInst, const uint32 LocHwCrcCh, const uint32 LocValue) =
    {
    ...
    fpHwAcc_DmaCh_SetCrcParam[Parameter](LocHwCrcInst, LocHwCrcCh, LocValue);
    (void)LocHwVers;
}
#endif /* #if (STD_ON == DMA_IP_DMACRC_IS_AVAILABLE) */
...
#if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE)
        case DMA_IP_HARDWARE_VERSION_3:
            hwv3AccInlineDmaCh_GetFinalCrc(g_pDmaCrcPtrArray[LocHwCrcInst], LocHwCrcCh, retValue);
        break;
#endif /* #if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE) */
...
#if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE)
        case DMA_IP_HARDWARE_VERSION_3:
            hwv3AccInlineDmaCh_SetCrc_InstanceChannelSelect(g_pDmaCrcPtrArray[LocHwInst], LocHwCh, LocValue);
        break;
#endif /* #if (STD_ON == DMA_IP_HWV3_IS_AVAILABLE) */
