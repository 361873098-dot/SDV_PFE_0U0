...
#define DMA_IP_MULTICORE_SW_PATCH_VERSION_C                2
...
==================================================================================================*/
LOCAL_INLINE uint8 Static_Dma_Ip_GetMultiCoreChannelStatus(uint32 ChannelNumber, const Dma_Ip_InitType * const ConfigPtr);
LOCAL_INLINE uint8 Static_Dma_Ip_GetMultiCoreInstanceStatus(uint32 InstanceNumber, const Dma_Ip_InitType * const ConfigPtr);
...
LOCAL_INLINE uint8 Static_Dma_Ip_GetMultiCoreChannelStatus(uint32 ChannelNumber, const Dma_Ip_InitType * const ConfigPtr)
{
    ...
    /* Get the core that access Channel Dma */
    if (StatusChannel == 0U)
    {
        Status = (uint8)0xFFU;
    }
...
LOCAL_INLINE uint8 Static_Dma_Ip_GetMultiCoreInstanceStatus(uint32 InstanceNumber, const Dma_Ip_InitType * const ConfigPtr)
{
    ...
    /* Get the core that access Instance Dma */
