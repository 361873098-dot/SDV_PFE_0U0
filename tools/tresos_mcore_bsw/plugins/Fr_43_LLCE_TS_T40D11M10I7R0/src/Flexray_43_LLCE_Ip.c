...
#include "Flexray_43_LLCE_Ip_Irq.h"
#include "Flexray_43_LLCE_Ip_HwAccess.h"
...
#define FLEXRAY_43_LLCE_IP_VENDOR_ID_C                        43
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C         4
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C         4
#define FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION_C      0
#define FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION_C                 1
#define FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION_C                 0
#define FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION_C                 7

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Flexray_43_LLCE_Ip.h header file are of the same vendor */
#if (FLEXRAY_43_LLCE_IP_VENDOR_ID_C != FLEXRAY_43_LLCE_IP_VENDOR_ID)
    #error "Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip.h header file are of the same Autosar version */
#if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C    != FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C    != FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION_C != FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip.h header file are of the same software version */
#if ((FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION_C != FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION_C != FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION_C != FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip.h are different"
#endif

/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same vendor */
#if (FLEXRAY_43_LLCE_IP_VENDOR_ID_C != FLEXRAY_IP_IRQ_VENDOR_ID)
    #error "Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_Irq.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same Autosar version */
#if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C    != FLEXRAY_IP_IRQ_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C    != FLEXRAY_IP_IRQ_AR_RELEASE_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION_C != FLEXRAY_IP_IRQ_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_Irq.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same software version */
#if ((FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION_C != FLEXRAY_IP_IRQ_SW_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION_C != FLEXRAY_IP_IRQ_SW_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION_C != FLEXRAY_IP_IRQ_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_Irq.h are different"
#endif

/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same vendor */
#if (FLEXRAY_43_LLCE_IP_VENDOR_ID_C != FLEXRAY_IP_HWACCESS_VENDOR_ID)
    #error "Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_HwAccess.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same Autosar version */
#if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C    != FLEXRAY_IP_HWACCESS_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C    != FLEXRAY_IP_HWACCESS_AR_RELEASE_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_AR_RELEASE_REVISION_VERSION_C != FLEXRAY_IP_HWACCESS_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_HwAccess.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_HwAccess.h header file are of the same software version */
#if ((FLEXRAY_43_LLCE_IP_SW_MAJOR_VERSION_C != FLEXRAY_IP_HWACCESS_SW_MAJOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_MINOR_VERSION_C != FLEXRAY_IP_HWACCESS_SW_MINOR_VERSION) || \
     (FLEXRAY_43_LLCE_IP_SW_PATCH_VERSION_C != FLEXRAY_IP_HWACCESS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Flexray_43_LLCE_Ip.c and Flexray_43_LLCE_Ip_HwAccess.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and OsIf.h header file are of the same Autosar version */
    #if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C != OSIF_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C != OSIF_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and OsIf.h are different"
    #endif
    #if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
        /* Check if current file and Devassert.h header file are of the same Autosar version */
        #if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
             (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C != DEVASSERT_AR_RELEASE_MINOR_VERSION) \
            )
            #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and Devassert.h are different"
        #endif
    #endif
            ...
            #if ((FLEXRAY_43_LLCE_IP_AR_RELEASE_MAJOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
                 (FLEXRAY_43_LLCE_IP_AR_RELEASE_MINOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION) \
                )
                #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip.c and RegLockMacros.h are different"
            #endif
        #endif
    #endif
#endif
...
*                                       LOCAL MACROS
==================================================================================================*/
#define FLEXRAY_43_LLCE_WMAX_NMVREAD_U8                       ((uint8)5U)
/*==================================================================================================
*                                      LOCAL CONSTANTS
==================================================================================================*/
...
*                                      GLOBAL VARIABLES
==================================================================================================*/
#define FR_43_LLCE_START_SEC_VAR_CLEARED_32
#include "Fr_43_LLCE_MemMap.h"

static uint32 Flexray_43_LLCE_Ip_u32uSecondsToTicks; /* implicit zero initialization*/

#define FR_43_LLCE_STOP_SEC_VAR_CLEARED_32
#include "Fr_43_LLCE_MemMap.h"

#if (FLEXRAY_43_LLCE_INSTANCE_COUNT > 0U)

    #define FR_43_LLCE_START_SEC_CONST_UNSPECIFIED
    #include "Fr_43_LLCE_MemMap.h"
    /*! @brief  Table of base addresses for FR instances. */
    FLEXRAY_Type * const Flexray_43_LLCE_Ip_apxBase[FLEXRAY_43_LLCE_INSTANCE_COUNT] = IP_FLEXRAY_LLCE_BASE_PTRS;

    #define FR_43_LLCE_STOP_SEC_CONST_UNSPECIFIED
    #include "Fr_43_LLCE_MemMap.h"

    #define FR_43_LLCE_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_CACHEABLE
    #include "Fr_43_LLCE_MemMap.h"

    /*! @brief Pointers to FR internal driver state for each instance */
    static Flexray_Ip_StateType* Flexray_43_LLCE_Ip_apxState[FLEXRAY_43_LLCE_INSTANCE_COUNT];
    static Flexray_Ip_SoftwareStatesType Flexray_43_LLCE_Ip_aeDriverStates[FLEXRAY_43_LLCE_INSTANCE_COUNT];

    #define FR_43_LLCE_STOP_SEC_VAR_CLEARED_UNSPECIFIED_NO_CACHEABLE
    #include "Fr_43_LLCE_MemMap.h"
#endif
...
#include "Fr_43_LLCE_MemMap.h"
static void Flexray_43_LLCE_InitState(uint8 instNum, const Flexray_Ip_ConfigType* config, const Flexray_Ip_StateAllocateType *stateAlloc);
static void Flexray_43_LLCE_InitCC(uint8 instNum, const Flexray_Ip_CcConfigType* ccConfig);
static void Flexray_43_LLCE_InitCallback(uint8 instNum, const Flexray_Ip_ConfigType* config);
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ConfigureIndBuffer(uint8 instNum, Flexray_Ip_IndConfigType* pIndConfig, uint32 indDataOffset);
static void FLEXRAY_43_LLCE_ProcessTxMBWhenUpdatedSlotStatus(uint8 instNum, uint8 bufferId);
static boolean FLEXRAY_43_LLCE_IndexRxSanityCheck(uint16 phyMbIndex, uint16 objectiveIndex, const FLEXRAY_Type* inst, uint8 mbIndex);
static void FLEXRAY_43_LLCE_ProcessRxMBWhenUpdatedSlotStatus(uint8 instNum, uint8 mbIndex,Flexray_Ip_FrameHeaderType* frameHdr, uint8* pData, uint8 pdataLength);
static void Flexray_43_LLCE_GetTransmitStatus(const FLEXRAY_Type* inst, uint8 mbIndex , Flexray_Ip_BufferStateType* bState);
static void Flexray_43_LLCE_Ip_ConfigureShadowBuffer(uint8 instNum, const Flexray_Ip_ShadowConfigType* pShadowConfig, uint32 shadowDataOffset);
static void Flexray_43_LLCE_Ip_SetFiFoRangeFilter(uint8 instNum, const Flexray_Ip_FifoConfigType* fifoConfig);
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ConfigureRxFiFo(uint8 instNum, boolean isChnB, const Flexray_Ip_FifoConfigType* fifoConfig, uint32 fifoDataOffset);
static void FLEXRAY_43_LLCE_CalculateSizeOfSysMemAndFiFoSysMem(uint8 instNum, const Flexray_Ip_ConfigType* config);
static Flexray_Ip_StatusType Flexray_43_LLCE_InitBuffer(uint8 instNum, const Flexray_Ip_ConfigType* config);
static inline void Flexray_43_LLCE_Ip_CheckDynamicLength(const FLEXRAY_Type* base, const Flexray_Ip_BufferStateType* bState, uint16* pHeaderMB, uint8 dataLength, uint8 mbIndex);
static inline void FLEXRAY_43_LLCE_CheckMBasignement(const Flexray_Ip_FrameHeaderType* frameHdr, const boolean *bChnA, const boolean *bChnB, boolean  *bStatusVal);
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_WaitPOCState(uint8 instNum, Flexray_Ip_PocStateType pocState);
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
static boolean FLEXRAY_43_LLCE_CheckShadowForRxIndBuffer(const Flexray_Ip_ConfigType* config);
static void FLEXRAY_43_LLCE_CheckRxIndBufferChannelAppearsOnce(const Flexray_Ip_IndConfigType* pIndConfig, boolean* chanA, boolean* chanB);
static void FLEXRAY_43_LLCE_CheckRxIndBufferSegmentAppearsOnce(const Flexray_Ip_IndConfigType* pIndConfig, boolean* seg1, boolean* seg2, uint8 indS1Size);
static void FLEXRAY_43_LLCE_CheckShadowBufferAppearsOnce(const Flexray_Ip_ShadowConfigType* pShadowConfig, boolean* shadowSeg1, boolean* shadowSeg2, boolean* shadowChanA, boolean* shadowChanB);
#endif
 ...
 *                 in user mode.
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetUserAccessAllowed(const FLEXRAY_Type *base)
{
 ...
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ClrUserAccessAllowed(const FLEXRAY_Type *base)
{
 ...
 *
 *END**************************************************************************/
Flexray_Ip_PocStateType Flexray_43_LLCE_Ip_GetCurrentState(uint8 instNum)
{
    const FLEXRAY_Type* inst;
    Flexray_Ip_PocStateType retValue = FLEXRAY_STATE_CONFIG;

#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(instNum < FLEXRAY_43_LLCE_INSTANCE_COUNT);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */

    inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    ...
    if (Flexray_43_LLCE_OccurFreeze(inst))
    {
        retValue = FLEXRAY_STATE_HALT;
    }
#endif
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_SendCHICommand(uint8 instNum, Flexray_Ip_ChiCmdType cmd)
{
    FLEXRAY_Type* inst;
    ...
    }while (FLEXRAY_43_LLCE_GetPOCStatus(inst) && (timeElapsed < Flexray_43_LLCE_Ip_u32uSecondsToTicks));

    if (timeElapsed < Flexray_43_LLCE_Ip_u32uSecondsToTicks)
    {
        FLEXRAY_43_LLCE_SetProtocolControlCommand(inst, cmd);
    }
    else
    {
...
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_WaitPOCState(uint8 instNum, Flexray_Ip_PocStateType pocState)
{
    ...
    {
        timeElapsed += OsIf_GetElapsed(&timeStart, FLEXRAY_TIMEOUT_TYPE);
    }while ((Flexray_43_LLCE_Ip_GetCurrentState(instNum) != pocState) && (timeElapsed <= Flexray_43_LLCE_Ip_u32uSecondsToTicks));
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ConfigTimer(uint8 instNum, const Flexray_Ip_TimerConfigType* timerCfg)
{
    FLEXRAY_Type* inst;
    ...
    if (timerCfg->timer == FLEXRAY_TIMER1)
    {
        ...
        FLEXRAY_43_LLCE_ConfigureTimer1(inst, timerCfg);
    ...
    else if (timerCfg->timer == FLEXRAY_TIMER2)
    {
        ...
        FLEXRAY_43_LLCE_ConfigureTimer2(inst, timerCfg);
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_StartTimer(uint8 instNum, Flexray_Ip_TimerType timer)
{
    FLEXRAY_Type* inst;
    ...
    if (timer == FLEXRAY_TIMER1)
    {
        ...
        FLEXRAY_43_LLCE_StartTimer1(inst, TRUE);
        /* End critical section: implementation depends on integrator */
    ...
    else
    {
        /* Start critical section: implementation depends on integrator */
        SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_01();
        FLEXRAY_43_LLCE_StartTimer2(inst, TRUE);
        /* End critical section: implementation depends on integrator */
        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_01();
    }
}
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_StopTimer(uint8 instNum, Flexray_Ip_TimerType timer)
{
    FLEXRAY_Type* inst;
    ...
    if (timer == FLEXRAY_TIMER1)
    {
        ...
        FLEXRAY_43_LLCE_StopTimer1(inst, TRUE);
        /* End critical section: implementation depends on integrator */
    ...
    else
    {
        /* Start critical section: implementation depends on integrator */
        SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_02();
        FLEXRAY_43_LLCE_StopTimer2(inst, TRUE);
        /* End critical section: implementation depends on integrator */
        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_02();
    }
}
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetStatusCounter(uint8 instNum,
                                  uint8 counterIndex,
 ...
 *
 *END**************************************************************************/
uint16 Flexray_43_LLCE_Ip_GetStatusCounter(uint8 instNum,
                                      uint8 counterIndex)
{
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetProtocolInterrupt(uint8 instNum, Flexray_Ip_ProtocolIntType pInt, boolean enable)
{
    FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
boolean Flexray_43_LLCE_Ip_GetProtocolInterruptFlag(uint8 instNum, Flexray_Ip_ProtocolIntType pInt)
{
    const FLEXRAY_Type* inst;
    uint8 tpInt = (uint8)pInt;
    boolean retValue;
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ClearProtocolInterruptFlag(uint8 instNum, Flexray_Ip_ProtocolIntType pInt)
{
    FLEXRAY_Type* inst;
    uint8 tpInt = (uint8)pInt;
 ...
 *
 *END**************************************************************************/
boolean Flexray_43_LLCE_Ip_GetGlobalInterruptFlag(uint8 instNum, Flexray_Ip_GlobalIntType gInt)
{
    const FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetGlobalInterrupt(uint8 instNum, Flexray_Ip_GlobalIntType gInt, boolean enable)
{
    FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(uint8 instNum, Flexray_Ip_GlobalIntType gInt)
{
    FLEXRAY_Type* inst;
    uint16 temp;
 ...
 *
 *END**************************************************************************/
boolean Flexray_43_LLCE_Ip_GetCHIInterruptFlag(uint8 instNum, Flexray_Ip_ChiIntType cInt)
{
    const FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ClearCHIInterruptFlag(uint8 instNum, Flexray_Ip_ChiIntType cInt)
{
    FLEXRAY_Type* inst;
 ...
 * a slot.
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetStatusMonitorSlot(uint8 instNum, uint8 monitorIndex, uint16 slotNumber)
{
    FLEXRAY_Type* inst;
 ...
 * a slot.
 *END**************************************************************************/
uint8 Flexray_43_LLCE_Ip_GetStatusMonitor(uint8 instNum, uint8 monitorIndex, boolean channelA, boolean evenCycle)
{
    uint8 slotStatus;
    uint8 slotIdx;
    const FLEXRAY_Type* inst;
    ...
    if (evenCycle)
    {
        ...
        slotStatus = FLEXRAY_43_LLCE_GetSlotStatus(inst, slotIdx, channelA);
    }
    else
    {
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetExternalCorrection(uint8 instNum,
                                       boolean rateCorrect,
                                       Flexray_Ip_ExtClkCorrectType correctType)
{
    ...
    if (rateCorrect)
    {
        FLEXRAY_43_LLCE_SetRateCorrection(inst, correctType);
    }
    else
    {
        FLEXRAY_43_LLCE_SetOffsetCorrection(inst, correctType);
    }
}
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_SetMTS(uint8 instNum,
                            boolean channelA,
                            boolean enable)
{
    FLEXRAY_Type* inst;
    ...
    if (FLEXRAY_STATE_NORMAL_ACTIVE != Flexray_43_LLCE_Ip_GetCurrentState(instNum))
    {
    ...
    else
    {
        ...
        FLEXRAY_43_LLCE_SetMTS(inst, channelA, enable);
    }
 ...
 *
 *END**************************************************************************/
uint16 Flexray_43_LLCE_Ip_GetCurrentSlotCounter(uint8 instNum, boolean channelA)
{
    const FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
static void Flexray_43_LLCE_InitState(uint8 instNum,
                              ...
                              const Flexray_Ip_StateAllocateType *stateAlloc)
{
    ...
    Flexray_43_LLCE_Ip_apxState[instNum] = stateAlloc->state;
    state = Flexray_43_LLCE_Ip_apxState[instNum];
...
static void Flexray_43_LLCE_InitCC(uint8 instNum, const Flexray_Ip_CcConfigType* ccConfig)
{
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    ...
    /*Disable CC */
    FLEXRAY_43_LLCE_EnableCC(inst, FALSE);

    FLEXRAY_43_LLCE_SetSysMemAccessTimeout(inst, ccConfig->timeout);

    FLEXRAY_43_LLCE_SetModuleConfiguration(inst, ccConfig);

    FLEXRAY_43_LLCE_SetSysMemBaseAddr(inst, (uint32)(ccConfig->pSysMem));
    ...
    if (ccConfig->memLayout == FLEXRAY_MEM_LAYOUT_DEDICATED)
    {
        ...
        FLEXRAY_43_LLCE_SetRxFiFoSysMemBaseAddr(inst, (uint32)(ccConfig->pFiFoSysMem));
    }

    FLEXRAY_43_LLCE_EnableCC(inst, TRUE);
}
...
static void Flexray_43_LLCE_InitCallback(uint8 instNum, const Flexray_Ip_ConfigType* config)
{
    ...
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    #endif
    Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    ...
    FLEXRAY_43_LLCE_SetTxMBInterrupt(inst, TRUE);
    FLEXRAY_43_LLCE_SetRxMBInterrupt(inst, TRUE);
    #endif
...
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ConfigureIndBuffer(uint8 instNum, Flexray_Ip_IndConfigType* pIndConfig, uint32 indDataOffset)
{
    ...
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    Flexray_43_LLCE_Ip_HeaderDataType * pHeaderData = NULL_PTR;
    Flexray_43_LLCE_Ip_HeaderDataType * pBaseHeaderData = NULL_PTR;
    ...
    pBaseHeaderData = (Flexray_43_LLCE_Ip_HeaderDataType *)(FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst));

    FLEXRAY_43_LLCE_SetMBEnableMode(inst, pIndConfig->MBIndex, FALSE);
    FLEXRAY_43_LLCE_SetMBDirection(inst, pIndConfig->MBIndex, pIndConfig->isTx);
    FLEXRAY_43_LLCE_SetMBRepeat(inst, pIndConfig->MBIndex, pIndConfig->repeatTx);
    FLEXRAY_43_LLCE_SetMBChn(inst, pIndConfig->MBIndex, pIndConfig->channelA, pIndConfig->channelB);
    FLEXRAY_43_LLCE_SetCycleCountFilter(inst, pIndConfig->MBIndex, pIndConfig->ccFilter, \
                                 pIndConfig->ccFilterVal, pIndConfig->ccFilterMask);
    FLEXRAY_43_LLCE_SetMBFrameId(inst, pIndConfig->MBIndex, pIndConfig->frameID);
    #ifdef FLEXRAY_MB_INTERRUPT_SUPPORT
    if (pIndConfig->isTx)
    {
        FLEXRAY_43_LLCE_SetMBInterrupt(inst, pIndConfig->MBIndex, TRUE);
    }
    else
    {
        FLEXRAY_43_LLCE_SetMBInterrupt(inst, pIndConfig->MBIndex, FALSE);
    }
    #endif

    FLEXRAY_43_LLCE_ClearMBFlag(inst, pIndConfig->MBIndex);
    FLEXRAY_43_LLCE_SetPhyMBIndex(inst, pIndConfig->MBIndex, pIndConfig->phyMBIndex);
    FLEXRAY_43_LLCE_SetMBDataOffset(inst, pIndConfig->phyMBIndex, indDataOffset);
    ...
    if (pIndConfig->isTx)
    {
        if (pIndConfig->frameID <= FLEXRAY_43_LLCE_GetNumbOfStaticSlots(inst))
        {
            /*Set payload length for static slots */
            pIndConfig->payloadLength =  (uint8)(FLEXRAY_43_LLCE_GetPayloadLengthStatic(inst));
        }
        if (pIndConfig->frameID == FLEXRAY_43_LLCE_GetKeySlot(inst))
        {
             Flexray_43_LLCE_calCrc(pIndConfig->payloadLength, pIndConfig->frameID, TRUE, TRUE, &(pIndConfig->headerCrc));
        } else
        {
             Flexray_43_LLCE_calCrc(pIndConfig->payloadLength, pIndConfig->frameID, FALSE, FALSE, &(pIndConfig->headerCrc));
        }
    ...
    {
        FLEXRAY_43_LLCE_SetMBEnableMode(inst, pIndConfig->MBIndex, TRUE);
        FLEXRAY_43_LLCE_SetMBLockMode(inst, pIndConfig->MBIndex, FALSE);
        FLEXRAY_43_LLCE_ClearMBFlag(inst, pIndConfig->MBIndex);
    }
    else
    {
        ...
        while (FLEXRAY_43_LLCE_GetMBEnableStatus(inst, pIndConfig->MBIndex) &&
              (timeElapsed < Flexray_43_LLCE_Ip_u32uSecondsToTicks))
        {
            FLEXRAY_43_LLCE_SetMBEnableMode(inst, pIndConfig->MBIndex, FALSE);
            timeElapsed += OsIf_GetElapsed(&timeStart, FLEXRAY_TIMEOUT_TYPE);
 ...
 *
 *END**************************************************************************/
static uint16 Flexray_43_LLCE_CalculateNumRxFifoBuf(const Flexray_Ip_FifoConfigType* fifoConfigA, const Flexray_Ip_FifoConfigType* fifoConfigB)
{
...
static Flexray_Ip_StatusType Flexray_43_LLCE_InitBuffer(uint8 instNum, const Flexray_Ip_ConfigType* config)
{
    ...
    if ((indMemConfig != NULL_PTR) && (indBufConfig != NULL_PTR))
    {
        ...
        numRxFiFoBuf = Flexray_43_LLCE_CalculateNumRxFifoBuf(fifoConfigA, fifoConfigB);

        if (FLEXRAY_MEM_LAYOUT_MIXED == config->ccConfig->memLayout)
        {
        ...
        FLEXRAY_43_LLCE_SetTxMBInterrupt(inst, FALSE);
        FLEXRAY_43_LLCE_SetRxMBInterrupt(inst, FALSE);
        /* End critical section: implementation depends on integrator */
        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_06();
        #endif

    #if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
        DevAssert(TRUE == FLEXRAY_43_LLCE_CheckShadowForRxIndBuffer(config));
    #endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
        ...
        if (indMemConfig->TotalBuffers > 0U)
        {
            /* Start critical section: implementation depends on integrator */
            SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_06();
            FLEXRAY_43_LLCE_SetSegmentSize(inst, indMemConfig->S1Size, indMemConfig->S2Size);
            FLEXRAY_43_LLCE_SetSegmentBuffSize(inst, indMemConfig->S1DataSize, indMemConfig->S2DataSize);
            /* End critical section: implementation depends on integrator */
            SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_06();
            for (MbIndex =0U; MbIndex < numIndBuf ; MbIndex++)
            {
                for (i = 0U; i < indMemConfig->TotalBuffers; i++)
                {
                    if ((MbIndex == indBufConfig[i].MBIndex) && (TRUE == indBufConfig[i].firstInit))
                    {
                        ...
                        ret = Flexray_43_LLCE_Ip_ConfigureIndBuffer(instNum, pIndConfig, indDataOffset);
                        /* End critical section: implementation depends on integrator */
                        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_06();
        ...
        for (i = 0U; i < numShadowConfig; i++)
        {
            ...
            Flexray_43_LLCE_Ip_ConfigureShadowBuffer(instNum, pShadowConfig, indDataOffset);
            indDataOffset += ((uint32)(pShadowConfig->segment1 ? indMemConfig->S1DataSize : indMemConfig->S2DataSize) << 1U);
        }

        /* Configure FiFo A */
        retConfigFiFoA = Flexray_43_LLCE_Ip_ConfigureRxFiFo(instNum, FALSE, fifoConfigA, fifoDataOffset);
        if (FLEXRAY_STATUS_ERROR == retConfigFiFoA)
        {
        ...
        /* Configure FiFo B */
        retConfigFiFoB = Flexray_43_LLCE_Ip_ConfigureRxFiFo(instNum, TRUE, fifoConfigB, fifoDataOffset);

        if (FLEXRAY_STATUS_ERROR == retConfigFiFoB)
        {
        ...
        FLEXRAY_43_LLCE_CalculateSizeOfSysMemAndFiFoSysMem(instNum, config);
    }
    else
    {
 ...
 *
 *END**************************************************************************/
static void Flexray_43_LLCE_PowerCycle(uint8 instNum)
{
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    
    if (TRUE == FLEXRAY_43_LLCE_IsEnabled(inst))
    {
        if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_FREEZE))
        {
            if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_WaitPOCState(instNum, (Flexray_Ip_PocStateType) FLEXRAY_STATE_HALT))
            {
                if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_DEFAULT_CONFIG))
                {
                    if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_WaitPOCState(instNum, (Flexray_Ip_PocStateType) FLEXRAY_STATE_DEFAULT_CONFIG))
                    {
                        /* Disable FR CC */
                        FLEXRAY_43_LLCE_EnableCC(inst, FALSE);
                    }
 ...
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_Init(uint8 instNum,
                         const Flexray_Ip_ConfigType* config,
                         const Flexray_Ip_StateAllocateType *stateAlloc
                         )
{
...
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
    Flexray_43_LLCE_Ip_u32uSecondsToTicks = OsIf_MicrosToTicks(FLEXRAY_TIMEOUT_DURATION_US, FLEXRAY_TIMEOUT_TYPE);
#ifdef FLEXRAY_43_LLCE_SET_USER_ACCESS_ALLOWED_AVAILABLE
#if (STD_ON == FLEXRAY_43_LLCE_SET_USER_ACCESS_ALLOWED_AVAILABLE)
...
#ifdef FLEXRAY_AUTOSAR_MODE_USED
    Flexray_43_LLCE_PowerCycle(instNum);
    if (FALSE == FLEXRAY_43_LLCE_IsEnabled(inst))
    {
#endif
        /* Check POC current state is DEFAULT_CONFIG */
        if (FLEXRAY_STATE_DEFAULT_CONFIG != Flexray_43_LLCE_Ip_GetCurrentState(instNum))
        {
            do
            {
                (void) Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_DEFAULT_CONFIG);
                u8PocStartAttempts--;
            } while (( FLEXRAY_STATE_DEFAULT_CONFIG != Flexray_43_LLCE_Ip_GetCurrentState(instNum)) && ((uint8)0U < u8PocStartAttempts));
        }
        ...
        {
            Flexray_43_LLCE_InitState(instNum, config, stateAlloc);

            /* Initialize Communication Controller */
            Flexray_43_LLCE_InitCC(instNum, ccConfig);
            ret = Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_CONFIG);

            if (FLEXRAY_STATUS_SUCCESS == ret)
            {
                ret = Flexray_43_LLCE_Ip_WaitPOCState(instNum, FLEXRAY_STATE_CONFIG);
            }

            if (FLEXRAY_STATUS_SUCCESS == ret)
            {
                /* Set MTS cycle filter for both two channels: A & B */
                FLEXRAY_43_LLCE_SetMTSFilterChnA(inst, config->mtsfilterChnA);
                FLEXRAY_43_LLCE_SetMTSFilterChnB(inst, config->mtsfilterChnB);
                /* Initialize callback for all global interrupt */
                Flexray_43_LLCE_InitCallback(instNum, config);
                /* Initialize parameters of protocol engine */
                FLEXRAY_43_LLCE_InitPE(instNum, peConfig);
                /* Initialize individual buffer and receive FiFo */
                retIntBuffer = Flexray_43_LLCE_InitBuffer(instNum, config);
                /* Set timebase mode for timer 2 */
                FLEXRAY_43_LLCE_SetTimebaseModeTimer2(inst, config->timer2IsRelative);
                /* Set timer duration for receive FiFo */
                FLEXRAY_43_LLCE_SetFiFoTimerDuration(inst, config->fifoTimerDuration);
                /* Send CONFIG_COMPLETE CHI command to fulfill configuration */
                ret = Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_CONFIG_COMPLETE);

                if (FLEXRAY_STATUS_SUCCESS == ret)
                {
                    ret = Flexray_43_LLCE_Ip_WaitPOCState(instNum, FLEXRAY_STATE_READY);

                    if ((peConfig->pKeySlotUsedForStartup) && (peConfig->pKeySlotUsedForSync) && (FLEXRAY_STATUS_SUCCESS == ret))
                    {
                        ret = Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_ALLOW_COLDSTART);
                    }
                }
            }
            ...
            if (FLEXRAY_STATUS_SUCCESS == ret)
            {
                ...
                Flexray_43_LLCE_Ip_aeDriverStates[instNum] = FLEXRAY_STATE_INIT;
            }
        }
 ...
 *
 *END**************************************************************************/
static void Flexray_43_LLCE_ClearMemory(uint8 instNum)
{
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    uint8 currentLevel;
    uint32 i;
    ...
    currentLevel = Flexray_43_LLCE_Ip_GetFifoLevel(instNum, TRUE);
    if (currentLevel > 0U)
    {
        FLEXRAY_43_LLCE_PopCountFiFo(inst, TRUE, currentLevel);
        Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_FIFOB_INTERRUPT);
    }

    currentLevel = Flexray_43_LLCE_Ip_GetFifoLevel(instNum, FALSE);
    if (currentLevel > 0U)
    {
        FLEXRAY_43_LLCE_PopCountFiFo(inst, FALSE, currentLevel);
        Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_FIFOA_INTERRUPT);
    }

    /* Clear Flexray memory area */
    if (FLEXRAY_43_LLCE_GetMemLayout(inst))
    {
        pSysMem = (uint8 *)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst);
        pFiFoSysMem = (uint8 *)FLEXRAY_43_LLCE_GetRxFiFoSysMemBaseAddr(inst);
 ...
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_Deinit(uint8 instNum)
{
    uint32 i = 0U;
    FLEXRAY_Type* inst;
    uint8 nBuffer;
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(Flexray_43_LLCE_Ip_apxState[instNum] != NULL_PTR);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */

    nBuffer = Flexray_43_LLCE_Ip_apxState[instNum]->numberOfBuffer;
    bState = Flexray_43_LLCE_Ip_apxState[instNum]->bufferState;
    ...
    for (i = 0U; i < nBuffer; i++)
    {
        ...
        timeStart = OsIf_GetCounter(FLEXRAY_TIMEOUT_TYPE);
        timeElapsed += OsIf_GetElapsed(&timeStart, FLEXRAY_TIMEOUT_TYPE);
        while ((FLEXRAY_43_LLCE_GetMBEnableStatus(inst, bufferId)) && (timeElapsed < Flexray_43_LLCE_Ip_u32uSecondsToTicks))
        {
            FLEXRAY_43_LLCE_SetMBEnableMode(inst, bufferId, FALSE);
    ...
    FLEXRAY_43_LLCE_DisableAllProtocolInterrupt(inst);
    FLEXRAY_43_LLCE_DisableAllGlobalInterrupt(inst);

    /* Clear interrupt flags */
    FLEXRAY_43_LLCE_ClearAllProtocolInterruptFlag(inst);
    Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_WAKEUP_INTERRUPT);
    Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_FIFOA_INTERRUPT);
    Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_FIFOB_INTERRUPT);
    FLEXRAY_43_LLCE_ClearAllCHIErrorInterruptFlag(inst);

    /* Disable MTS for channel A & B */
    (void)Flexray_43_LLCE_Ip_SetMTS(instNum, TRUE, FALSE);
    (void)Flexray_43_LLCE_Ip_SetMTS(instNum, FALSE, FALSE);

    /* Set FR module to POC:HALT state */
    /* The POC state is not updated to register if the FREEZE occurred */
    if (FLEXRAY_STATUS_SUCCESS == ret)
    {
        ret = Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_FREEZE);
    }
    ...
    if (FLEXRAY_STATUS_SUCCESS == ret)
    {
        ...
        {
            timeElapsed += OsIf_GetElapsed(&timeStart, FLEXRAY_TIMEOUT_TYPE);
        }while ((!Flexray_43_LLCE_OccurFreeze(inst)) &&(timeElapsed < Flexray_43_LLCE_Ip_u32uSecondsToTicks));
    ...
    if (FLEXRAY_STATUS_SUCCESS == ret)
    {
        ret = Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_DEFAULT_CONFIG);
    }

    if (FLEXRAY_STATUS_SUCCESS == ret)
    {
        /* Wait DEFAUT_CONFIG POC state */
        ret = Flexray_43_LLCE_Ip_WaitPOCState(instNum, FLEXRAY_STATE_DEFAULT_CONFIG);
    }

    if (FLEXRAY_STATUS_SUCCESS == ret)
    {
        /* Disable module */
        Flexray_43_LLCE_Ip_aeDriverStates[instNum] = FLEXRAY_STATE_UNINIT;
        FLEXRAY_43_LLCE_EnableCC(inst, FALSE);
        Flexray_43_LLCE_ClearMemory(instNum);
    #ifdef FLEXRAY_43_LLCE_SET_USER_ACCESS_ALLOWED_AVAILABLE
    #if (STD_ON == FLEXRAY_43_LLCE_SET_USER_ACCESS_ALLOWED_AVAILABLE)
...
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    const FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    uint8 mbIndex = state->bufferState[bufferId].mbId;
    Flexray_Ip_BufferStateType* bState = state->mbStateMap[mbIndex];
    if (FLEXRAY_43_LLCE_IsMBTx(inst, mbIndex))
    {
        if (bState->status == FLEXRAY_STATUS_BUSY)
        {
            /* Read Status of TX buffer */
            Flexray_43_LLCE_GetTransmitStatus(inst, mbIndex , bState);
            #ifdef FLEXRAY_MB_INTERRUPT_SUPPORT
            /* Disable interrupt */
            FLEXRAY_43_LLCE_SetMBInterrupt((FLEXRAY_Type*)inst, mbIndex, FALSE);
            #endif
 ...
 *
 *END**************************************************************************/
static boolean FLEXRAY_43_LLCE_IndexRxSanityCheck(uint16 phyMbIndex, 
 ...
 *
 *END**************************************************************************/
static void FLEXRAY_43_LLCE_ProcessRxMBWhenUpdatedSlotStatus(uint8 instNum,
                              uint8 mbIndex,
                              ...
                              uint8 pdataLength)
{
    ...
    Flexray_43_LLCE_Ip_HeaderDataType* pBaseHeaderData;
    Flexray_43_LLCE_Ip_HeaderDataType* pHeaderData;
    ...
    phyMbIndex = FLEXRAY_43_LLCE_GetPhyMBIndex(inst, mbIndex);
    objMbIdx = (uint16)((uint16)(state->numberOfMbUsed) + state->numShadowBuffer);
    if(FLEXRAY_43_LLCE_IndexRxSanityCheck(phyMbIndex, objMbIdx, inst, mbIndex))
    {
        if(FLEXRAY_43_LLCE_GetMBDataUpdate(inst,mbIndex))
        {
            /* Start critical section: implementation depends on integrator */
            SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_01();
            /* Lock Rx MB */
            FLEXRAY_43_LLCE_SetMBLockMode(inst,mbIndex, TRUE);
            /* End critical section: implementation depends on integrator */
            SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_01();
            /* Read the MB again to check if the MB is locked, */
            if (FLEXRAY_43_LLCE_GetMBLockStatus(inst, mbIndex))
            {   /* MB is locked */
                Flexray_43_LLCE_UnpackMessageBufferHeader((Flexray_43_LLCE_Ip_HeaderDataType *)&(pBaseHeaderData[phyMbIndex]), frameHdr);
                FLEXRAY_43_LLCE_GetMBChn(inst, mbIndex ,&bChnA,&bChnB);
                ...
                if (frameHdr->payloadLength == pdataLength)
                {
                    ...
                    FLEXRAY_43_LLCE_CheckMBasignement(frameHdr, &bChnA, &bChnB, &bStatusVal);
                    if (TRUE ==  bStatusVal)
                    {
                        pHeaderData = (Flexray_43_LLCE_Ip_HeaderDataType *)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst);
                        pFrameData = (uint16*)((uint32)((uint64)FLEXRAY_43_LLCE_GetMBDataOffset(inst, phyMbIndex) + (uint32)pHeaderData));
                ...
                /* Unlock MB */
                FLEXRAY_43_LLCE_SetMBLockMode(inst, mbIndex, FALSE);

                #ifdef FLEXRAY_MB_INTERRUPT_SUPPORT
                /* Disable interrupt */
                FLEXRAY_43_LLCE_SetMBInterrupt(inst, mbIndex, FALSE);
                #endif
                /* End critical section: implementation depends on integrator */
 ...
 *END**************************************************************************/
static void FLEXRAY_43_LLCE_CheckMBasignement(const Flexray_Ip_FrameHeaderType* frameHdr,
                                      const boolean *bChnA,
                                      const boolean *bChnB,
                                      boolean  *bStatusVal
                                     )
{
    if ((TRUE == *bChnA) && (TRUE == *bChnB))
    {
        ...
        if ((0x080U == (frameHdr->slotStatus & FLEXRAY_43_LLCE_STRINGENT_MASK_A)) || ( 0x8000U ==(frameHdr->slotStatus & FLEXRAY_43_LLCE_STRINGENT_MASK_B)))
        {
             *bStatusVal = TRUE;
        }
    }
    else if (TRUE == *bChnA)
    {
        ...
        /* Check Slot Status information */
        if (0x0080U == ( frameHdr->slotStatus & FLEXRAY_43_LLCE_STRINGENT_MASK_A))
        {
             *bStatusVal = TRUE;
        }
    }
    else
    {
        ...
        /* Check Slot Status information */
        if (0x8000U == ( frameHdr->slotStatus & FLEXRAY_43_LLCE_STRINGENT_MASK_B))
        {
             *bStatusVal = TRUE;
        }
    }
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_Send(uint8 instNum,
                          uint8 bufferId,
                          const uint8* pData,
                          uint8 dataLength)
{
    ...
    state = Flexray_43_LLCE_Ip_apxState[instNum];
    base = Flexray_43_LLCE_Ip_apxBase[instNum];
    ...
    if ( mbIndex == bState->mbId)
    {
        ...
        if (TRUE == FLEXRAY_43_LLCE_IsMBTx(base, mbIndex))
        {
            ...
            if (bState->status != FLEXRAY_STATUS_BUSY)
            {
                ...
                phyMbIndex = FLEXRAY_43_LLCE_GetPhyMBIndex(base, mbIndex);
                if (phyMbIndex < (uint16)((uint16)(state->numberOfMbUsed) + state->numShadowBuffer))
                {
                    ...
                    FLEXRAY_43_LLCE_SetMBInterrupt(base, mbIndex, FALSE);
                    #endif

                    /* Clear Message Buffer Interrupt Flag */
                    FLEXRAY_43_LLCE_ClearMBFlag(base, mbIndex);
                    /* End critical section: implementation depends on integrator */
                    SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                    /* Header field */
                    pHeaderData = (Flexray_43_LLCE_Ip_HeaderDataType*)FLEXRAY_43_LLCE_GetSysMemBaseAddr(base);

                    pHeaderMB = (uint16*)(&(pHeaderData[mbIndex]));
                    /* Prepare message buffer data */
                    pFrameData = (uint8*)((uint32)((uint64)FLEXRAY_43_LLCE_GetMBDataOffset(base, phyMbIndex) + (uint32) pHeaderData));

                    /* Get lock and enable status of message buffer */
                    eds = FLEXRAY_43_LLCE_GetMBEnableStatus(base, mbIndex);

                    /* Start critical section: implementation depends on integrator */
                    SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                    /* Lock individual buffer */
                    FLEXRAY_43_LLCE_SetMBLockMode(base, mbIndex, TRUE);
                    lcks = FLEXRAY_43_LLCE_GetMBLockStatus(base, mbIndex);
                    ...
                    if ((!eds) || lcks)
                    {
                        ...
                        #ifdef FLEXRAY_UNUSED_BIT_VALUE_U16
                        tempDataLength++;
                        if (FLEXRAY_43_LLCE_GetMBFrameId(base,mbIndex) < FLEXRAY_43_LLCE_GetNumbOfStaticSlots(base))
                        {
                            tempPayloadLength = FLEXRAY_43_LLCE_GetPayloadLengthStatic(base);
                        ...
                        Flexray_43_LLCE_Ip_CheckDynamicLength(base, bState, pHeaderMB, dataLength, mbIndex);

                        /* Start critical section: implementation depends on integrator */
                        SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                        FLEXRAY_43_LLCE_SetMBTrasmitReady(base, mbIndex, TRUE);

                        if (!eds)
                        {
                            FLEXRAY_43_LLCE_SetMBEnableMode(base, mbIndex, TRUE);
                        }
                        FLEXRAY_43_LLCE_SetMBLockMode(base, mbIndex, FALSE);
                        /* End critical section: implementation depends on integrator */
                        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                    ...
                    if (bState->blocking == FALSE)
                    {
                        ...
                        SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                        /* Enable MB interrupt */
                        FLEXRAY_43_LLCE_SetMBInterrupt(base, mbIndex, TRUE);
                        /* End critical section: implementation depends on integrator */
                        SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_09();
                        #endif
                    }
 ...
 *END**************************************************************************/
static inline void Flexray_43_LLCE_Ip_CheckDynamicLength(const FLEXRAY_Type* base,
                                   ...
                                   uint8 mbIndex)
{
    ...
    if (TRUE == bState->allowDynamicLength)
    {
        ...
        if (pHeaderMB[1U] != tempDataLength)
        {
            ...
            frameId = FLEXRAY_43_LLCE_GetMBFrameId(base,mbIndex);
            if (frameId == FLEXRAY_43_LLCE_GetKeySlot(base))
            {
                 Flexray_43_LLCE_calCrc(tempDataLength, frameId, TRUE, TRUE, (uint16*) &pHeaderMB[2U]);
            } else
            {
                 Flexray_43_LLCE_calCrc(tempDataLength, frameId, FALSE, FALSE, (uint16*) &pHeaderMB[2U]);
            }
        }
    }
}
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_SendBlocking(uint8 instNum,
                                  uint8 bufferId,
                                  const uint8* pData,
                                  uint8 dataLength,
                                  uint32 timeout_ms)
{
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(bState != NULL_PTR);
    DevAssert(FLEXRAY_43_LLCE_IsMBTx(inst, mbIndex) == TRUE);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */

    bState->blocking = TRUE;
    (void) Flexray_43_LLCE_Ip_Send(instNum, bufferId, pData, dataLength);
    bState->blocking = FALSE;

    while (FLEXRAY_43_LLCE_GetMBFlag(inst, mbIndex) != TRUE)
    {
        timeElapsed += OsIf_GetElapsed(&timeStart, FLEXRAY_TIMEOUT_TYPE);
    ...
    if (result == FLEXRAY_STATUS_TIMEOUT)
    {
        ...
        FLEXRAY_43_LLCE_SetMBTrasmitReady(inst, mbIndex, FALSE);
    ...
    else
    {
        ...
        #ifdef FLEXRAY_MB_INTERRUPT_SUPPORT
        /* Enable MB interrupt */
        FLEXRAY_43_LLCE_SetMBInterrupt(inst, mbIndex, TRUE);
        #endif
    }
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ReceiveInd(uint8 instNum,
                            uint8 bufferId,
                            Flexray_Ip_FrameHeaderType* frameHdr,
                            uint8* pData,
                            uint8 dataLength)
{
    ...
    if ( mbIndex == bState->mbId)
    {
        ...
        if (FALSE == FLEXRAY_43_LLCE_IsMBTx(base, mbIndex))
        {
            #ifndef FLEXRAY_AUTOSAR_MODE_USED
            ...
            if (FLEXRAY_43_LLCE_GetMBFlag(base, mbIndex))
            {
                /* Start critical section: implementation depends on integrator */
                SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_07();
                FLEXRAY_43_LLCE_ClearMBFlag(base, mbIndex);
                /* End critical section: implementation depends on integrator */
                SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_07();
                FLEXRAY_43_LLCE_ProcessRxMBWhenUpdatedSlotStatus(instNum, mbIndex, frameHdr, pData, dataLength);
            }
#ifdef FLEXRAY_AUTOSAR_MODE_USED
            else
            {
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReceiveIndBlocking(uint8 instNum,
                                        uint8 bufferId,
                                        Flexray_Ip_FrameHeaderType* frameHdr,
                                        uint8* pData,
                                        uint8 dataLength,
                                        uint32 timeout_ms)
{
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(bState != NULL_PTR);
    DevAssert(FALSE == FLEXRAY_43_LLCE_IsMBTx(inst, mbIndex));
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
    /* If message buffer is aborted formerly, enable again rx message buffer */
    if ((bState->status) == FLEXRAY_STATUS_ABORTED)
    {
        bState->status = FLEXRAY_STATUS_BUSY;
        FLEXRAY_43_LLCE_SetMBEnableMode(inst, mbIndex, TRUE);
    }
    ...
    if (result == FLEXRAY_STATUS_TIMEOUT)
    {
        ...
        FLEXRAY_43_LLCE_SetMBInterrupt(inst, bufferId, FALSE);
        #endif
        bState->status = FLEXRAY_STATUS_TIMEOUT;
        res = FLEXRAY_STATUS_TIMEOUT;
    }
    ...
    {
        Flexray_43_LLCE_Ip_ReceiveInd(instNum, bufferId, frameHdr, pData, dataLength);
        res = bState->status;
    }
    return res;
}
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReceiveFIFO(uint8 instNum, boolean channel, Flexray_Ip_FrameHeaderType* frameHdr, uint8* pData , uint8 dataLength)
{
    Flexray_43_LLCE_Ip_HeaderDataType* pHeaderData;
    const uint16* pFrameData;
    ...
    inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    /* Select FIFO */
    FLEXRAY_43_LLCE_SetFiFoChn(inst, channel);

    fillLevel = FLEXRAY_43_LLCE_FillLevelFiFo(inst, channel);
    ...
    if (fillLevel > 0U)
    {
        ...
        {
            /* Read data from header field */
            pHeaderData = (Flexray_43_LLCE_Ip_HeaderDataType *)(FLEXRAY_43_LLCE_GetRxFiFoSysMemBaseAddr(inst));
        }

        if (FALSE == channel)
        {
            mbIndex = FLEXRAY_43_LLCE_ReceiveFiFoAReadIdx(inst);
        } else
        {
            mbIndex = FLEXRAY_43_LLCE_ReceiveFiFoBReadIdx(inst);
        }
        Flexray_43_LLCE_UnpackMessageBufferHeader((Flexray_43_LLCE_Ip_HeaderDataType *)&(pHeaderData[mbIndex]), frameHdr);
        #if (FLEXRAY_RXSTRINGENTLENGTHCHECK == STD_ON)
        if (frameHdr->payloadLength == dataLength)
        {
            ...
            if (TRUE == bReceive)
            {
                ...
                mbIndex -= FLEXRAY_43_LLCE_GetFiFoStartIdx(inst);
                fifoDataOff = (uint32)FLEXRAY_43_LLCE_GetFiFoDataOffset(inst);
                fifoCurrentDataOff = (uint32)((uint32)(mbIndex * (uint32)FLEXRAY_43_LLCE_GetFiFoEntrySize(inst)) << 1U);
        ...
        if (FALSE == channel)
        {
            FLEXRAY_43_LLCE_ClearFifoAInterruptFlag(inst);
        }
        else
        {
            FLEXRAY_43_LLCE_ClearFifoBInterruptFlag(inst);
        }
    }
    else
    {
...
static void Flexray_43_LLCE_GetTransmitStatus(const FLEXRAY_Type* inst, uint8 mbIndex , Flexray_Ip_BufferStateType* bState)
{
    ...
    phyMBIndex = FLEXRAY_43_LLCE_GetPhyMBIndex(inst, mbIndex);
    sysBaseAddr = FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst);
    headerBuffOffset = (uint32)((uint32)phyMBIndex * FRAME_HEADER_SIZE);
    pHeaderData = (Flexray_43_LLCE_Ip_HeaderDataType *)(sysBaseAddr + headerBuffOffset);

    /* The frameHdr must not point to null at this point. */
    if (bState->frameHdr != NULL_PTR)
    {
       Flexray_43_LLCE_UnpackMessageBufferHeader(pHeaderData, bState->frameHdr);
    }

    /* Check all channels for conflicts. */
    if (FLEXRAY_43_LLCE_GetTxChnAConflict(inst) && FLEXRAY_43_LLCE_GetTxChnBConflict(inst))
    {
        bState->status = FLEXRAY_STATUS_TX_CONFLICT_AB;
    } else if (FLEXRAY_43_LLCE_GetTxChnAConflict(inst))
    {
        bState->status = FLEXRAY_STATUS_TX_CONFLICT_A;
    } else if (FLEXRAY_43_LLCE_GetTxChnBConflict(inst))
    {
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetTransferStatus(uint8 instNum, uint8 bufferId)
{
    ...
    if ( mbIndex == bState->mbId)
    {
        ...
        if (FLEXRAY_43_LLCE_IsMBTx(inst, mbIndex))
        {
            if (FLEXRAY_43_LLCE_GetMBFlag(inst, mbIndex) == TRUE)
            {
                Flexray_43_LLCE_GetTransmitStatus(inst, mbIndex , bState);
            }
        #endif
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_TxIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    const Flexray_Ip_BufferStateType* bState;
    ...
    for (idxMB = 0U; idxMB < numberMb; idxMB++)
    {
        ...
        isTxMB = FLEXRAY_43_LLCE_IsMBTx(inst, idxMB);
        if (FLEXRAY_43_LLCE_GetMBFlag(inst, idxMB) && isTxMB )
        {
            if (FLEXRAY_43_LLCE_GetMBInterruptEnable(inst, idxMB))
            {
                FLEXRAY_43_LLCE_ClearMBFlag(inst, idxMB);
                if (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT)
                {
                    FLEXRAY_43_LLCE_ProcessTxMBWhenUpdatedSlotStatus(instNum, bufferId);
                }
            }
        }
    }
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_RxIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    const Flexray_Ip_BufferStateType* bState;
    ...
    for (idxMB = 0U; idxMB < numberMB; idxMB++)
    {
        ...
        if (FLEXRAY_43_LLCE_GetMBFlag(inst, idxMB) && (!isTxMB))
        {
            ...
            {
                FLEXRAY_43_LLCE_ClearMBFlag(inst, idxMB);
                if ((bState->status == FLEXRAY_STATUS_BUSY) && (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT))
                {
                    FLEXRAY_43_LLCE_ProcessRxMBWhenUpdatedSlotStatus(instNum, bufferId, bState->frameHdr, bState->pData, bState->dataLength);
                }
            }
        }
        bState++;
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_PrIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    void* callbackParam = state->callback.prCallbackParam;
    uint32 prIntFlagValue = FLEXRAY_43_LLCE_GetAllProtocolInterruptFlag(inst);

    MCAL_FAULT_INJECTION_POINT(T_FR_FIP_1_PRIRQ);
    if (prIntFlagValue != 0UL)
    {
        if ((state->callback.protocolCallback != NULL_PTR) && (FLEXRAY_43_LLCE_GetAllProtocolInterruptEnable(inst) != 0UL))
        {
            if (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT)
            {
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_ChiIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    void* callbackParam = state->callback.chiCallbackParam;
    uint16 chiErrorFlagValue = FLEXRAY_43_LLCE_GetAllCHIErrorInterruptFlag(inst);

    MCAL_FAULT_INJECTION_POINT(T_FR_FIP_2_CHIRQ);
    if (chiErrorFlagValue != 0UL)
    {
        FLEXRAY_43_LLCE_ClearAllCHIErrorInterruptFlag(inst);

        if ((state->callback.chiCallback != NULL_PTR) && (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT) && FLEXRAY_43_LLCE_GetCHIInterruptEnable(inst))
        {
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_WupIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    const FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    ...
    if (FLEXRAY_43_LLCE_GetWUPInterruptFlag(inst))
    {
        Flexray_43_LLCE_Ip_ClearGlobalInterruptFlag(instNum, FLEXRAY_WAKEUP_INTERRUPT);

        if ((state->callback.wakeupCallback != NULL_PTR) && (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT) && FLEXRAY_43_LLCE_GetWUPInterruptEnable(inst))
        {
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_FAFAIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    const FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    void* callbackParam = state->callback.fifoACallbackParam;

    if (FLEXRAY_43_LLCE_GetFifoAInterruptFlag(inst))
    {
        if ((state->callback.fifoACallback != NULL_PTR) && (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT) && FLEXRAY_43_LLCE_GetFIFOAInterruptEnable(inst))
        {
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_FAFBIrq(uint8 instNum)
{
    const Flexray_Ip_StateType* state = Flexray_43_LLCE_Ip_apxState[instNum];
    const FLEXRAY_Type* inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    void* callbackParam = state->callback.fifoBCallbackParam;

    if (FLEXRAY_43_LLCE_GetFifoBInterruptFlag(inst))
    {
        if ((state->callback.fifoBCallback != NULL_PTR) && (Flexray_43_LLCE_Ip_aeDriverStates[instNum] == FLEXRAY_STATE_INIT) && FLEXRAY_43_LLCE_GetFIFOBInterruptEnable(inst))
        {
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_Abort(uint8 instNum,
                                       uint8 bufferId)
{
    const Flexray_Ip_StateType* state;
    Flexray_Ip_BufferStateType* bState;
    ...
    if ( mbIndex == bState->mbId)
    {
        ...
        else
        {
            ...
            if (FLEXRAY_STATE_STARTUP != Flexray_43_LLCE_Ip_GetCurrentState(instNum))
            {
    #endif
#endif
                if (FLEXRAY_43_LLCE_IsMBTx(inst, mbIndex))
                ...
                else
                {
                    ...
                    FLEXRAY_43_LLCE_SetMBEnableMode(inst, mbIndex, FALSE);

                    /* End critical section: implementation depends on integrator */
                    SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_10();
                    if (!FLEXRAY_43_LLCE_GetMBEnableStatus(inst, mbIndex))
                    {
                        #ifdef FLEXRAY_MB_INTERRUPT_SUPPORT
                        FLEXRAY_43_LLCE_SetMBInterrupt(inst, mbIndex, FALSE);
                        #endif
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_CancelTxBuffer(uint8 instNum,
                                                uint8 bufferId,
                                                boolean* pendingStatus)
{
    ...
    if ( mbIndex == bState->mbId)
    {
        ...
        if (FLEXRAY_43_LLCE_IsMBTx(inst,mbIndex))
        {
            ...
            if (!FLEXRAY_43_LLCE_GetMBTrasmitReady(inst,mbIndex))
            {
                *pendingStatus = TRUE;
                /* Start critical section: implementation depends on integrator */
                SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_11();
                ...
                if (!FLEXRAY_43_LLCE_GetMBLockStatus(inst, mbIndex) && FLEXRAY_43_LLCE_GetMBTrasmitReady(inst,mbIndex))
                {
                    ret = FLEXRAY_STATUS_SUCCESS;
                }
                else
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StartupStatusType Flexray_43_LLCE_Ip_GetStartupStatus(uint8 instNum)
{
    const FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
uint8 Flexray_43_LLCE_Ip_GetCurrentCycleCount(uint8 instNum)
{
    const FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_SetWakeupChannel
(
    uint8 instNum,
    boolean bChnA,
    boolean bChnB
)
{
    ...
    if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_CONFIG))
    {
        /* Wait till FlexRay CC is not in POC:Config */
        if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_WaitPOCState(instNum, FLEXRAY_STATE_CONFIG))
        {
            ...
            if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_SendCHICommand(instNum, FLEXRAY_CHI_CMD_CONFIG_COMPLETE))
            {
                /* Wait till FlexRay CC is not in POC:Ready */
                if (FLEXRAY_STATUS_SUCCESS == Flexray_43_LLCE_Ip_WaitPOCState(instNum, FLEXRAY_STATE_READY))
                {
                    retValue = FLEXRAY_STATUS_SUCCESS;
                }
            }
 ...
 *
 *END**************************************************************************/
Flexray_Ip_WakeUpChannelType Flexray_43_LLCE_Ip_GetWakeupChannel(uint8 instNum)
{
    FLEXRAY_Type* inst;
 ...
 *
 *END**************************************************************************/
Flexray_Ip_WakeupStatusType Flexray_43_LLCE_Ip_GetWakeupStatus(uint8 instNum)
{
    const FLEXRAY_Type* inst;
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(NULL_PTR != pShadowConfig);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */

    sel = pShadowConfig->segment1 ? 0U : 1U;
    sel |= pShadowConfig->channelA ? 0U : 2U;

    FLEXRAY_43_LLCE_SetShadowBufferIdx(inst, pShadowConfig->phyMBIndex, sel);
    FLEXRAY_43_LLCE_SetMBDataOffset(inst, pShadowConfig->phyMBIndex, shadowDataOffset);
}
...
static void Flexray_43_LLCE_Ip_SetFiFoRangeFilter(uint8 instNum, const Flexray_Ip_FifoConfigType* fifoConfig)
{
    ...
    {
        FLEXRAY_43_LLCE_SetFiFoRangeFilter(inst, filterIdx, &fifoConfig->rangeFilter[filterIdx]);
    }
}
...
static Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ConfigureRxFiFo(uint8 instNum, boolean isChnB, const Flexray_Ip_FifoConfigType* fifoConfig, uint32 fifoDataOffset)
{
    ...
    if (NULL_PTR != fifoConfig)
    {
        FLEXRAY_43_LLCE_SetFiFoWatermark(inst, isChnB, fifoConfig->watermark);
        if (fifoConfig->fifoDepth == 0U)
        {
            FLEXRAY_43_LLCE_SetFiFoRejFilter(inst, 0U, 0U);
        }
        else
        {
            startIndex = FLEXRAY_43_LLCE_GetFiFoStartIdx(inst);
            if (isChnB)
            {
                currentReadIdx = FLEXRAY_43_LLCE_ReceiveFiFoBReadIdx(inst);
            }
            else
            {
                currentReadIdx = FLEXRAY_43_LLCE_ReceiveFiFoAReadIdx(inst);
            }
            ...
            {
                FLEXRAY_43_LLCE_SetFiFoPos(inst, fifoConfig->startIndex, fifoDataOffset);
                FLEXRAY_43_LLCE_SetFiFoSize(inst, fifoConfig->entrySize, fifoConfig->fifoDepth);
                FLEXRAY_43_LLCE_SetFiFoRejFilter(inst, fifoConfig->fidRejVal, fifoConfig->fidRejMask);
                FLEXRAY_43_LLCE_SetFiFoAcceptFilter(inst, fifoConfig->midAccVal, fifoConfig->midAccMask);
                Flexray_43_LLCE_Ip_SetFiFoRangeFilter(instNum, fifoConfig);
            }
            else
            {
                ret = FLEXRAY_STATUS_ERROR;
    ...
    {
        FLEXRAY_43_LLCE_SetFiFoWatermark(inst, isChnB, 0U);
        FLEXRAY_43_LLCE_SetFiFoRejFilter(inst, 0U, 0U);
    }
...
static boolean FLEXRAY_43_LLCE_CheckShadowForRxIndBuffer(const Flexray_Ip_ConfigType* config)
{
    ...
    if ((NULL_PTR != indMemConfig) && (NULL_PTR != indBufConfig))
    {
        numIndBuf = (uint16)((uint16)(indMemConfig->S1Size) + indMemConfig->S2Size);
        for (idx = 0U; idx < numIndBuf; idx++)
        {
            ...
            {
                FLEXRAY_43_LLCE_CheckRxIndBufferChannelAppearsOnce(&indBufConfig[idx] , &chanA, &chanB);
                FLEXRAY_43_LLCE_CheckRxIndBufferSegmentAppearsOnce(&indBufConfig[idx] , &seg1, &seg2, indMemConfig->S1Size);
            }
        }
    }
    ...
    if (shadowConfig != NULL_PTR)
    {
        ...
        {
            FLEXRAY_43_LLCE_CheckShadowBufferAppearsOnce(&shadowConfig[idx], &shadowSeg1, &shadowSeg2, &shadowChanA, &shadowChanB);
        }
    }
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_GetDefaultConfig(const Flexray_Ip_ConfigType * config)
{
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_SetBasicDynamicTxFrame(uint8 instNum,
                                            uint8 bufferId,
                                            boolean PPI,
                                            uint8 payloadLength)
{
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(instNum < FLEXRAY_43_LLCE_INSTANCE_COUNT);
    DevAssert(NULL_PTR != Flexray_43_LLCE_Ip_apxState[instNum]);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
...
#if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
    DevAssert(FLEXRAY_43_LLCE_IsMBTx(base, mbIndex) == TRUE);
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
    /* Start critical section: implementation depends on integrator */
    ...
    if ((!eds) || lcks)
    {
        ...
        /* Get data buffer index */
        index = FLEXRAY_43_LLCE_GetPhyMBIndex(base, mbIndex);

        /* Get header data of message buffer */
        Flexray_43_LLCE_UnpackMessageBufferHeader(&pHeaderData[index], &frameHdr);

    #if (STD_ON == FLEXRAY_DEV_ERROR_DETECT)
        DevAssert(frameHdr.frameID > FLEXRAY_43_LLCE_GetNumbOfStaticSlots(base));
    #endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */

        frameHdr.payloadPreambleIndicator = PPI;
        frameHdr.payloadLength = payloadLength;
        Flexray_43_LLCE_PackMessageBufferHeader(&pHeaderData[index], &frameHdr);
        /* Start critical section: implementation depends on integrator */
        SchM_Enter_Fr_43_LLCE_FR_EXCLUSIVE_AREA_12();
        if (!eds)
        {
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReConfigIndividual(uint8 instNum, Flexray_Ip_IndConfigType* pIndConfig)
{
    FLEXRAY_Type* inst;
    Flexray_43_LLCE_Ip_HeaderDataType * pHeaderData;
    Flexray_43_LLCE_Ip_HeaderDataType * pBaseHeaderData;
    ...
    if (MBIndex < (state->numberOfMbUsed))
    {
        ...
        if (phyMbIndex < (uint16)((uint16)(state->numberOfMbUsed) + state->numShadowBuffer))
        {
            ...
            if (!FLEXRAY_43_LLCE_GetMBEnableStatus(inst, MBIndex))
            {
                ...
                FLEXRAY_43_LLCE_SetMBRepeat(inst, MBIndex, pIndConfig->repeatTx);
                FLEXRAY_43_LLCE_SetMBChn(inst, MBIndex, pIndConfig->channelA, pIndConfig->channelB);
                FLEXRAY_43_LLCE_SetCycleCountFilter(inst, MBIndex, pIndConfig->ccFilter, \
                                             pIndConfig->ccFilterVal, pIndConfig->ccFilterMask);
                FLEXRAY_43_LLCE_SetMBFrameId(inst, MBIndex, pIndConfig->frameID);
                FLEXRAY_43_LLCE_SetMBDirection(inst, MBIndex, pIndConfig->isTx);
                FLEXRAY_43_LLCE_SetMBInterrupt(inst, MBIndex, TRUE);
                /* End critical section: implementation depends on integrator */
                SchM_Exit_Fr_43_LLCE_FR_EXCLUSIVE_AREA_13();
                ...
                {
                    FLEXRAY_43_LLCE_SetMBEnableMode(inst, MBIndex, TRUE);
                    if (FALSE == FLEXRAY_43_LLCE_GetMBEnableStatus(inst, MBIndex))
                    {
                        ret = FLEXRAY_STATUS_ERROR;
                    }
                }
 ...
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetNMVector(uint8 instNum,
                                             uint8* data,
                                             uint8* configLen
                                             )
{
...
#endif /* (STD_ON == FLEXRAY_DEV_ERROR_DETECT) */
    inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    nmvLength = FLEXRAY_43_LLCE_GetNMVLength(inst);
    bDataCons = TRUE;
    ...
    for (i = 0U; i < nmvLength; i++)
    {
        ...
        {
            nmvValue = FLEXRAY_43_LLCE_GetNMV(inst, (i >> 1U));
 ...
 *
 *END**************************************************************************/
uint8 Flexray_43_LLCE_Ip_GetFifoLevel(uint8 instNum, boolean isChnB)
{
    const FLEXRAY_Type* inst;
    uint8 fifoLevel;
    ...
    inst = Flexray_43_LLCE_Ip_apxBase[instNum];
    fifoLevel = FLEXRAY_43_LLCE_FillLevelFiFo(inst, isChnB);
...
void Flexray_43_LLCE_Ip_GetPocStatus(uint8 instNum, uint16* data)
{
    const FLEXRAY_Type* inst;
...
***************************************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_CheckCCAccess(uint8 instNum,
 ...
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ClearDisableIRQs
(
    uint8 instNum
)
{
 ...
 *
 *END**************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetGlobalTime
(
    uint8 instNum,
    uint8* cyclePtr,
    uint16* macroTickPtr
 ...
 *
 *END**************************************************************************/
void Flexray_43_LLCE_Ip_GetChannelStatus
(
    uint8 instNum,
...
***************************************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetClockCorrection
(
    uint8 instNum,
...
*
***************************************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetSyncFrameList
(
    uint8 instNum,
    const Flexray_Ip_ConfigType * config,
    uint8 listSize,
        ...
        if ((uint16)((uint16)FLEXRAY_SFTCCSR_ELKS_MASK | FLEXRAY_SFTCCSR_OLKS_MASK) == (((inst->SFTCCSR) & ((uint16)FLEXRAY_SFTCCSR_ELKS_MASK | ((uint16)FLEXRAY_SFTCCSR_OLKS_MASK | FLEXRAY_SFTCCSR_SIDEN_MASK)))))
        {
            ...
            for (index = 0U; index < u8tmpListSizeMax; index++)
            {
                ...
                {/* Copy channel A Even Sync Frame ID Table */
                    channelAEvenListPtr[index] = ((volatile uint16*)((pointerSizeType)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst) + (pointerSizeType)config->peConfig->SyncFrameTableOffset))[index];
                }
                if (index < u8tmpListSizeChBEven)
                {/* Copy channel B Even Sync Frame ID Table */
                    channelBEvenListPtr[index] = ((volatile uint16*)((pointerSizeType)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst) + (pointerSizeType)config->peConfig->SyncFrameTableOffset + 0x001EU))[index];
                }
                if (index < u8tmpListSizeChAOdd)
                {/* Copy channel A Odd Sync Frame ID Table */
                    channelAOddListPtr[index] = ((volatile uint16*)((pointerSizeType)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst) + (pointerSizeType)config->peConfig->SyncFrameTableOffset + 0x003CU))[index];
                }
                if (index < u8tmpListSizeChBOdd)
                {/* Copy channel B Odd Sync Frame ID Table */
                    channelBOddListPtr[index] = ((volatile uint16*)((pointerSizeType)FLEXRAY_43_LLCE_GetSysMemBaseAddr(inst) + (pointerSizeType)config->peConfig->SyncFrameTableOffset + 0x005AU))[index];
                }
            }
...
*
***************************************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_GetNumOfStartFrames
(
    uint8 instNum,
...
*
***************************************************************************************************/
Flexray_Ip_StatusType Flexray_43_LLCE_Ip_ReadbackCCConfig
(
    uint8 instNum,
    const Flexray_Ip_PeConfigType* peConfig
)
{
    ...
    const FLEXRAY_Type* base = Flexray_43_LLCE_Ip_apxBase[instNum];
    Flexray_Ip_StatusType retValue = FLEXRAY_STATUS_SUCCESS;
    uint8 i;
