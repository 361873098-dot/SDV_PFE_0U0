...
[!CODE!][!WS "0"!]#include "S32G274A_DMA.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G274A_DMA_TCD.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G274A_DMA_CRC.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G274A_DMAMUX.h"[!CR!][!ENDCODE!][!//
[!ELSEIF "contains($DerivativeName, 'S32R45')"!][!//
[!CODE!][!WS "0"!]#include "[!"$DerivativeName"!]_DMA.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "[!"$DerivativeName"!]_DMA_TCD.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "[!"$DerivativeName"!]_DMA_CRC.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "[!"$DerivativeName"!]_DMAMUX.h"[!CR!][!ENDCODE!][!//
[!ELSEIF "contains($DerivativeName, 'S32G3')"!][!//
[!CODE!][!WS "0"!]#include "S32G399A_DMA.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G399A_DMA_TCD.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G399A_DMA_CRC.h"[!CR!][!ENDCODE!][!//
[!CODE!][!WS "0"!]#include "S32G399A_DMAMUX.h"[!CR!][!ENDCODE!][!//
[!ENDIF!][!//
[!ELSE!][!//
...
#define DMA_IP_CFG_DEVICEREGISTERSV3_SW_PATCH_VERSION                2
...
/  DMAMUX CHANNELS                               /
/-----------------------------------------------*/
#define DMA_IP_DMAMUX_NOF_CHANNELS         DMAMUX_CHCFG_COUNT
#define DMA_IP_DMAMUX_REG_INDEX_CONV(x)    ((uint32)(x) ^ 3U)

/*-----------------------------------------------/
/  DMA INSTANCES                                 /
/-----------------------------------------------*/
#define DMA_IP_DMA_BASE0                   (IP_EDMA_0_MP_BASE)
#define DMA_IP_DMA_BASE0_PTR               ((Dma_Ip_Hwv3InstRegType *)DMA_IP_DMA_BASE0)
#define DMA_IP_DMA_BASE1                   (IP_EDMA_1_MP_BASE)
#define DMA_IP_DMA_BASE1_PTR               ((Dma_Ip_Hwv3InstRegType *)DMA_IP_DMA_BASE1)
#define DMA_IP_DMA_BASE_PTRS               {DMA_IP_DMA_BASE0_PTR, DMA_IP_DMA_BASE1_PTR}

#define DMA_IP_DMA_MP_GRPRI_COUNT          DMA_MP_GRPRI_COUNT
#define DMA_IP_DMA_NOF_HWV3_INST           DMA_INSTANCE_COUNT        /* Total number of hardware instances */

/*-----------------------------------------------/
/  DMA TCD CHANNELS                              /
/-----------------------------------------------*/
#define DMA_IP_TCD_BASE0                   (IP_EDMA_0_TCD_BASE)
#define DMA_IP_TCD_BASE0_PTR               ((Dma_Ip_Hwv3TcdArrayType *)DMA_IP_TCD_BASE0)
#define DMA_IP_TCD_BASE1                   (IP_EDMA_1_TCD_BASE)
#define DMA_IP_TCD_BASE1_PTR               ((Dma_Ip_Hwv3TcdArrayType *)DMA_IP_TCD_BASE1)
#define DMA_IP_TCD_BASE_PTRS               {DMA_IP_TCD_BASE0_PTR, DMA_IP_TCD_BASE1_PTR}

#define DMA_IP_TCD_RESERVED                (4032)           /* Reserved space between hardware TCDs */

#define DMA_IP_TCD_NOF_HWV3_CH_INST        DMA_TCD_INSTANCE_COUNT /* Number of hardware TCD instances */
#define DMA_IP_TCD_NOF_HWV3_CH             DMA_TCD_TCD_COUNT      /* Number of hardware channels */
...
#define DMA_IP_BASE_ADDR(instIdx) \
        ((uint32)(((instIdx)>0UL) ? \
        (DMA_IP_DMA_BASE1) : (DMA_IP_DMA_BASE0)))
...
#define DMA_IP_DMAMUX_BASE_ADDR(instIdx) \
        ( ((instIdx)==0UL) ? (IP_DMAMUX_0_BASE) : ( \
          ((instIdx)==1UL) ? (IP_DMAMUX_1_BASE) : ( \
          ((instIdx)==2UL) ? (IP_DMAMUX_2_BASE) : (IP_DMAMUX_3_BASE))) )
