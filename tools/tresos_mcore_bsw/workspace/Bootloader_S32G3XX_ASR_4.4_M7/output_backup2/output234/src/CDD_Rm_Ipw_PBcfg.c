...
#define RM_IPW_PBCFG_AR_RELEASE_MINOR_VERSION_C      4
#define RM_IPW_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define RM_IPW_PBCFG_SW_MAJOR_VERSION_C              4
...
#if (RM_IPW_PBCFG_VENDOR_ID_C != RM_MPU_M7_IP_VENDOR_ID)
    #error "CDD_Rm_Ipw_PBcfg.c and Mpu_M7_Ip.h have different vendor ids"
#endif
#if ((RM_IPW_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != RM_MPU_M7_IP_AR_RELEASE_MAJOR_VERSION) || \
     (RM_IPW_PBCFG_AR_RELEASE_MINOR_VERSION_C    != RM_MPU_M7_IP_AR_RELEASE_MINOR_VERSION) || \
     (RM_IPW_PBCFG_AR_RELEASE_REVISION_VERSION_C != RM_MPU_M7_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Rm_Ipw_PBcfg.c and Mpu_M7_Ip.h are different"
#endif
#if ((RM_IPW_PBCFG_SW_MAJOR_VERSION_C != RM_MPU_M7_IP_SW_MAJOR_VERSION) || \
     (RM_IPW_PBCFG_SW_MINOR_VERSION_C != RM_MPU_M7_IP_SW_MINOR_VERSION) || \
     (RM_IPW_PBCFG_SW_PATCH_VERSION_C != RM_MPU_M7_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Rm_Ipw_PBcfg.c and Mpu_M7_Ip.h are different"
#endif
/*==================================================================================================
