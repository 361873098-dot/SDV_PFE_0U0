...
#define FLEXRAY_IP_TYPES_SW_MAJOR_VERSION                 4
#define FLEXRAY_IP_TYPES_SW_MINOR_VERSION                 0
#define FLEXRAY_IP_TYPES_SW_PATCH_VERSION                 2
...
/* Check if current file and Flexray_Ip_Cfg.h header file are of the same vendor */
    ...
    #error "Flexray_Ip_Types.h and Flexray_Ip_Cfg.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_Ip_Cfg.h header file are of the same Autosar version */
    ...
    #error "Software Version Numbers of Flexray_Ip_Types.h and Flexray_Ip_Cfg.h are different"
#endif
/* Check if current file and Flexray_Ip_Cfg.h header file are of the same software version */
    ...
    #error "Autosar Version Numbers of Flexray_Ip_Types.h and Flexray_Ip_Cfg.h are different"
#endif
/*==================================================================================================
...
* @implements Flexray_Ip_StatusType_enumeration
***************************************************************************************************/
typedef enum
{
    /* Generic error codes */
 ...
 *
 * @implements  Flexray_Ip_ChiCmdType_enumeration
 */
typedef enum
{
 ...
 * @implements  Flexray_Ip_PocStateType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_ExtClkCorrectType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_GlobalIntType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_WakeupStatusType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_StartupStatusType_enumeration
 */
 ...
 *
 * @implements  Flexray_Ip_ProtocolIntType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_ChiIntType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_WakeUpChannelType_enumeration
 */
typedef enum
{
 ...
 *
 * @implements  Flexray_Ip_TimerType_enumeration
 */
typedef enum
{
    FLEXRAY_TIMER1,
 ...
 *
 * @implements  Flexray_Ip_CallbackType_typedef
 */
 ...
 * param[in] callbackParam    callback parameters for user
 *
 * @implements  Flexray_Ip_PrCallbackType_typedef
 */
 ...
 * param[in] callbackParam    callback parameters for user
 *
 * @implements  Flexray_Ip_ChiCallbackType_typedef
 */
 ...
 * param[in] callbackParam    callback parameters for user
 *
 * @implements  Flexray_Ip_IndCallbackType_typedef
 */
 ...
 *
 * @implements  Flexray_Ip_UserCallbackType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_FrameHeaderType_struct
 */
typedef struct
{
    boolean reservedBit;
 ...
 *
 * @implements  Flexray_Ip_IndConfigType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_ShadowConfigType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_CounterConfigType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_PeConfigType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_ConfigType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_StateAllocateType_struct
 */
typedef struct
{
 ...
 *
 * @implements  Flexray_Ip_TimerConfigType_struct
 */
typedef struct
{
