1. Example Description
    ...
    The application includes an EB Tresos project that configures the Base, EcuC, Rm and Resource drivers
    1.1 The application software functionality
        - Rm_Init configure MPU to have access right for PERIPHERAL_ADDR
        - Override exception handlers.
        - Try to write PATTERN to PERIPHERAL_ADDR.
        - Verify that no memfault handler occur.
        - Try to use Rm_Mpu_M7_SetAccessRight to take away right access of core for PERIPHERAL_ADDR and Try to write PATTERN to PERIPHERAL_ADDR. This should trigger an exception for memory management.
        - Verify that memfault handler occur and detail error for MPU is correct
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - X-S32R45-PROC-S PCB REV X3 SCH REV B (Daughtercard)
