...
typedef struct {
  __IO uint32_t PCFS_SDUR;                         /**< PCFS Step Duration, offset: 0x0, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_0[132];
  __IO uint32_t PCFS_DIVC12;                       /**< PCFS Divider Change 12 Register, offset: 0x88, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t PCFS_DIVE12;                       /**< PCFS Divider End 12 Register, offset: 0x8C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t PCFS_DIVS12;                       /**< PCFS Divider Start 12 Register, offset: 0x90, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  ...
  __IO uint32_t MUX_0_DC_0;                        /**< Clock Mux 0 Divider 0 Control Register, offset: 0x308, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_0_DC_1;                        /**< Clock Mux 0 Divider 1 Control Register, offset: 0x30C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_2[44];
  __I  uint32_t MUX_0_DIV_UPD_STAT;                /**< Clock Mux 0 Divider Update Status Register, offset: 0x33C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_1_CSC;                         /**< Clock Mux 1 Select Control Register, offset: 0x340, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_1_CSS;                         /**< Clock Mux 1 Select Status Register, offset: 0x344, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_1_DC_0;                        /**< Clock Mux 1 Divider 0 Control Register, offset: 0x348, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_3[48];
  __I  uint32_t MUX_1_DIV_UPD_STAT;                /**< Clock Mux 1 Divider Update Status Register, offset: 0x37C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_2_CSC;                         /**< Clock Mux 2 Select Control Register, offset: 0x380, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_2_CSS;                         /**< Clock Mux 2 Select Status Register, offset: 0x384, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_2_DC_0;                        /**< Clock Mux 2 Divider 0 Control Register, offset: 0x388, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_4[48];
  __I  uint32_t MUX_2_DIV_UPD_STAT;                /**< Clock Mux 2 Divider Update Status Register, offset: 0x3BC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_3_CSC;                         /**< Clock Mux 3 Select Control Register, offset: 0x3C0, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_3_CSS;                         /**< Clock Mux 3 Select Status Register, offset: 0x3C4, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_3_DC_0;                        /**< Clock Mux 3 Divider 0 Control Register, offset: 0x3C8, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_5[48];
  __I  uint32_t MUX_3_DIV_UPD_STAT;                /**< Clock Mux 3 Divider Update Status Register, offset: 0x3FC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_4_CSC;                         /**< Clock Mux 4 Select Control Register, offset: 0x400, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_4_CSS;                         /**< Clock Mux 4 Select Status Register, offset: 0x404, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_4_DC_0;                        /**< Clock Mux 4 Divider 0 Control Register, offset: 0x408, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_6[48];
  __I  uint32_t MUX_4_DIV_UPD_STAT;                /**< Clock Mux 4 Divider Update Status Register, offset: 0x43C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_5_CSC;                         /**< Clock Mux 5 Select Control Register, offset: 0x440, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_5_CSS;                         /**< Clock Mux 5 Select Status Register, offset: 0x444, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_5_DC_0;                        /**< Clock Mux 5 Divider 0 Control Register, offset: 0x448, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_7[48];
  __I  uint32_t MUX_5_DIV_UPD_STAT;                /**< Clock Mux 5 Divider Update Status Register, offset: 0x47C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_6_CSC;                         /**< Clock Mux 6 Select Control Register, offset: 0x480, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_6_CSS;                         /**< Clock Mux 6 Select Status Register, offset: 0x484, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_6_DC_0;                        /**< Clock Mux 6 Divider 0 Control Register, offset: 0x488, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_8[48];
  __I  uint32_t MUX_6_DIV_UPD_STAT;                /**< Clock Mux 6 Divider Update Status Register, offset: 0x4BC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_7_CSC;                         /**< Clock Mux 7 Select Control Register, offset: 0x4C0, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_7_CSS;                         /**< Clock Mux 7 Select Status Register, offset: 0x4C4, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_9[56];
  __IO uint32_t MUX_8_CSC;                         /**< Clock Mux 8 Select Control Register, offset: 0x500, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_8_CSS;                         /**< Clock Mux 8 Select Status Register, offset: 0x504, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_10[56];
  __IO uint32_t MUX_9_CSC;                         /**< Clock Mux 9 Select Control Register, offset: 0x540, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_9_CSS;                         /**< Clock Mux 9 Select Status Register, offset: 0x544, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_9_DC_0;                        /**< Clock Mux 9 Divider 0 Control Register, offset: 0x548, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_11[48];
  __I  uint32_t MUX_9_DIV_UPD_STAT;                /**< Clock Mux 9 Divider Update Status Register, offset: 0x57C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_10_CSC;                        /**< Clock Mux 10 Select Control Register, offset: 0x580, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_10_CSS;                        /**< Clock Mux 10 Select Status Register, offset: 0x584, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_10_DC_0;                       /**< Clock Mux 10 Divider 0 Control Register, offset: 0x588, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_12[48];
  __I  uint32_t MUX_10_DIV_UPD_STAT;               /**< Clock Mux 10 Divider Update Status Register, offset: 0x5BC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_11_CSC;                        /**< Clock Mux 11 Select Control Register, offset: 0x5C0, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_11_CSS;                        /**< Clock Mux 11 Select Status Register, offset: 0x5C4, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_13[56];
  __IO uint32_t MUX_12_CSC;                        /**< Clock Mux 12 Select Control Register, offset: 0x600, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_12_CSS;                        /**< Clock Mux 12 Select Status Register, offset: 0x604, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_12_DC_0;                       /**< Clock Mux 12 Divider 0 Control Register, offset: 0x608, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_14[48];
  __I  uint32_t MUX_12_DIV_UPD_STAT;               /**< Clock Mux 12 Divider Update Status Register, offset: 0x63C, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_15[64];
  __IO uint32_t MUX_14_CSC;                        /**< Clock Mux 14 Select Control Register, offset: 0x680, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_14_CSS;                        /**< Clock Mux 14 Select Status Register, offset: 0x684, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_14_DC_0;                       /**< Clock Mux 14 Divider 0 Control Register, offset: 0x688, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_16[48];
  __I  uint32_t MUX_14_DIV_UPD_STAT;               /**< Clock Mux 14 Divider Update Status Register, offset: 0x6BC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_15_CSC;                        /**< Clock Mux 15 Select Control Register, offset: 0x6C0, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_15_CSS;                        /**< Clock Mux 15 Select Status Register, offset: 0x6C4, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_15_DC_0;                       /**< Clock Mux 15 Divider 0 Control Register, offset: 0x6C8, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  uint8_t RESERVED_17[48];
  __I  uint32_t MUX_15_DIV_UPD_STAT;               /**< Clock Mux 15 Divider Update Status Register, offset: 0x6FC, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __IO uint32_t MUX_16_CSC;                        /**< Clock Mux 16 Select Control Register, offset: 0x700, available only on: MC_CGM_0 (missing on MC_CGM_5) */
  __I  uint32_t MUX_16_CSS;                        /**< Clock Mux 16 Select Status Register, offset: 0x704, available only on: MC_CGM_0 (missing on MC_CGM_5) */
