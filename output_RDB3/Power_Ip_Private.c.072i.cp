...
OsIf_GetElapsed/7 (OsIf_GetElapsed) @075c8e00
  Type: function
  ...
  Calls: 
OsIf_MicrosToTicks/6 (OsIf_MicrosToTicks) @075c8c40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OsIf_GetCounter/5 (OsIf_GetCounter) @075c8b60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: Power_Ip_StartTimeout/2 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
Power_Ip_pfReportErrorsCallback/4 (Power_Ip_pfReportErrorsCallback) @075ce1f8
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
Power_Ip_TimeoutExpired/3 (Power_Ip_TimeoutExpired) @075c8540
...
Power_Ip_StartTimeout/2 (Power_Ip_StartTimeout) @075c82a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Power_Ip_ReportPowerErrorsEmptyCallback/1 (Power_Ip_ReportPowerErrorsEmptyCallback) @075c8000
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
Power_Ip_ReportPowerErrors/0 (Power_Ip_ReportPowerErrors) @075be2a0
  Type: function definition analyzed
  Visibility: externally_visible public
...
;; Function Power_Ip_ReportPowerErrors (Power_Ip_ReportPowerErrors, funcdef_no=0, decl_uid=6517, cgraph_uid=1, symbol_order=0)
...
{
  void (*<T584>) (Power_Ip_ReportErrorType, uint8) Power_Ip_pfReportErrorsCallback.0_1;
...
;; Function Power_Ip_ReportPowerErrorsEmptyCallback (Power_Ip_ReportPowerErrorsEmptyCallback, funcdef_no=1, decl_uid=6520, cgraph_uid=2, symbol_order=1)
...
;; Function Power_Ip_StartTimeout (Power_Ip_StartTimeout, funcdef_no=2, decl_uid=6525, cgraph_uid=3, symbol_order=2)
...
;; Function Power_Ip_TimeoutExpired (Power_Ip_TimeoutExpired, funcdef_no=3, decl_uid=6529, cgraph_uid=4, symbol_order=3)
