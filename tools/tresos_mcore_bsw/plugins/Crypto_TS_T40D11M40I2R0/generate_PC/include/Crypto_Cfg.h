...
#define CRYPTO_SW_MAJOR_VERSION_CFG                4
...
/* Support for SHE */
#define CRYPTO_SPT_SHE                                  ([!"ecu:get(concat('Crypto.HseSptShe.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for Miyaguchi-Preneel compression function (SHE spec support) */
#define CRYPTO_SPT_MP                                   ([!"ecu:get(concat('Crypto.HseSptMP.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for AES */
#define CRYPTO_SPT_AES                                  ([!"ecu:get(concat('Crypto.HseSptAes.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_AES_CBC                          ([!"ecu:get(concat('Crypto.HseSptAesCbc.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_AES_CFB                          ([!"ecu:get(concat('Crypto.HseSptAesCfb.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_AES_CTR                          ([!"ecu:get(concat('Crypto.HseSptAesCtr.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_AES_ECB                          ([!"ecu:get(concat('Crypto.HseSptAesEcb.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_AES_OFB                          ([!"ecu:get(concat('Crypto.HseSptAesOfb.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for AEAD */
#define CRYPTO_SPT_AEAD                                 ([!"ecu:get(concat('Crypto.HseSptAead.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for MAC */
#define CRYPTO_SPT_MAC                                  ([!"ecu:get(concat('Crypto.HseSptMac.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_CMAC                             ([!"ecu:get(concat('Crypto.HseSptCmac.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_FAST_CMAC                        ([!"ecu:get(concat('Crypto.HseSptFastCmac.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_GMAC                             ([!"ecu:get(concat('Crypto.HseSptGmac.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_HMAC                             ([!"ecu:get(concat('Crypto.HseSptHmac.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_XCBCMAC                          ([!"ecu:get(concat('Crypto.HseSptXCbcmac.',  string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for HASH primitives */
#define CRYPTO_SPT_HASH                                 ([!"ecu:get(concat('Crypto.HseSptHash.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_MD5                              ([!"ecu:get(concat('Crypto.HseSptMd5.',          string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA1                             ([!"ecu:get(concat('Crypto.HseSptSha1.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_224                         ([!"ecu:get(concat('Crypto.HseSptSha2_224.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_256                         ([!"ecu:get(concat('Crypto.HseSptSha2_256.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_384                         ([!"ecu:get(concat('Crypto.HseSptSha2_384.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_512                         ([!"ecu:get(concat('Crypto.HseSptSha2_512.',     string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_512_224                     ([!"ecu:get(concat('Crypto.HseSptSha2_512_224.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA2_512_256                     ([!"ecu:get(concat('Crypto.HseSptSha2_512_256.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SHA3                             ([!"ecu:get(concat('Crypto.HseSptSha3.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for SIPHASH primitive */
#define CRYPTO_SPT_SIPHASH                              ([!"ecu:get(concat('Crypto.HseSptSiphash.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for RSA primitives */
#define CRYPTO_SPT_RSA                                  ([!"ecu:get(concat('Crypto.HseSptRsa.',                    string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_RSAES_NO_PADDING                 ([!"ecu:get(concat('Crypto.HseSptRsaesNoPadding.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSAES_OAEP                       ([!"ecu:get(concat('Crypto.HseSptRsaesOaep.',              string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSAES_PCKS1_V15                  ([!"ecu:get(concat('Crypto.HseSptRsaesPkcs1V15.',          string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSAASSA_PSS                      ([!"ecu:get(concat('Crypto.HseSptRsassaPss.',              string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSASSA_PCKS1_V15                 ([!"ecu:get(concat('Crypto.HseSptRsassaPkcs1V15.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for ECC primitives */
#define CRYPTO_SPT_ECC                                  ([!"ecu:get(concat('Crypto.HseSptEcc.',                    string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_EDDSA                            ([!"ecu:get(concat('Crypto.HseSptEddsa.',                  string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_ECDSA                            ([!"ecu:get(concat('Crypto.HseSptEcdsa.',                  string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SECP256R1                        ([!"ecu:get(concat('Crypto.HseSptEcSecSecp256R1.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SECP384R1                        ([!"ecu:get(concat('Crypto.HseSptEcSecSecp384R1.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SECP521R1                        ([!"ecu:get(concat('Crypto.HseSptEcSecSecp521R1.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_BRAINPOOLP256R1                  ([!"ecu:get(concat('Crypto.HseSptEcBrainpoolP256R1.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_BRAINPOOLP320R1                  ([!"ecu:get(concat('Crypto.HseSptEcBrainpoolP320R1.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_BRAINPOOLP384R1                  ([!"ecu:get(concat('Crypto.HseSptEcBrainpoolP384R1.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_BRAINPOOLP512R1                  ([!"ecu:get(concat('Crypto.HseSptEcBrainpoolP512R1.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_EC25519_ED25519                  ([!"ecu:get(concat('Crypto.HseSptEc25519Ed25519.',         string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_EC25519_ED25519PH                ([!"ecu:get(concat('Crypto.HseSptEc25519Ed25519PH.',       string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_EC25519_CURVE25519               ([!"ecu:get(concat('Crypto.HseSptEc25519Curve25519.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_EC448_ED448                      ([!"ecu:get(concat('Crypto.HseSptEc448Ed448.',             string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_EC448_CURVE448                   ([!"ecu:get(concat('Crypto.HseSptEc448Curve448.',          string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for various key operations */
#define CRYPTO_SPT_KEY_IMPORT                           ([!"ecu:get(concat('Crypto.HseSptKeyImport.',             string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_SHE_KEY_IMPORT                   ([!"ecu:get(concat('Crypto.HseSptSheKeyImport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SYM_KEY_IMPORT                   ([!"ecu:get(concat('Crypto.HseSptSymKeyImport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSA_KEY_IMPORT                   ([!"ecu:get(concat('Crypto.HseSptRsaKeyImport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_ECC_KEY_IMPORT                   ([!"ecu:get(concat('Crypto.HseSptEccKeyImport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_ENC_AUTH_KEY_IMPORT              ([!"ecu:get(concat('Crypto.HseSptEncAuthKeyImport.',       string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
#define CRYPTO_SPT_KEY_EXPORT                           ([!"ecu:get(concat('Crypto.HseSptKeyExport.',              string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_SHE_KEY_EXPORT                   ([!"ecu:get(concat('Crypto.HseSptSheKeyExport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_SYM_KEY_EXPORT                   ([!"ecu:get(concat('Crypto.HseSptSymKeyExport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSA_KEY_EXPORT                   ([!"ecu:get(concat('Crypto.HseSptRsaKeyExport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_ECC_KEY_EXPORT                   ([!"ecu:get(concat('Crypto.HseSptEccKeyExport.',           string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
#define CRYPTO_SPT_FORMATKEYCATALOGS                    ([!"ecu:get(concat('Crypto.HseSptFormatKeyCatalogs.',      string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
#define CRYPTO_SPT_GETKEYINFO                           ([!"ecu:get(concat('Crypto.HseSptGetKeyInfo.',             string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
#define CRYPTO_SPT_KEY_VERIFY                           ([!"ecu:get(concat('Crypto.HseSptKeyVerify.',             string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for key derivation */
#define CRYPTO_SPT_KEY_DERIVE                           ([!"ecu:get(concat('Crypto.HseSptKeyDerive.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_KDF_ANS_X963                     ([!"ecu:get(concat('Crypto.HseSptKDFAnsX963.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_PBKDF2                           ([!"ecu:get(concat('Crypto.HseSptPBKDF2.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_KDFTLS_12PRF                     ([!"ecu:get(concat('Crypto.HseSptKdfTls12Prf.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for Diffie-Hellman Compute Key */
#define CRYPTO_SPT_COMPUTE_DH                           ([!"ecu:get(concat('Crypto.HseSptComputeDH.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for key generation */
#define CRYPTO_SPT_KEY_GENERATE                         ([!"ecu:get(concat('Crypto.HseSptKeyGenerate.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
[!INDENT "4"!]#define CRYPTO_SPT_SYM_RND_KEY_GEN                  ([!"ecu:get(concat('Crypto.HseSptSymRndKeyGen.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_RSA_KEY_PAIR_GEN                 ([!"ecu:get(concat('Crypto.HseSptRsaKeyPairGen.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_ECC_KEY_PAIR_GEN                 ([!"ecu:get(concat('Crypto.HseSptEccKeyPairGen.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//
[!INDENT "4"!]#define CRYPTO_SPT_CLASSIC_DH_KEY_PAIR_GEN          ([!"ecu:get(concat('Crypto.HseSptClassicDHKeyPairGen.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])[!CR!][!ENDINDENT!][!//

/* Support for Cipher modes flags for AES keys */
#define CRYPTO_AES_BLOCK_MODE_MASK                      ([!"ecu:get(concat('Crypto.HseAesBlockModeMask.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for HSE ECC key format */
#define CRYPTO_ECC_KEY_FORMAT                           ([!"ecu:get(concat('Crypto.HseEccKeyFormat.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])

/* Support for Compressed ECC key format */
#define CRYPTO_ECC_COMPRESSED_FORMAT                    ([!"ecu:get(concat('Crypto.HseEccCompressedFormat.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM'))))"!])
...
[!IF "node:value(CryptoGeneral/CryptoEnableTCMSupport)='true'"!][!//
    ...
    [!CODE!][!INDENT "4"!]#define CRYPTO_ITCM_ADDR_START_U32                  ([!"ecu:get('Crypto.ItcmAddrStart')"!]U)[!CR!][!ENDINDENT!][!ENDCODE!][!//
    [!CODE!][!INDENT "4"!]#define CRYPTO_ITCM_ADDR_END_U32                    ([!"ecu:get('Crypto.ItcmAddrEnd')"!]U)[!CR!][!ENDINDENT!][!ENDCODE!][!//
    [!CODE!][!INDENT "4"!]#define CRYPTO_DTCM_ADDR_START_U32                  ([!"ecu:get('Crypto.DtcmAddrStart')"!]U)[!CR!][!ENDINDENT!][!ENDCODE!][!//
    [!CODE!][!INDENT "4"!]#define CRYPTO_DTCM_ADDR_END_U32                    ([!"ecu:get('Crypto.DtcmAddrEnd')"!]U)[!CR!][!ENDINDENT!][!ENDCODE!][!//
[!ELSE!][!//
...
[!IF "ecu:get(concat('Crypto.HseSptEncAuthKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
    [!VAR "Import" = "'STD_OFF'"!][!//
    [!LOOP "CryptoKeyElements/CryptoKeyElement/*"!][!//
...
[!IF "ecu:get(concat('Crypto.HseSptEncAuthKeyExport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
    [!VAR "Export" = "'STD_OFF'"!][!//
    [!LOOP "CryptoKeyElements/CryptoKeyElement/*"!][!//
...
==================================================================================================*/
[!IF "node:exists(CryptoKeys)"!][!//
[!IF "ecu:get(concat('Crypto.HseSptEncAuthKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON' or
      ecu:get(concat('Crypto.HseSptEncAuthKeyExport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
typedef struct
{
...
[!ENDIF!][!//
[!IF "ecu:get(concat('Crypto.HseSptEccKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
    const   uint8                            u8HseEccCurveId;
[!ENDIF!][!//
[!IF "ecu:get(concat('Crypto.HseSptSymKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON' or
      ecu:get(concat('Crypto.HseSptRsaKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON' or
      ecu:get(concat('Crypto.HseSptEccKeyImport.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON' or
      ecu:get(concat('Crypto.HseSptKeyDerive.',    string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
...
[!IF "ecu:get(concat('Crypto.HseSptFormatKeyCatalogs.', string(node:fallback(CryptoGeneral/HseFwType,'PREMIUM')))) = 'STD_ON'"!][!//
