...
#define FTM_OCU_IP_SW_MAJOR_VERSION_C                4
#define FTM_OCU_IP_SW_MINOR_VERSION_C                0
#define FTM_OCU_IP_SW_PATCH_VERSION_C                2
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
Ftm_Ocu_Ip_ChStateType Ftm_Ocu_Ip_gaxChState[OCU_FTM_INSTANCE_COUNT][OCU_FTM_CHANNEL_COUNT] = {{{(boolean)FALSE, (boolean)FALSE, NULL_PTR, (uint16)OCU_FTM_INVALID_CHANNEL_NUM}}};
#endif
