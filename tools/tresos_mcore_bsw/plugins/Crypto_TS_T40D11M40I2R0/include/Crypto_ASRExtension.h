...
#define CRYPTO_SW_MAJOR_VERSION_ASREXTENSION_H                4
#define CRYPTO_SW_MINOR_VERSION_ASREXTENSION_H                0
#define CRYPTO_SW_PATCH_VERSION_ASREXTENSION_H                2
...
#endif
#ifndef CRYPTO_ALGOFAM_CUSTOM_ED448
    #define CRYPTO_ALGOFAM_CUSTOM_ED448                            ((uint8)0x84U)
#endif

#ifndef CRYPTO_ALGOFAM_CUSTOM_ED25519PH
    #define CRYPTO_ALGOFAM_CUSTOM_ED25519PH                        ((uint8)0x85U) /*ED22519 elliptic curve with pre-hash*/
#endif

/**
* @brief Defines for Crypto Encryption Scheme
* */
#define CRYPTO_ENC_SCHEME_NONE  ((uint8)0x00U)
#define CRYPTO_ENC_SCHEME_SYM   ((uint8)0x01U)
#define CRYPTO_ENC_SCHEME_AEAD  ((uint8)0x02U)
#define CRYPTO_ENC_SCHEME_RSA   ((uint8)0x03U)

/**
* @brief Defines for Crypto Authentication Scheme
* */
#define CRYPTO_AUTH_SCHEME_NONE ((uint8)0x00U)
#define CRYPTO_AUTH_SCHEME_MAC  ((uint8)0x01U)
#define CRYPTO_AUTH_SCHEME_SIGN ((uint8)0x02U)
...
typedef uint8 Crypto_EncSchemeType;
/** @brief Type define used for Crypto Authentication Scheme selection. */
typedef uint8 Crypto_AuthSchemeType;
...
typedef struct 
{
    ...
    {   /** @brief Crypto Encryption Scheme selection.
         ...
         *           SYM, AEAD, RSA.
         */
        Crypto_EncSchemeType  SelEncryptionScheme;
    ...
    struct
    {
         ...
         *           MAC, SIGN.
         */
        Crypto_AuthSchemeType SelAuthenticationScheme;
