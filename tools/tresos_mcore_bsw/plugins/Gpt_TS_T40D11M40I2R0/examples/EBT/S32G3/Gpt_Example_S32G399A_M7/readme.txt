...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - S32G-VNP-RDB3 PCB SCH-53060_E1
        2.1.2 Connections
            - RGB LED BLUE   (PA_06 - gpio LED blink)(need SW11 = ON to check)
            - RGB LED RED    (PA_07 - gpio LED blink)(need SW11 = ON to check)
            - RGB LED GREEN  (PF_15 - gpio LED blink)(need SW11 = ON to check)
        2.1.3 Debugger
