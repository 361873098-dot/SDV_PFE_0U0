...
[!IF "node:exists(EthGeneral/EthVendorSpecific/PfeChannelBdFlushApi)"!][!//
    #define ETH_43_PFE_CHANNEL_BD_FLUSH_API   ([!IF "EthGeneral/EthVendorSpecific/PfeChannelBdFlushApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!ELSE!][!//
    #define ETH_43_PFE_CHANNEL_BD_FLUSH_API   (STD_OFF)
[!ENDIF!][!//
    /*! @brief Max BDP flush loops per a single API call. 0 to disable the limit. */
[!IF "node:exists(EthGeneral/EthVendorSpecific/PfeChannelBdFlushMaxBdCount)"!][!//
    #define ETH_43_PFE_CHANNEL_BD_FLUSH_MAX_TICK_COUNT  ([!"num:i(EthGeneral/EthVendorSpecific/PfeChannelBdFlushMaxBdCount)"!]U)
[!ELSE!][!//
...
[!IF "node:exists(EthGeneral/EthVendorSpecific/PfeChannelBdFlushTimeoutCounter)"!][!//
    #define ETH_43_PFE_CHANNEL_BD_FLUSH_TIMEOUT_COUNTER   ([!"num:i(EthGeneral/EthVendorSpecific/PfeChannelBdFlushTimeoutCounter)"!]U)
[!ELSE!][!//
...
[!IF "node:exists(EthGeneral/EthVendorSpecific/PfeIdexRpcResendTime)"!][!//
    #define PFE_CFG_IDEX_RESEND_DELAY_MS  ([!"num:i(EthGeneral/EthVendorSpecific/PfeIdexRpcResendTime)"!]U)
[!ELSE!][!//
    #define PFE_CFG_IDEX_RESEND_DELAY_MS  (100U)
[!ENDIF!][!//

    /*! @brief IDEX request maximum retry count. */
[!IF "node:exists(EthGeneral/EthVendorSpecific/PfeIdexRpcResendCount)"!][!//
    #define PFE_CFG_IDEX_RESEND_COUNT  ([!"num:i(EthGeneral/EthVendorSpecific/PfeIdexRpcResendCount)"!]U)
[!ELSE!][!//
...
#define ETH_43_PFE_ENABLE_USER_MODE_SUPPORT              ([!IF "EthGeneral/EthVendorSpecific/EthEnableUserModeSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
    ...
    [!IF "node:exists(EthGeneral/EthVendorSpecific/FwFeaturesBufferSize)"!][!//
    #define ETH_43_PFE_FEATURES_SECTION_BUFF_SIZE   ([!"num:i(EthGeneral/EthVendorSpecific/FwFeaturesBufferSize)"!]U)
    [!ELSE!][!//
    #define ETH_43_PFE_FEATURES_SECTION_BUFF_SIZE   (1U)
    [!ENDIF!][!//
    /*! @brief Size of buffer for copy .messages section from fw elf file. */
    [!IF "node:exists(EthGeneral/EthVendorSpecific/FwMessagesBufferSize)"!][!//
    #define ETH_43_PFE_MESSAGES_SECTION_BUFF_SIZE   ([!"num:i(EthGeneral/EthVendorSpecific/FwMessagesBufferSize)"!]U)
    [!ELSE!][!//
    #define ETH_43_PFE_MESSAGES_SECTION_BUFF_SIZE   (1U)
    [!ENDIF!][!//
