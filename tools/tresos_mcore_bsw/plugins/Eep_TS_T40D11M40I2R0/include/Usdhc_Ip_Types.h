...
#define USDHC_IP_TYPES_AR_RELEASE_MINOR_VERSION_H        4
#define USDHC_IP_TYPES_AR_RELEASE_REVISION_VERSION_H     0
#define USDHC_IP_TYPES_SW_MAJOR_VERSION_H                4
#define USDHC_IP_TYPES_SW_MINOR_VERSION_H                0
#define USDHC_IP_TYPES_SW_PATCH_VERSION_H                2
...
typedef struct
{
    ...
    boolean                      EepEnableAutoCMD12;    /* Set this field to true then uSDHC will send"CMD12" command automatically after data transfer is end */
