...
#ifndef MCL_PBCFG_VS_0_H
#define MCL_PBCFG_VS_0_H
...
#define CDD_MCL_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION      4
#define CDD_MCL_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION   0
#define CDD_MCL_VS_0_PBCFG_SW_MAJOR_VERSION              4
#define CDD_MCL_VS_0_PBCFG_SW_MINOR_VERSION              0
#define CDD_MCL_VS_0_PBCFG_SW_PATCH_VERSION              2
