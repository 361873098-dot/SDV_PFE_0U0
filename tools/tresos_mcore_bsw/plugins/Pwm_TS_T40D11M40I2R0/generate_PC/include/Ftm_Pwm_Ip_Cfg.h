...
#define FTM_PWM_IP_CFG_SW_MAJOR_VERSION             4
#define FTM_PWM_IP_CFG_SW_MINOR_VERSION             0
#define FTM_PWM_IP_CFG_SW_PATCH_VERSION             2
...
[!IF "ecu:get('Pwm.FTM_PWM_HAS_MODULE_SINGLE_INTERRUPT') = 'true'"!]
    [!LOOP "as:modconf('Pwm')[1]/PwmChannelConfigSet/PwmFtm/*"!]
        [!VAR "HwInstance" = "substring-after(./PwmHwInstance,'Ftm_')"!]
        [!IF "(./PwmFtmInstCfg/PwmFtmOverflowIrq = 'true') or (./../../../PwmGeneral/PwmNotificationSupported = 'true') or ((./PwmFtmInstCfg/PwmFtmReloadIrq = 'true'))"!]
            [!CODE!]
