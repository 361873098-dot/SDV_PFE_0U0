...
[!LOOP "SerdesGlobalConfig/SerdesChannel/*"!] /* Loop through all configured channels */
    [!IF "contains(SerdesHwChannel,'Serdes')"!] /* Select only Serdes channels */
[!CODE!]
/*XPCS0 enabled */
#define [!"text:toupper(SerdesHwChannel)"!]_XPCS0_ENABLED   ([!IF "UseXpcs0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/*XPCS1 enabled */
#define [!"text:toupper(SerdesHwChannel)"!]_XPCS1_ENABLED   ([!IF "UseXpcs1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!CODE!]
/*XPCS0 enabled */
#define [!"text:toupper(SerdesHwChannel)"!]_USED   ([!IF "UseXpcs0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

[!ENDCODE!]
    [!ENDIF!] /* End of Select only Serdes channels */
[!ENDLOOP!] /* End of the loop */

[!CODE!]
/* Define User Mode */
#define SERDES_IP_ENABLE_USER_MODE_SUPPORT    ([!IF "SerdesGeneral/SerdesEnableUserModeSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!ENDCODE!]
...
*/
#define SERDES_IP_TIMEOUT_U32                  ([!"num:i(SerdesGeneral/SerdesTimeoutDuration)"!]UL)
#define SERDES_IP_TIMEOUT_TYPE             ([!"(SerdesGeneral/SerdesTimeoutMethod)"!])
[!ENDCODE!]
