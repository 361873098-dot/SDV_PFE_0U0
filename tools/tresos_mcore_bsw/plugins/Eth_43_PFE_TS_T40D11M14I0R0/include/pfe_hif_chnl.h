...
bool_t pfe_hif_chnl_can_accept_tx_num(const pfe_hif_chnl_t *chnl, uint16_t number) __attribute__((pure, hot));
...
/*  Instance control */
errno_t pfe_hif_chnl_create_mcal(pfe_hif_chnl_t *chnl, addr_t cbus_base_va, uint32_t id, const pfe_bmu_t *bmu) __attribute__((cold));
errno_t pfe_hif_chnl_create_minihif(pfe_hif_chnl_t *chnl, addr_t cbus_base_va, uint32_t id, pfe_hif_ring_t *rx_ring, pfe_hif_ring_t *tx_ring) __attribute__((cold));
