        ...
        *reply_len = 0U;
        ...
        switch(if_cmd->action)
        {
            ...
            case FPP_ACTION_QUERY_CONT:
            {
                ...
                {
                    reply_buf->flags |= (uint32_t)oal_htonl(FPP_IF_LOOPBACK);
                }
                ...
                {
                    (void)autolibc_memcpy(  &reply_buf->arguments.ipv.v6,
                                            &args.ipv.v6,
                                            sizeof(reply_buf->arguments.ipv.v6));
                }
                else
                {
                    (void)autolibc_memcpy(  &reply_buf->arguments.ipv.v4,
                                            &args.ipv.v4,
                                            sizeof(reply_buf->arguments.ipv.v4));
                }
