...
Sys_GetCoreID/17 (Sys_GetCoreID) @06dc2c40
  Type: function
  ...
  Calls: 
Det_Start/16 (Det_Start) @06dc2700
...
Det_ReportTransientFault/15 (Det_ReportTransientFault) @06dc2460
  Type: function definition analyzed
  Visibility: externally_visible public
...
Det_ReportRuntimeError/14 (Det_ReportRuntimeError) @06dc21c0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/17 (1073741824 (estimated locally),1.00 per call) 
Det_ReportError/13 (Det_ReportError) @06dbdee0
  Type: function definition analyzed
  Visibility: externally_visible public
...
Det_Init/12 (Det_Init) @06dbde00
  ...
  Calls: 
Det_RuntimeModuleId/11 (Det_RuntimeModuleId) @06dbe360
  ...
  Availability: available
  Varpool flags:
Det_ModuleId/10 (Det_ModuleId) @06dbe318
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientModuleId/9 (Det_TransientModuleId) @06dbe2d0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Det_TransientFaultId/8 (Det_TransientFaultId) @06dbe288
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientApiId/7 (Det_TransientApiId) @06dbe240
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_TransientInstanceId/6 (Det_TransientInstanceId) @06dbe1f8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportTransientFault/15 (write)
  Availability: available
  Varpool flags:
Det_RuntimeErrorId/5 (Det_RuntimeErrorId) @06dbe1b0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeApiId/4 (Det_RuntimeApiId) @06dbe168
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_RuntimeInstanceId/3 (Det_RuntimeInstanceId) @06dbe120
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportRuntimeError/14 (write)
  Availability: available
  Varpool flags:
Det_ErrorId/2 (Det_ErrorId) @06dbe0d8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_ApiId/1 (Det_ApiId) @06dbe090
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
  Availability: available
  Varpool flags:
Det_InstanceId/0 (Det_InstanceId) @06dbe048
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Det_ReportError/13 (write)
...
;; Function Det_Init (Det_Init, funcdef_no=0, decl_uid=5657, cgraph_uid=1, symbol_order=12)
...
;; Function Det_ReportError (Det_ReportError, funcdef_no=1, decl_uid=5662, cgraph_uid=2, symbol_order=13)
...
;; Function Det_ReportRuntimeError (Det_ReportRuntimeError, funcdef_no=2, decl_uid=5667, cgraph_uid=3, symbol_order=14)
...
;; Function Det_ReportTransientFault (Det_ReportTransientFault, funcdef_no=3, decl_uid=5672, cgraph_uid=4, symbol_order=15)
...
;; Function Det_Start (Det_Start, funcdef_no=6, decl_uid=5674, cgraph_uid=5, symbol_order=16)
