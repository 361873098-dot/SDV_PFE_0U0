...
#define DMA_IP_DRIVER_STATE_SW_PATCH_VERSION_C                2
...
Dma_Ip_HwChannelStateType * Dma_Ip_InitHwChannelStatePointer(uint32 LocHwVers, uint32 LocHwInst, uint32 LocHwCh, Dma_Ip_HwChannelStateType * StatePointer)
{
    Dma_Ip_HwChannelStateType * PtStatePtr = NULL_PTR;
