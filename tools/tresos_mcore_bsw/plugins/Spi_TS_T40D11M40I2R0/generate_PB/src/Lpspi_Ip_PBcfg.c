...
#define LPSPI_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MAJOR_VERSION_PBCFG_C                 4
#define LPSPI_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MINOR_VERSION_PBCFG_C                 0
#define LPSPI_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_PBCFG_C                 2
    ...
    , LPSPI_CFGR1_OUTCFG(1u)[!ENDCODE!] 
        [!IF "node:exists(SpiTransferWidth)"!]
            ...
            [!IF "(SpiTransferWidth = 'TRANSFER_1_BIT')"!]
                ...
                [!IF "contains($DerivativeName, 'S32K') or contains($DerivativeName, 'S32M') or contains($DerivativeName, 'S32G')"!][!//
