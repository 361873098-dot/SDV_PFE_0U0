...
Not considering SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00 for cloning; -fipa-cp-clone disabled.
Not considering SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00 for cloning; -fipa-cp-clone disabled.
Not considering Ipcf_schm_read_msr for cloning; -fipa-cp-clone disabled.
...
Sys_GetCoreID/5 (Sys_GetCoreID) @06d5dee0
  Type: function
  ...
  Calls: 
SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00/4 (SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00) @06d5d9a0
...
SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00/3 (SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00) @06d5d700
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/5 (1073741824 (estimated locally),1.00 per call) 
Ipcf_schm_read_msr/2 (Ipcf_schm_read_msr) @06d5d380
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
reentry_guard_IPCF_EXCLUSIVE_AREA_00/1 (reentry_guard_IPCF_EXCLUSIVE_AREA_00) @06d59bd0
  ...
  Availability: available
  Varpool flags:
msr_IPCF_EXCLUSIVE_AREA_00/0 (msr_IPCF_EXCLUSIVE_AREA_00) @06d59b40
  Type: variable definition analyzed
  Visibility: force_output prevailing_def_ironly
  References: 
...
;; Function Ipcf_schm_read_msr (Ipcf_schm_read_msr, funcdef_no=0, decl_uid=5651, cgraph_uid=1, symbol_order=2)
...
;; Function SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00 (SchM_Enter_Ipcf_IPCF_EXCLUSIVE_AREA_00, funcdef_no=1, decl_uid=5645, cgraph_uid=2, symbol_order=3)
...
;; Function SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00 (SchM_Exit_Ipcf_IPCF_EXCLUSIVE_AREA_00, funcdef_no=2, decl_uid=5647, cgraph_uid=3, symbol_order=4)
