...
#define GPT_IPW_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C             4
#define GPT_IPW_SW_MINOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C             0
#define GPT_IPW_SW_PATCH_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C             2
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.c and Pit_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.c and Stm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.c and Rtc_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
        ...
        [!CODE!]Gpt_Ipw_HwInstanceConfigType Gpt_Ipw_HwInstanceConfig_[!"$PBCfg_Variant"!][!IF "$GptEcucPartitionRefCount != 0 "!]_P_[!"$PartitionIndex"!][!ENDIF!][[!"num:i($OutNumInstancesInPartition)"!]U]=[!CR!]{[!CR!][!ENDCODE!]
            ...
            [!CODE!][!WS "4"!]}[!CR!][!ENDCODE!]
                    ...
                    [!IF "node:exists(GptPit/*/GptPitModule[contains(., concat('PIT_',$Instance))]) and
                         (node:exists(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[(node:refs(GptModuleRef)/../../GptPitModule = concat('PIT_',$Instance)) and (node:value(./GptChannelEcucPartitionRef/*[1]) = $GptEcucPartitionRefName)]))"!][!//
            [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!][!//
                        [!CODE!][!WS "8"!]/** @brief IP type  */[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]GPT_PIT_MODULE,[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]/** @brief IP instance */[!CR!][!ENDCODE!]
            ...
            [!VAR "InstanceCfgCount" = "num:i(count(as:modconf('Gpt')[1]/GptChannelConfigSet/GptStm/*))"!][!//
                [!FOR "Instance" = "0" TO "num:i(ecu:list('Gpt.Num_Stm_Hw_Modules')) - 1"!]
                [!FOR "index" = "1" TO "$InstanceCfgCount"!]
                    [!VAR "InstanceName" = "node:value(as:modconf('Gpt')[1]/GptChannelConfigSet/GptStm/*[num:i($index)]/GptStmModule)"!][!//
                    [!IF "$GptEcucPartitionRefCount = 0 and $InstanceName = concat('STM_',$Instance)"!][!//
                [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!][!//
                        [!CODE!][!WS "8"!]/** @brief IP type  */[!CR!][!ENDCODE!]
                ...
                [!CODE!][!WS "4"!]}[!CR!][!ENDCODE!]
                    ...
                    [!ELSE!]
                    [!IF "$InstanceName = concat('STM_',$Instance) and
                    (node:exists(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[(node:refs(GptModuleRef)/../../GptStmModule = concat('STM_',$Instance)) and (node:value(./GptChannelEcucPartitionRef/*[1]) = $GptEcucPartitionRefName)]))"!]
                [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!][!//
                        [!CODE!][!WS "8"!]/** @brief IP type  */[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]GPT_STM_MODULE,[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]/** @brief IP instance */[!CR!][!ENDCODE!]
            ...
            [!IF "$OutNumGptChannelsUsingFtm > 0"!]
                ...
                [!CODE!][!WS "4"!]}[!CR!][!ENDCODE!]
                    ...
                    (node:exists(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[(node:refs(GptModuleRef)/../../GptFtmModule = concat('FTM_',$Instance)) and (node:value(./GptChannelEcucPartitionRef/*[1]) = $GptEcucPartitionRefName)]))"!]
                [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!][!//
                        [!CODE!][!WS "8"!]/** @brief IP type  */[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]GPT_FTM_MODULE,[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]/** @brief IP instance */[!CR!][!ENDCODE!]
            ...
            [!IF "$OutNumGptChannelsUsingRtc > 0"!]
                ...
                [!CODE!][!WS "4"!]}[!CR!][!ENDCODE!]
                        [!IF "num:i($OutNumInstancesInPartition) > 1"!][!CODE!][!WS "4"!],[!CR!][!ENDCODE!][!VAR "OutNumInstancesInPartition" = "$OutNumInstancesInPartition - 1"!][!ENDIF!]
                    [!ELSE!]
                [!IF "node:exists(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*/GptChannelEcucPartitionRef/*[1][node:value(.) = $GptEcucPartitionRefName])"!]
                [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!][!//
                        [!CODE!][!WS "8"!]/** @brief IP type  */[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]GPT_RTC_MODULE,[!CR!][!ENDCODE!]
                        [!CODE!][!WS "8"!]/** @brief IP instance */[!CR!][!ENDCODE!]
                    ...
                    [!IF "(($GptEcucPartitionRefCount = 0) or (node:value(./GptChannelEcucPartitionRef/*[1]) = $GptEcucPartitionRefName))"!]
                        ...
                        [!CODE!][!WS "4"!]{[!CR!][!ENDCODE!]
                            [!IF "contains(GptHwIp,'PIT')"!]
                                ...
                                [!CODE!][!WS "8"!][!"substring-after(substring-after((node:ref(./GptModuleRef)/GptPitChannel), substring-before(node:value(node:ref(./GptModuleRef)/GptPitChannel),'CH_')), '_')"!]U,[!CR!][!ENDCODE!]
