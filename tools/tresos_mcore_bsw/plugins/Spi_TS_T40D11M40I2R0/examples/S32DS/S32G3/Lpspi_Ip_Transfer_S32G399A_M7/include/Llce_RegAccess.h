...
* 
* @section [global]
* Violates MISRA 2012 Required Rule 10.8, The value of a composite expression shall not be cast to a different essential type category or a wider essentia l type
* The cast is used for indexing memory mapped registers for several memory types.
*
* @section Llce_RegAccess_h_REF_1
 ...
 *                                       DEFINES AND MACROS
 ==================================================================================================*/
     ...
     /* @violates @ref Llce_RegAccess_h_REF_1 Violates MISRA 2012 Required
     * Rule 21.1, only for PC-LINT analysis */
     #define LLCE__PACKED
 #else
     ...
     * Rule 21.1, only for PC-LINT analysis */
     ...
     /* @violates @ref Llce_RegAccess_h_REF_1 Violates MISRA 2012 Required
     * Rule 21.1, only for PC-LINT analysis */
     /* @violates @ref Llce_RegAccess_h_REF_2 Violates MISRA 2012 Advisory
     * Rule 2.5, only for PC-LINT analysis */
