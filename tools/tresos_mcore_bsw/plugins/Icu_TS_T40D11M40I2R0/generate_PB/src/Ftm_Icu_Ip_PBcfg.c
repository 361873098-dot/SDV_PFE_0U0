...
[!IF "count(IcuFtm/*) > '0'"!]
    [!LOOP "IcuFtm/*"!]
        ...
        [!CODE!][!WS "4"!](uint8)[!"num:i(node:value(./IcuFtmPrescaler))"!]U,[!CR!][!ENDCODE!]
        [!CODE!][!WS "0"!]#if (FTM_ICU_DUAL_CLOCK_MODE_API == STD_ON)[!CR!][!ENDCODE!]
        [!CODE!][!WS "4"!]/** @brief FTM instance alternate prescaler  */[!CR!][!ENDCODE!]
        [!CODE!][!WS "4"!](uint8)[!"num:i(node:value(./IcuFtmPrescalerAlternate))"!]U,[!CR!][!ENDCODE!]
        [!CODE!][!WS "0"!]#endif[!CR!][!ENDCODE!]
        ...
        [!CODE!][!WS "4"!](uint16)[!"num:i(node:value(./IcuFtmModValue))"!]U[!CR!][!ENDCODE!]
        [!CODE!]};[!CR!][!ENDCODE!]
...
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C             4
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C             0
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C             2

/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if source file and ICU type file are of the same vendor */
...
#endif
/* Check if source file and ICU type file are of the same AutoSar version */
...
#endif
/* Check if source file and ICU type file are of the same Software version */
