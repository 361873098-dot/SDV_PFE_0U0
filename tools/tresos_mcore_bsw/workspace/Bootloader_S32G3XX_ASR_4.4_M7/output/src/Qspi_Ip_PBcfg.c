...
/* paLutOperations */
static const Qspi_Ip_InstrOpType MemCfg_0_paLutOperations_0[50U] =
{
    /*  0: Read_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)237U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_ADDR_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)32U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_DUMMY | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)10U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_READ_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)16U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  5: Write_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)2U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_ADDR_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)32U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_WRITE_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)16U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  9: Erase_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)32U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_ADDR_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)32U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  12: ReadSR_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)5U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_READ | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)1U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  15: WriteSR_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)1U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_WRITE | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)1U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  18: WriteEnable_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)6U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  20: ResetEnable_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)102U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  22: Reset_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_4 | (Qspi_Ip_InstrOpType)153U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  24: FastRead  */
    ...
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  34: ReadId_dopi  */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD_DDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_1 | (Qspi_Ip_InstrOpType)159U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_READ | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_1 | (Qspi_Ip_InstrOpType)4U),
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /*  37: RDCR2  */
...
{
    {
        ...
        {
            /* statusConfig */
            47U,                               /* statusRegInitReadLut */
            12U,                               /* statusRegReadLut */
            15U,                               /* statusRegWriteLut */
            18U,                               /* writeEnableSRLut */
            18U,                               /* writeEnableLut */
            1U,                               /* regSize */
            0U,                               /* busyOffset */
            1U,                               /* busyValue */
