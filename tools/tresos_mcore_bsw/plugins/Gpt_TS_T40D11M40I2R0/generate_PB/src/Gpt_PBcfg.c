...
#define GPT_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C               4
#define GPT_SW_MINOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C               0
#define GPT_SW_PATCH_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C               2
...
#define GPT_CONF_CHANNELS_PB[!"$VS_number"!]_P_[!"$currentPartition"!][!WS"4"!][!"num:i(count(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[contains(./GptChannelEcucPartitionRef/*,$currentPartition)]))"!]U
[!ENDLOOP!][!// 
[!ELSE!]
...
[!FOR "outerIndex" = "0" TO "num:i($GptChannelNumber)-1"!][!//
    ...
    [!ELSE!]
        [!VAR "comma" = "' '"!]
    [!ENDIF!]
    [!SELECT "as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[GptChannelId=$outerIndex]"!][!//
...
[!ELSE!]
    ...
    [!ELSE!]
        [!VAR "comma" = "' '"!]
    [!ENDIF!]    
    [!SELECT "as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*/GptChannelId[.=$x]"!][!//
        [!CODE!][!WS "4"!][!"num:i($x)"!][!"$comma"!] /* Logical Channel [!"node:name(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*/GptChannelId[.=$x]/..)"!]*/[!CR!][!ENDCODE!]
    [!ENDSELECT!][!//
    [!ENDFOR!][!//
[!ENDIF!][!//
[!CODE!]};[!ENDCODE!]
...
const Gpt_ConfigType Gpt_Config_[!"$currentPartitionNumber"!] =
{
    ...
    (Gpt_ChannelType)[!"num:i(count(as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*[contains(./GptChannelEcucPartitionRef/*,$currentPartitionNumber)]))"!]U,
                ...
                [!IF "$GptEcucPartitionRefName = node:value(OsAppEcucPartitionRef)"!][!//
                    ...
                    [!VAR "OsCoreId" = "node:value(./EcucCoreId)"!][!//
                        [!IF "num:i($OsCoreId) = num:i($CurrentCoreId)"!][!//
                            [!VAR "HasCore" = "1"!][!//
                            [!LOOP "as:modconf('Gpt')[1]/GptChannelConfigSet/GptChannelConfiguration/*"!][!//
