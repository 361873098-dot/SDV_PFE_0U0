...
#define FTM_OCU_IP_IRQ_SW_MAJOR_VERSION_C                4
#define FTM_OCU_IP_IRQ_SW_MINOR_VERSION_C                0
#define FTM_OCU_IP_IRQ_SW_PATCH_VERSION_C                2
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
static void Ftm_Ocu_Ip_Irq_ProcessCommonInterrupt(uint8 InstNum)
{
    ...
    {
        /* clear the Timer Overflow Interrupt Flag only if the interrupt is valid */
    ...
    if(IsTofEnabled && HasToiOccurred)
    {
        /* nothing to do for now
           keeping this function just in case for future needed new functionalities, like calling notification for Timer Overflow Interrupt */
    }
}
#endif
