...
#define CRYPTO_MU_2_U8                                  ((uint8)2U)
#define CRYPTO_MU_3_U8                                  ((uint8)3U)
...
#define CRYPTO_ENABLE_ALTERNATE_MAPPING_FOR_JOB_KEY     (STD_OFF)
...
#define CRYPTO_SPT_MAC                                  (STD_ON)
    ...
    #define CRYPTO_SPT_XCBCMAC                          (STD_ON)
...
#define CRYPTO_SPT_SIPHASH                              (STD_ON)
...
#define CRYPTO_SPT_ECC                                  (STD_ON)
    ...
    #define CRYPTO_SPT_SECP384R1                        (STD_OFF)
    #define CRYPTO_SPT_SECP521R1                        (STD_OFF)
    #define CRYPTO_SPT_BRAINPOOLP256R1                  (STD_ON)
    #define CRYPTO_SPT_BRAINPOOLP320R1                  (STD_OFF)
    #define CRYPTO_SPT_BRAINPOOLP384R1                  (STD_OFF)
    #define CRYPTO_SPT_BRAINPOOLP512R1                  (STD_OFF)
...
#define CRYPTO_SPT_KEY_EXPORT                           (STD_ON)
    ...
    #define CRYPTO_SPT_ENC_AUTH_KEY_EXPORT              (STD_ON)
...
#define CRYPTO_ENABLE_ENC_AUTH_KEY_EXPORT               (STD_OFF)
...
#define CryptoConf_CryptoKey_AES256CMAC_RAM_KEY                         ((uint32)0U)
#define CryptoConf_CryptoKey_AES256CMAC_NVM_KEY                         ((uint32)1U)
#define CryptoConf_CryptoKey_AES128CBCECB_KEY                           ((uint32)2U)

/* Symbolic names for the CryptoKeyElementId attribute of all the Crypto key elements */
#define CryptoConf_CryptoKeyElement_Crypto_KE_AES256_CMAC_RAM_GENERATE  ((uint32)1U)
#define CryptoConf_CryptoKeyElement_Crypto_KE_AES256_CMAC_NVM_VERIFY    ((uint32)1U)
#define CryptoConf_CryptoKeyElement_Crypto_KE_AES128_DECRYPT            ((uint32)1U)
