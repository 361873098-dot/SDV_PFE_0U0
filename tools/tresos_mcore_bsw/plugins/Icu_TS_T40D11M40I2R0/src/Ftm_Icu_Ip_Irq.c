...
#define FTM_ICU_IP_IRQ_SW_MAJOR_VERSION_C               4
#define FTM_ICU_IP_IRQ_SW_MINOR_VERSION_C               0
#define FTM_ICU_IP_IRQ_SW_PATCH_VERSION_C               2
...
static inline void Ftm_Icu_Ip_SignalMeasurement(uint8 instance, uint8 hwchannel, boolean overflow)
{
    ...
    if (((FTM_ICU_HIGH_TIME == measProperty) ||  (FTM_ICU_LOW_TIME == measProperty)) && (hwchannel > 0U))
    {
