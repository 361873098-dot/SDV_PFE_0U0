...
Jump functions:
  Jump functions of caller  Clock_Ip_GetConfiguredFrequencyValue/8:
...
overall_size: 87, max_new_size: 11001
...
Clock_Ip_GetConfiguredFrequencyValue/8 (Clock_Ip_GetConfiguredFrequencyValue) @0739db60
  Type: function
  ...
  Called by: Clock_Ip_CgmXPcfsSdurDivcDiveDivs/4 (118111600 (estimated locally),0.34 per call) 
  Calls: 
Clock_Ip_apxCgmPcfs/7 (Clock_Ip_apxCgmPcfs) @0739f900
  Type: variable
...
Clock_Ip_au8ClockFeatures/6 (Clock_Ip_au8ClockFeatures) @0739f8b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axPcfsCallbacks/5 (Clock_Ip_axPcfsCallbacks) @0739f000
...
Clock_Ip_CgmXPcfsSdurDivcDiveDivs/4 (Clock_Ip_CgmXPcfsSdurDivcDiveDivs) @0739d460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxCgmPcfs/7 (read)Clock_Ip_au8ClockFeatures/6 (read)HashPcfs/2 (read)HashPcfs/2 (write)AMax/0 (read)PcfsRate/1 (read)
  Referring: Clock_Ip_axPcfsCallbacks/5 (addr)
  Availability: available
  Function flags: count:345194060 (estimated locally) body optimize_size
  Called by: 
  Calls: Clock_Ip_GetConfiguredFrequencyValue/8 (118111600 (estimated locally),0.34 per call) 
Clock_Ip_ProgressiveFrequencyClockSwitchEmpty/3 (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty) @071c1ee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty, funcdef_no=0, decl_uid=6787, cgraph_uid=1, symbol_order=3)
...
;; Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs (Clock_Ip_CgmXPcfsSdurDivcDiveDivs, funcdef_no=1, decl_uid=6789, cgraph_uid=2, symbol_order=4)
...
Clock_Ip_CgmXPcfsSdurDivcDiveDivs (const struct Clock_Ip_PcfsConfigType * Config)
{
  ...
  _7 = (int) _5;
  _8 = HashPcfs[_7];
  _9 = Config_56(D)->ClockSourceFrequency;
  _10 = Config_56(D)->MaxAllowableIDDchange;
  _11 = _9 ^ _10;
  _12 = _4 ^ _11;
  _13 = _1 ^ _12;
  _14 = Config_56(D)->StepDuration;
  _15 = _13 ^ _14;
  if (_8 != _15)
    goto <bb 4>; [48.88%]
  else
  ...
  HashPcfs[_7] = _15;
  # DEBUG BEGIN_STMT
  _16 = Config_56(D)->ClockSourceFrequency;
  ...
  # DEBUG BEGIN_STMT
  _18 = Config_56(D)->MaxAllowableIDDchange;
  _19 = Config_56(D)->StepDuration;
  _20 = _18 * _19;
  _21 = _20 * 100000;
  _22 = Finput_61 * 2360;
  AmaxBrut_64 = _21 / _22;
  ...
  <bb 6> [local count: 147604073]:
  # DEBUG BEGIN_STMT
  Rate_65 = PcfsRate[Index_48];
  # DEBUG Rate => Rate_65

  <bb 7> [local count: 295208146]:
  # Rate_45 = PHI <Rate_46(5), Rate_65(6)>
  # DEBUG Rate => Rate_45
  # DEBUG BEGIN_STMT
  Index_66 = Index_48 + 1;
  # DEBUG Index => Index_66

  <bb 8> [local count: 354263946]:
  # Rate_46 = PHI <Rate_45(7), AmaxBrut_64(20)>
  # Index_48 = PHI <Index_66(7), 1(20)>
  ...
  <bb 11> [local count: 1073741820]:
  # Var2_51 = PHI <1073741824(9), Var2_81(10)>
  # DEBUG Var2 => Var2_51
  # DEBUG BEGIN_STMT
  if (Var2_51 > Var1_67)
    goto <bb 10>; [89.00%]
  ...
  # Var1_49 = PHI <Var1_50(13), Var1_77(14)>
  # Var3_53 = PHI <Var3_54(13), Var3_78(14)>
  # DEBUG Var3 => Var3_53
  # DEBUG Var1 => Var1_49
  # DEBUG BEGIN_STMT
  Var3_79 = Var3_53 >> 1;
  ...
  # Var1_50 = PHI <Var1_49(15), Var1_67(19)>
  # Var2_52 = PHI <Var2_80(15), Var2_51(19)>
  # Var3_54 = PHI <Var3_79(15), 0(19)>
  # DEBUG Var3 => Var3_54
  # DEBUG Var2 => Var2_52
  # DEBUG Var1 => Var1_50
  # DEBUG BEGIN_STMT
