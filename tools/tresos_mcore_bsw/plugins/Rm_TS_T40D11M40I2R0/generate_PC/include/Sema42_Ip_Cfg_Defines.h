...
/** @brief    Enable or Disable Reset All Gates when Initialization */
#define SEMA42_IP_RESET_ALL_GATES             ([!IF "RmConfigSet/Sema42_ModuleConfig/Sema42ResetAllGates"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
