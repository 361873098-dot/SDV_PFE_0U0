...
#define WDG_CHANNEL_SW_MAJOR_VERSION_C               4
...
#include "Wdg_MemMap.h"
    ...
    void Wdg_Cbk_GptNotification5(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE6
    #if (WDG_INSTANCE6 == STD_ON)
    void Wdg_Cbk_GptNotification6(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE7
    #if (WDG_INSTANCE7 == STD_ON)
    void Wdg_Cbk_GptNotification7(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE8
    #if (WDG_INSTANCE8 == STD_ON)
    void Wdg_Cbk_GptNotification8(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE9
    #if (WDG_INSTANCE9 == STD_ON)
    void Wdg_Cbk_GptNotification9(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE10
    #if (WDG_INSTANCE10 == STD_ON)
    void Wdg_Cbk_GptNotification10(void);
    #endif
    #endif

            #ifdef WDG_INSTANCE11
    #if (WDG_INSTANCE11 == STD_ON)
    void Wdg_Cbk_GptNotification11(void);
    #endif
    #endif
                                                                       ...
                                                                       )
{
    ...
    **/
    void Wdg_Cbk_GptNotification5(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE5);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification6(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE6);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification7(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE7);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification8(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE8);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification9(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE9);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification10(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE10);
    }
    #endif
    #endif
    ...
    **/
    void Wdg_Cbk_GptNotification11(void)
    {
        Wdg_ChannelTrigger(WDG_IPW_INSTANCE11);
    }
    #endif
    #endif
    #endif /* WDG_DIRECT_SERVICE */
...
void Wdg_ChannelService(const Wdg_Ipw_InstanceType Instance)
{
    ...
    CoreID = (uint32) Wdg_GetCoreID();
    Valid = Wdg_ChannelValidateCoreUsed(CoreID, Instance,WDG_SERVICE_ID,WDG_E_PARAM_CONFIG);
    if ((Std_ReturnType)E_OK == Valid)
    {
#endif
    #if (WDG_VALIDATE_GLOBAL_CALL == STD_ON)
