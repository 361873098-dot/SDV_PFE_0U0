...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - Board    : S32G-VNP-RDB3 PCB 53060 RevC SCH RevF, S32G3 silicon (Rev 1.1)
            - Silicon  : P32G399AACVUC SBAU2235 1P72B TIAUSBA
        2.2.2 Connections
            The following Connections must be done to for this example application to work:

            Pin function                                            | S32G-VNP-RDB3              | Description
            --------------------------------------------------------|----------------------------|----------------------------------------------------------------
            Connects uSDHC interface to eMMC chip (SD_eMMC_SEL = 0) | SW3   - Set to state OFF   | Because the uSDHC pins are shared between SD and eMMC card
            Connect VDD_eMMC supplies to 1.8V                       | R1243 - Set to position A  | Allow eMMC card to work in 1.8V mode
