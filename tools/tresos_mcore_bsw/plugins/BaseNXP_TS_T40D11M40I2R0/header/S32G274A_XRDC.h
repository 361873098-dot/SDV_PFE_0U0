...
typedef struct {
  ...
  struct {                                         /* offset: 0x2000, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W0;                      /**< Memory Region Descriptor Word 0, array offset: 0x2000, array step: index*0x200, index2*0x20, valid indices: [0][0-3], [1][0-3], [2][0-15], [3][0-3], [4][0-3], [5][0-3] */
    __IO uint32_t XRDC_MRGD_W1;                      /**< Memory Region Descriptor Word 1, array offset: 0x2004, array step: index*0x200, index2*0x20, valid indices: [0][0-3], [1][0-3], [2][0-15], [3][0-3], [4][0-3], [5][0-3] */
    __IO uint32_t XRDC_MRGD_W2;                      /**< Memory Region Descriptor Word 2, array offset: 0x2008, array step: index*0x200, index2*0x20, valid indices: [0][0-3], [1][0-3], [2][0-15], [3][0-3], [4][0-3], [5][0-3] */
    __IO uint32_t XRDC_MRGD_W3;                      /**< Memory Region Descriptor Word 3, array offset: 0x200C, array step: index*0x200, index2*0x20, valid indices: [0][0-3], [1][0-3], [2][0-15], [3][0-3], [4][0-3], [5][0-3] */
