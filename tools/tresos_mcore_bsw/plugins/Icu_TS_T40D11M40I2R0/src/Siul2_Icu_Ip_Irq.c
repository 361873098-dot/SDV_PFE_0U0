...
#define SIUL2_ICU_IRQ_SW_PATCH_VERSION_C               2
...
* @details        Interrupt handler for SIUL2 module 0.
*/
...
/**
* @brief          Independent interrupt handler.
* @details        Interrupt handler for SIUL2 module 1.
*/
...
/**
* @brief          Independent interrupt handler.
* @details        Interrupt handler for SIUL2 module 4.
*/
...
/**
* @brief          Independent interrupt handler.
* @details        Interrupt handler for SIUL2 module 5.
*/
