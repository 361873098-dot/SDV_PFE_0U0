...
errno_t pfe_hif_ring_create_mcal(pfe_hif_ring_t *ring, uint32_t length, bool_t rx) __attribute__((cold));
errno_t pfe_hif_ring_create_minihif(pfe_hif_ring_t *ring, void *ring_va, void *wb_ring_va, uint32_t length, bool_t rx) __attribute__((cold));
