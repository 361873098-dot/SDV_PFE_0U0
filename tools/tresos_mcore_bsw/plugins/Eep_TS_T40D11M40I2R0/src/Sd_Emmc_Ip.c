...
#define SD_EMMC_IP_AR_RELEASE_MINOR_VERSION_C     4
#define SD_EMMC_IP_AR_RELEASE_REVISION_VERSION_C  0
#define SD_EMMC_IP_SW_MAJOR_VERSION_C             4
#define SD_EMMC_IP_SW_MINOR_VERSION_C             0
#define SD_EMMC_IP_SW_PATCH_VERSION_C             2
...
==================================================================================================*/
    ...
    /* Check if current file and Mcal header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Eep.c and Mcal.h are different"
    #endif
#endif
...
/* Temporary variable to store current state, easy to test injection timeout error */
static uint32    Sd_Emmc_Ip_u32TempState;
    ...
    else
    {
        ...
        switch (Config->usdhcConfig->endianMode)
        {
            case USDHC_ENDIAN_MODE_BIG:
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_SEC_CNT          >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_SEC_CNT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_DATA_SECTOR_SIZE >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_DATA_SECTOR_SIZE >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BUS_WIDTH        >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BUS_WIDTH >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_REV              >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_REV >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_CARD_TYPE        >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_CARD_TYPE >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_STROBE_SUPPORT         >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_STROBE_SUPPORT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_PARTITION_CONFIG >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_PARTITION_CONFIG >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_SIZE_MULT   >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_SIZE_MULT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_INFO        >> 2U] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_INFO >> 2U]);
                break;

            case USDHC_ENDIAN_MODE_HALF_WORD_BIG:
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_SEC_CNT          >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_SEC_CNT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_DATA_SECTOR_SIZE >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_DATA_SECTOR_SIZE >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BUS_WIDTH        >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BUS_WIDTH >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_REV              >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_REV >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_CARD_TYPE        >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_CARD_TYPE >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_STROBE_SUPPORT         >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_STROBE_SUPPORT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_PARTITION_CONFIG >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_PARTITION_CONFIG >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_SIZE_MULT   >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_SIZE_MULT >> 2U]);
                Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_INFO        >> 2U] = Sd_Ip_SwapHword(Sd_Emmc_Ip_u32CsdBuffer[MMC_EXT_CSD_INDEX_BOOT_INFO >> 2U]);
                break;
...
static Sd_Emmc_Ip_StatusType Sd_Ip_VerifyTuningPattern4bit(const Sd_Emmc_Ip_ConfigType *Config)
{
    ...
    switch (Config->usdhcConfig->endianMode)
    {
        case USDHC_ENDIAN_MODE_LITTLE:
            ...
            {
                Sd_Emmc_Ip_u32TuningDestBuffer[Index] = Sd_Ip_LoadDword(Sd_Emmc_Ip_u32TuningDestBuffer[Index]);
            }
            break;
        ...
        case USDHC_ENDIAN_MODE_HALF_WORD_BIG:
            ...
            for (Index = 0; Index < MMC_TUNING_4BIT_PATTERN_WORDS; Index++)
            {
                Sd_Emmc_Ip_u32TuningDestBuffer[Index] = Sd_Ip_LoadHword(Sd_Emmc_Ip_u32TuningDestBuffer[Index]);
            }
            break;
...
{
    uint32 u32NearestFrequency;
    uint32 NextFrequency = Config->SdConfigClock;
    Sd_Emmc_Ip_StatusType Status = (Sd_Emmc_Ip_StatusType)SD_IP_STATUS_SUCCESS;

    /* Set the bus clock */
    (void)uSDHC_Ip_SetBusClock(Config->usdhcConfig->instance, Config->u32McuClock, NextFrequency, &u32NearestFrequency);
    ...
    while(((Sd_Emmc_Ip_StatusType)SD_IP_STATUS_SUCCESS != Status) && (NextFrequency!= 0U))
    {
        NextFrequency >>= 1U;
        /* Set the bus clock */
        /* Note: When NextFrequency = 0, Sd_Ip_Set BlockSize() is still capable of returning SD_IP_STATUS_SUCCESS with u32NearestFrequency != 0*/
        (void)uSDHC_Ip_SetBusClock(Config->usdhcConfig->instance, Config->u32McuClock, NextFrequency, &u32NearestFrequency);
        /* Try Setting the block size */
        Status = Sd_Ip_SetBlockSize(Config, 64U);
    };
...
#if (EEP_SD_IP_DEV_ERROR_DETECT == STD_ON)
                               ...
                               )
{
    ...
    Sd_Emmc_Ip_u32TempState = (uint32)(uSDHC_Ip_GetPresentStatusFlags(Config->usdhcConfig->instance) & (uint32)USDHC_DATA0_LINE_LEVEL);
    ...
    if ((Sd_Emmc_Ip_StatusType)SD_IP_STATUS_SUCCESS == Sd_Emmc_Ip_eJobState)
    {
        ...
        while (0U == Sd_Emmc_Ip_u32TempState)
        {
            CurrentTime += OsIf_GetElapsed(&StartTime, USDHC_IP_TIMEOUT_TYPE);
...
static Sd_Emmc_Ip_StatusType Sd_Ip_SwitchHighSpeed(const Sd_Emmc_Ip_ConfigType *Config)
{
    ...
    if ((Sd_Emmc_Ip_StatusType)SD_IP_STATUS_SUCCESS == Status)
    {
        ...
        if(0U == Sd_Emmc_Ip_u32BusClockInfo)
        {
...
static Sd_Emmc_Ip_StatusType Sd_Ip_IncreaseMmcBusSpeed4Bit(const Sd_Emmc_Ip_ConfigType *Config)
{
    ...
    {
        Status = SD_IP_STATUS_NOT_SUPPORTED;
    }
...
static void Sd_Emmc_Ip_InitPreCheck(const Sd_Emmc_Ip_ConfigType *Config)
{
    ...
    */
    Sd_Emmc_Ip_TransferStorage.data.enableAutoCMD12 = Config->usdhcConfig->EepEnableAutoCMD12;
}
...
Sd_Emmc_Ip_StatusType Sd_Emmc_Ip_ReadBlocks(const Sd_Emmc_Ip_ConfigType *Config, uint8 *Buffer, uint32 StartBlock, uint32 BlockCount)
{
    ...
    if ((Sd_Emmc_Ip_StatusType)SD_IP_STATUS_ERROR != Sd_Emmc_Ip_eJobState)
    {
...
Sd_Emmc_Ip_StatusType Sd_Emmc_Ip_WriteBlocks(const Sd_Emmc_Ip_ConfigType *Config, const uint8 *Buffer, uint32 StartBlock, uint32 BlockCount, boolean AsyncEnable)
{
    ...
    u32bootSize = (uint32)((uint32)Sd_Emmc_Ip_MmcECsr.bootSizeMultiplier << 17U)/SD_IP_SDMMC_DEFAULT_BLOCK_SIZE;
    /* Check if number of writing blocks exceeds boot partition size */
    if(((SD_IP_MMC_PARTITION_BOOT_1 == mmcPartitionState) || (SD_IP_MMC_PARTITION_BOOT_2 == mmcPartitionState)) && (BlockCount > u32bootSize))
    {
        Sd_Emmc_Ip_eJobState = (Sd_Emmc_Ip_StatusType)SD_IP_STATUS_ERROR;
    }
