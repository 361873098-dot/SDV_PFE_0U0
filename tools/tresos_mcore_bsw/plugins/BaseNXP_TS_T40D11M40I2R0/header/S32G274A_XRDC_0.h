...
typedef struct {
  ...
  __I  uint8_t MDACFG[XRDC_0_MDAC_COUNT];          /**< Master Domain Assignment Configuration, array offset: 0x100, array step: 0x1, valid indices: [0-12, 15-21] */
  ...
  struct {                                         /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word 0, array offset: 0x400, array step: 0x10, valid indices: [0, 2-13, 16-19] */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word 1, array offset: 0x404, array step: 0x10, valid indices: [0, 2-13, 16-19] */
    __I  uint32_t DERR_W2;                           /**< Domain Error Word 2, array offset: 0x408, array step: 0x10, valid indices: [0, 2-13, 16-19] */
    __O  uint32_t DERR_W3;                           /**< Domain Error Word 3, array offset: 0x40C, array step: 0x10, valid indices: [0, 2-13, 16-19] */
  } DERRW0[XRDC_0_DERRW0_COUNT];
  uint8_t RESERVED_5[448];
  __IO uint32_t PID[XRDC_0_PID_COUNT];             /**< Process Identifier, array offset: 0x700, array step: 0x4, valid indices: [0-1, 8-10, 16-18] */
  ...
  struct {                                         /* offset: 0x1000, array step: 0x400 */
    struct {                                         /* offset: 0x1000, array step: index*0x400, index2*0x8 */
      __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control Word 0, array offset: 0x1000, array step: index*0x400, index2*0x8, valid indices: [0][0-31], [1][0-31], [2][0-31], [3][0-14, 16-17, 22-24] */
      __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control Word 1, array offset: 0x1004, array step: index*0x400, index2*0x8, valid indices: [0][0-31], [1][0-31], [2][0-31], [3][0-14, 16-17, 22-24] */
