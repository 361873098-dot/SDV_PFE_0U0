...
/**
 *   @file       Wkpu_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.c
 *   @version    4.0.2
 *
    ...
    [!IF "count(IcuWkpu/*) > '0'"!]
        [!LOOP "IcuWkpu/*"!][!// Implementation is supporting only 1 instance of WKPU
            [!IF "num:i(count(IcuWkpuChannels/*)) > '0'"!]
                ...
                [!CODE!]/*[!CR!][!ENDCODE!]
                [!CODE!] *  @brief    [!"$VARIANT"!] WKPU Channels Configuration[!CR!][!ENDCODE!]
                [!CODE!] */[!CR!][!ENDCODE!]
                ...
                [!LOOP "IcuWkpuChannels/*"!]
                    ...
                    [!CODE!][!WS "8"!](uint8)[!"node:value(IcuWkpuChannel)"!]U,[!CR!][!ENDCODE!]
                    ...
                    [!CODE!][!WS "0"!]#if (defined(WKPU_IP_SUPPORT_PULL_CONTROL) && (WKPU_IP_SUPPORT_PULL_CONTROL == STD_ON))[!CR!][!ENDCODE!]
                    [!CODE!][!WS "8"!]/** @brief Wkpu Pad Pull Value */[!CR!][!ENDCODE!]
                    [!CODE!][!WS "8"!]WKPU_IP_[!"node:value(WkpuPadPullValue)"!],[!CR!][!ENDCODE!]
                    ...
                    [!CODE!]#if (defined(WKPU_IP_SUPPORT_BOOT_MODE) && (WKPU_IP_SUPPORT_BOOT_MODE == STD_ON))[!CR!][!ENDCODE!][!//
                    [!CODE!][!WS "8"!]/** @brief Wkpu Boot Mode Select */[!CR!][!ENDCODE!]
                    [!CODE!][!WS "8"!](boolean)[!"text:toupper(node:value(WakeupBootModeSelect))"!],[!CR!][!ENDCODE!]
                    ...
                    [!CODE!][!WS "8"!](uint8)[!"(../../../../../IcuConfigSet/IcuChannel/*[as:path(node:ref(./IcuChannelRef)) = as:path(node:current())]/IcuChannelId)"!]U[!CR!][!ENDCODE!]
                    [!CODE!][!WS "4"!]}[!ENDCODE!]
            ...
            [!IF "$IrqChannelsAvailable = 'true' or $NMIChannelsAvailable = 'true'"!]
                [!CODE!]/*[!CR!][!ENDCODE!]
                [!CODE!] *  @brief    [!"$VARIANT"!] Default WKPU IP Configuration[!CR!][!ENDCODE!]
                [!CODE!] */[!CR!][!ENDCODE!]
              ...
              [!IF "$IrqChannelsAvailable = 'true'"!]
                ...
                [!CODE!]#if (defined(WKPU_IP_SUPPORT_PULL_CONTROL) && (WKPU_IP_SUPPORT_PULL_CONTROL == STD_ON))[!CR!][!ENDCODE!][!//
                [!CODE!][!WS "4"!]/** @brief Wkpu Pull Override Enable */[!CR!][!ENDCODE!]
                [!CODE!][!WS "4"!](boolean)[!"text:toupper(node:value(./WkpuPullOverride))"!],[!CR!][!ENDCODE!]
                [!CODE!]#endif[!CR!][!ENDCODE!][!//
                [!CODE!][!WS "4"!]/** @brief Pointer to the array of Wkpu enabled Icu channel configurations */[!CR!][!ENDCODE!]
...
#define WKPU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C             4
#define WKPU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C             0
#define WKPU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C             2
