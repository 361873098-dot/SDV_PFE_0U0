...
#define FLS_SW_MAJOR_VERSION_C               4
...
static void Fls_AccumulateCRC_Qspi_centerAligned(const Qspi_Ip_ControllerConfigType *QspiUnitCfg);
static void Fls_AccumulateCRC_Qspi_differentialClock(const Qspi_Ip_ControllerConfigType *QspiUnitCfg);
...
static void Fls_AccumulateCRC_Qspi_dllSettings(const Qspi_Ip_ControllerConfigType *QspiUnitCfg)
{
    ...
    /* CRC - Accumulate dllMode */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.dllMode) );
    /* CRC - Accumulate freqEnable */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.freqEnable? 1U : 0U) );
    /* CRC - Accumulate DLL loop control */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.referenceCounter) );
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.resolution) );
    /* CRC - Accumulate coarseDelay */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.coarseDelay) );
    /* CRC - Accumulate fineDelay */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.fineDelay) );
    /* CRC - Accumulate tapSelect */
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->dllSettingsB.tapSelect) );
}

/**
 * @brief        Calculates CRC over QSPI centerAlignedStrobe configuration.
 *
 * @details      Calculates CRC over centerAlignedStrobe items of Fls QSPI configuration set
 *               pointed to by ConfigPtr.
 *
 * @param[in]    IterUnits The index of QSPI configuration
 *
...
static void Fls_AccumulateCRC_Qspi_centerAligned(const Qspi_Ip_ControllerConfigType *QspiUnitCfg)
{
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->centerAlignedStrobeA? 1U : 0U) );
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->centerAlignedStrobeB? 1U : 0U) );
}

/**
 * @brief        Calculates CRC over QSPI differentialClock configuration.
 *
 * @details      Calculates CRC over differentialClock items of Fls QSPI configuration set
 *               pointed to by ConfigPtr.
 *
 * @param[in]    IterUnits The index of QSPI configuration
 *
...
static void Fls_AccumulateCRC_Qspi_differentialClock(const Qspi_Ip_ControllerConfigType *QspiUnitCfg)
{
    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->differentialClockA? 1U : 0U) );

    Fls_AccumulateCRC( (uint32)(QspiUnitCfg->differentialClockB? 1U : 0U) );
}
...
static void Fls_AccumulateCRC_Qspi_paQspiUnitCfg(void)
{
    ...
    for (IterUnits = 0U; IterUnits < Fls_pConfigPtr->pFlsQspiCfgConfig->u8QspiConfigCount; IterUnits++)
    {
        ...
        /* CRC - Accumulate centerAligned */
        Fls_AccumulateCRC_Qspi_centerAligned(QspiUnitCfg);
        /* CRC - Accumulate differentialClock */
        Fls_AccumulateCRC_Qspi_differentialClock(QspiUnitCfg);
