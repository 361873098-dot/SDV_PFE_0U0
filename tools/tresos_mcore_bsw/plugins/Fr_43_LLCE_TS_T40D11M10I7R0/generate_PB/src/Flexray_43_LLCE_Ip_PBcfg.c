...
[!NOCODE!]
    ...
    [!MACRO "MemorySize", "CfgVariant" = "string('PB')", "FrIfCluster" = "", "FrController" = "", "FIFOASlots" = "", "FIFOBSlots" = "", "Reconfigurations" = "", "ReconfigurationsDynamic" = ""!]
        ...
        [!LOOP "node:order(node:ref($FrIfCluster)/FrIfController/*,'node:value(FrIfCtrlIdx)','node:name(.)')"!][!// Sort the controllers by their name at first
            [!IF "$FrController = node:path(node:ref(FrIfFrCtrlRef))"!]
                ...
                [!VAR "MacHeadersSize" = "num:i(($MacFIFOADepth + $MacFIFOBDepth + $MacShadowCount2 + $MacShadowCount1 + $MacDynamicBuffersCnt + $MacStaticBuffersCnt) * 8)"!]
    ...
    [!MACRO "HWConfig", "CfgIdx" = "0", "CfgVariant" = "", "FrIfCluster" = "", "FrController" = "", "FIFOASlots" = "", "FIFOBSlots" = "",  "Reconfigurations" = "", "ReconfigurationsDynamic" = ""!]
        ...
        [!WS "0"!]static Flexray_Ip_CcConfigType Fr_43_LLCEMC[!"num:i($CfgIdx)"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_CCCfgSet_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
        ...
        [!ENDIF!]
            ...
            [!WS "4"!]Fr_43_LLCE_MemoryArea_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!], /* FlexRay memory base address */
    ...
    [!MACRO "PSRRegisters", "CfgIdx" = "0", "CfgVariant" = "", "FrIfCluster" = "", "FrController" = ""!][!// this code snippet will compute keyslot header crc
        ...
        [!WS "0"!] * parameters returned by the Fr_43_LLCE_ReadCCConfig function */
        [!WS "0"!]static Flexray_Ip_PeConfigType Fr_43_LLCEMC[!"num:i($CfgIdx)"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_PeConfig_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
...
/**
*  @file Flexray_43_LLCE_Ip_PBcfg.c
*
...
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION_C                1
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION_C                0
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION_C                7
...
/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same vendor */
    ...
    #error "Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Cfg.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Cfg.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Cfg.h header file are of the same software version */
    ...
    #error "Software Version Numbers of Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Cfg.h are different"
#endif
...
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same vendor */
    ...
    #error "Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Types.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Types.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Types.h header file are of the same software version */
    ...
    #error "Software Version Numbers of Flexray_Ip[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCfg.c and Flexray_43_LLCE_Ip_Types.h are different"
#endif
/*==================================================================================================
...
[!FOR "i" = "1" TO "$CtrlNum"!]
    ...
    [!WS "0"!]VAR_ALIGN(uint8 Fr_43_LLCE_MemoryArea_Ctrl[!"num:i($i - 1)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][[!"$MemSize"!]], 16U)
...
[!LOOP "node:order(FrMultipleConfiguration,'node:name(.)')"!][!//Sort the multiple configurations by their name at first
    ...
    [!IF "1 < count(FrController/*)"!]
        [!ERROR!]
            [!WS "0"!]Error 048: Too many controllers were configured for [!"node:path(.)"!] multiple configuration. Hardware device supports maximum [!"num:i(1)"!] FlexRay [!IF "num:i(1) > 1"!]controllers[!ELSE!]controller[!ENDIF!].
        [!ENDERROR!]
    [!ENDIF!]
    ...
    [!LOOP "node:order(FrController/*,'FrCtrlIdx','node:name(.)')"!][!//Sort the controllers by their name at first
        ...
        [!IF "text:tolower(node:value(../../../FrGeneral/FrPrepareLPduSupport)) = 'true'"!]
            [!IF "($NeededBuffers > 256) or ('true' = text:tolower(VendorSpecific/ForceReconfiguration))"!]
                [!INFO!]
        ...
        [!ELSE!]
            ...
            [!IF "$NeededBuffers > 256"!]
                [!ERROR!]
                    [!WS "0"!]Error 035: Not enough resources for all LPdus, try enable the parameter FrPrepareLPduSupport which enables API function Fr_43_LLCE_PrepareLPdu(), so more than one LPdu can share one Message Buffer.
                [!ENDERROR!]
            [!ENDIF!]
        [!ENDIF!]
        [!WS "0"!][!//
        ...
        [!WS "0"!]static Flexray_Ip_StateType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_State_[!"string($CfgVariant)"!];
        [!WS "0"!][!CR!]
        [!WS "0"!]static Flexray_Ip_BufferStateType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_BufferState_[!"string($CfgVariant)"!][[!"num:i($NumberOfNonFifoMacs)"!]U];
        [!WS "0"!][!CR!]
        [!WS "0"!]static Flexray_Ip_BufferStateType* Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_BufferMap_[!"string($CfgVariant)"!][[!"num:i($NumberOfNonFifoMacs)"!]U];
        [!WS "0"!][!CR!]
        [!WS "0"!]Flexray_Ip_StateAllocateType Fr_43_LLCE_MC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_StateAlloc_[!"string($CfgVariant)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!"' '"!]=
        [!WS "0"!]{
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_State_[!"string($CfgVariant)"!],
            [!WS "4"!]Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_BufferState_[!"string($CfgVariant)"!],
            [!WS "4"!]Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_BufferMap_[!"string($CfgVariant)"!]
        [!WS "0"!]};
        [!WS "0"!][!CR!]
        [!WS "0"!]/*  Note: The following structure was not supportd by MCAL, values below are hardcoded*/
        [!WS "0"!]static Flexray_Ip_MtsFilterType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MtsFilter_A_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
            [!WS "4"!]0U,
            [!WS "4"!]0U
        [!WS "0"!]};
        [!WS "0"!][!CR!]
        [!WS "0"!]/*  Note: The following structure was not supportd by MCAL, values below are hardcoded*/
        [!WS "0"!]static Flexray_Ip_MtsFilterType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MtsFilter_B_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
            [!WS "4"!]0U,
            [!WS "4"!]0U
        [!WS "0"!]};
        [!WS "0"!][!CR!]
        [!WS "0"!]/*  Note: The following structure was not supportd by MCAL, values below are hardcoded*/
        [!WS "0"!]static Flexray_Ip_UserCallbackType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_userCallBackCfg_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
            [!WS "4"!]NULL_PTR,
            [!WS "4"!]NULL_PTR,
            [!WS "4"!]NULL_PTR,
        ...
        [!WS "0"!][!//
        [!WS "0"!]static Flexray_Ip_IndMemConfigType Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MemCfg_[!"string($CfgVariant)"!] =
        [!WS "0"!]{
        ...
        [!SELECT "node:ref($FrControllersUsage)/../../../.."!]
            [!VAR "FrIfConfigIndex" = "position()"!]
        [!ENDSELECT!]
        [!WS "0"!]Flexray_Ip_ConfigType Fr_43_LLCE_MC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_Cfg_[!"string($CfgVariant)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!"' '"!]=
        [!WS "0"!]{
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_PeConfig_[!"string($CfgVariant)"!],
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_CCCfgSet_[!"string($CfgVariant)"!],
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_userCallBackCfg_[!"string($CfgVariant)"!],
            ...
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MemCfg_[!"string($CfgVariant)"!],
            ...
            [!WS "4"!]0U,
            [!WS "4"!](boolean)FALSE,
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MtsFilter_A_[!"string($CfgVariant)"!],
            [!WS "4"!]&Fr_43_LLCEMC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_MtsFilter_B_[!"string($CfgVariant)"!]
        [!WS "0"!]};
        [!WS "0"!][!CR!]
