...
* @note           Used for channel, port and channel group validation.
*/
#define DIO_NUM_PORTS_U16               ((uint16)[!"num:inttohex(count(ecu:list('Dio.AvailablePortPinsForWrite')))"!]U)
...
*/
    ...
    #define DIO_NUM_CHANNELS_U16            ((uint16)[!"num:i(ecu:get('Dio.LastPinAvailable'))"!]U)
#endif
...
* @note           Used for channel validation.
*/
#define DIO_CHANNEL_PARTITION_U16            ((uint16)[!"num:i(ecu:get('Dio.LastPinAvailable') + 1)"!]U)
...
*/
#define DIO_NUM_SIUL2_INSTANCES_U8      ((uint8)[!"num:i(count(ecu:list('Dio.Siul2Instances')))"!]U)
...
#define DIO_SPLIT_PORTID_SUPPORT
[!ENDIF!][!//
...
[!INDENT "0"!][!//
    ...
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32r45')"!][!//
        [!IF "($PortId > 6)"!][!//
            [!VAR "ChannelId" = "16*($PortId - 1) + $PortChannelId"!][!//
        [!ELSE!][!//
            [!VAR "ChannelId" = "16*$PortId + $PortChannelId"!][!//
        [!ENDIF!][!//
    [!ENDIF!][!//
