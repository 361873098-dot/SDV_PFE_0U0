...
#define MEMDAL_ENABLED                      STD_ON

/* MemDal FEE component enable flag */
#define MEMDAL_FEE_ENABLED                  STD_OFF

/* MemDal SDHC component enable flag */
#define MEMDAL_SDHC_ENABLED                 STD_ON

/* MemDal SDHC fatfs mode enable flag */
#define MEMDAL_SDHC_FATFS_ENABLED           STD_ON

/* MemDal SDHC format card flag */
#define MEMDAL_SDHC_FORMATCARD              FALSE

/* Number of FEE blocks */
#define MEMDAL_BLOCKS_NUMBER_FEE            0U

/* Number of SDHC blocks */
#define MEMDAL_BLOCKS_NUMBER_SDHC           1U

/* Number of MemDal blocks */
#define MEMDAL_BLOCKS_NUMBER                1U
...
/* MemDal blocks ID */
#define MEMDAL_MEMDALSDHCBLOCKS_0_ID        1U
