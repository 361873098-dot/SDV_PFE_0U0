...
#define SIUL2_ICU_IP_SW_PATCH_VERSION_C            2
...
#if (STD_ON == SIUL2_ICU_IP_DEINIT_API)
...
#endif  /* (STD_ON == SIUL2_ICU_IP_DEINIT_API) */
...
Siul2_Icu_Ip_StatusType Siul2_Icu_Ip_Init(uint8 instance, const Siul2_Icu_Ip_ConfigType* userConfig)
{
    ...
    DevAssert(instance < SIUL2_INSTANCE_COUNT);
#if (defined SIUL2_ICU_IP_INSTANCE)
    DevAssert(instance == SIUL2_ICU_IP_INSTANCE);
#endif
#endif
    base = Siul2_Icu_Ip_pBase[instance];
...
/* @implements Siul2_Icu_Ip_SetSleepMode_Activity */
...
/* @implements Siul2_Icu_Ip_SetNormalMode_Activity */
