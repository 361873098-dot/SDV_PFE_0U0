...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - EVB : S32G-VNP-RDB2 PCB 47440 RevE SCH RevE
            - Silicon : P32G274AABVUC 1P77B SBCH2250B
        2.1.2 Connections
            - Powered board through power Adapter 12V
        2.1.3 Debugger
            The Lauterbach debugger must be connected to JTAG Cortex Debug connector.
...
3. Building the example application
    3.1 Generating the Tresos project
        Procedure:
               ...
               4. The output files shall be generated in the /generate subdirectory
   ...
   3.3 Running the application on the board
        Enter "make run" to execute the example application from command line. In order to execute the script in the T32 window,  the paths from run.cmm need to be changed relative to the debug folder instead of the example root folder.
