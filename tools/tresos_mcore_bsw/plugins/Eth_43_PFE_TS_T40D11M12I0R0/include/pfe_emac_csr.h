...
#define LARGE_MODE_TIMEOUT(x)           ((uint32_t)(x) << 20U)          /* LTMRMD   */
#define NORMAL_MODE_TIMEOUT(x)          ((uint32_t)(x) << 16U)          /* NTMRMD   */
#define EMAC_CFG_PPS0_MCGR_ENABLE           (1UL << 7U)                 /* MCGREN0 */
#define EMAC_CFG_PPS0_TRGTMODSEL0(x)        ((uint32_t)(x) << 5U)       /* TRGTMODSEL0 */
