...
/**
*   @file Flexray_43_LLCE_Ip_PBcfg.h
*
...
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION                  1
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION                  0
#define FLEXRAY_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION                  7
...
[!LOOP "node:order(FrMultipleConfiguration,'node:name(.)')"!][!//Sort the multiple configurations by their name at first
    ...
    [!LOOP "node:order(FrController/*,'FrCtrlIdx','node:name(.)')"!][!//Sort the controllers by their name at first
        ...
        [!WS "4"!]extern Flexray_Ip_StateAllocateType Fr_43_LLCE_MC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_StateAlloc_[!"string($CfgVariant)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
        [!WS "0"!][!CR!]
        ...
        [!WS "4"!]extern Flexray_Ip_ConfigType Fr_43_LLCE_MC[!"$FrConfigIdx"!]_Ctrl[!"num:i(node:ref($FrController)/FrCtrlIdx)"!]_Cfg_[!"string($CfgVariant)"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];
        [!WS "0"!][!CR!]
...
#endif /* FLEXRAY_43_LLCE_IP[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_H */
