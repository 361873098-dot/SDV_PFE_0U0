...
#define LIN[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MAJOR_VERSION              4
#define LIN[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_MINOR_VERSION              0
#define LIN[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_PBCFG_SW_PATCH_VERSION              2
[!ENDCODE!]
[!ELSE!]
[!CODE!][!//
...
#define LIN_PBCFG_SW_MAJOR_VERSION              4
#define LIN_PBCFG_SW_MINOR_VERSION              0
#define LIN_PBCFG_SW_PATCH_VERSION              2
[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
/*==================================================================================================
