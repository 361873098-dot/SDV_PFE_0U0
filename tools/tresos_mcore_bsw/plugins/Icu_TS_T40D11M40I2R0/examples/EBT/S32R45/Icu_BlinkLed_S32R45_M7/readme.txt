1. Example Description
        LED RGB_LED - control with input in ICU-FTM pin through IcuSignalNotification function  
    1.1 The aplication software functionality
        GPIO trigger will generate edges to ICU-FTM input pins. The interrupts will be generated for the ICU-FTM channels and the user's functions will be called, the user's functions will blink LED.
    ...
    2.1 Hardware installation
        ...
        2.1.2 Connections
            Wire connection is required as follows:
                - Pin J55.5 (PA_08 - gpio output for Icu_Ftm channel) to J39.5 (PA_07 - FTM_0_CH_0 input) (in motherboard)
                - Pin J126.1 (PD_07 - output trigger for LED) to J126.2 (LED D19) (in miniboard)
        2.1.3 Debugger
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - GCC_DIR The path to the GCC installation directory
                Ex: GCC_DIR = C:/gcc-9.2-arm32-eabi
