...
Clock_Ip_ReportClockErrors/10 (Clock_Ip_ReportClockErrors) @071f3b60
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/9 (Clock_Ip_TimeoutExpired) @071f3a80
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/8 (Clock_Ip_StartTimeout) @071f39a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_apxDfs/7 (Clock_Ip_apxDfs) @071f8240
  Type: variable
...
Clock_Ip_au8ClockFeatures/6 (Clock_Ip_au8ClockFeatures) @071f81f8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axFracDivCallbacks/5 (Clock_Ip_axFracDivCallbacks) @0717eb88
...
Clock_Ip_CompleteDfsMfiMfn/4 (Clock_Ip_CompleteDfsMfiMfn) @071f3380
...
Clock_Ip_SetDfsMfiMfn/3 (Clock_Ip_SetDfsMfiMfn) @071f30e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_ResetDfsMfiMfn/2 (Clock_Ip_ResetDfsMfiMfn) @0717d8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmptyComplete/1 (Clock_Ip_CallbackFracDivEmptyComplete) @0717dd20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmpty/0 (Clock_Ip_CallbackFracDivEmpty) @0717da80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_CallbackFracDivEmpty (Clock_Ip_CallbackFracDivEmpty, funcdef_no=0, decl_uid=6784, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CallbackFracDivEmptyComplete (Clock_Ip_CallbackFracDivEmptyComplete, funcdef_no=1, decl_uid=6786, cgraph_uid=2, symbol_order=1)
...
;; Function Clock_Ip_ResetDfsMfiMfn (Clock_Ip_ResetDfsMfiMfn, funcdef_no=2, decl_uid=6788, cgraph_uid=3, symbol_order=2)
...
Clock_Ip_ResetDfsMfiMfn (const struct Clock_Ip_FracDivConfigType * Config)
{
  ...
  DividerIndex_12 = (uint32) _3;
  # DEBUG DividerIndex => DividerIndex_12
  # DEBUG BEGIN_STMT
  _4 = Clock_Ip_apxDfs[Instance_11];
  _5 ={v} _4->PORTRESET;
  _6 = 1 << DividerIndex_12;
  _7 = _5 | _6;
  _4->PORTRESET ={v} _7;
...
;; Function Clock_Ip_SetDfsMfiMfn (Clock_Ip_SetDfsMfiMfn, funcdef_no=3, decl_uid=6790, cgraph_uid=4, symbol_order=3)
...
Clock_Ip_SetDfsMfiMfn (const struct Clock_Ip_FracDivConfigType * Config)
{
  ...
  # DEBUG BEGIN_STMT
  IntegerPart_18 = Config_14(D)->Value[0];
  # DEBUG IntegerPart => IntegerPart_18
  # DEBUG BEGIN_STMT
  FractionalPart_19 = Config_14(D)->Value[1];
...
;; Function Clock_Ip_CompleteDfsMfiMfn (Clock_Ip_CompleteDfsMfiMfn, funcdef_no=4, decl_uid=6792, cgraph_uid=5, symbol_order=4)
