...
[!IF "count(IcuSiul2/*) > '0'"!]
    [!LOOP "IcuSiul2/*"!]
        ...
        [!CODE!]/*[!CR!][!ENDCODE!]
        [!CODE!] *  @brief    SIUL2_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!][!ENDIF!] Channels Configuration[!CR!][!ENDCODE!]
        [!CODE!] */[!CR!][!ENDCODE!]
        ...
        [!CODE!]/*[!CR!][!ENDCODE!]
        [!CODE!] *  @brief    SIUL2_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!][!ENDIF!] Instance Configuration[!CR!][!ENDCODE!]
        [!CODE!] */[!CR!][!ENDCODE!]
        ...
        [!CODE!]/*[!CR!][!ENDCODE!]
        [!CODE!] *  @brief    SIUL2_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!][!ENDIF!] Default IP Configuration[!CR!][!ENDCODE!]
        [!CODE!] */[!CR!][!ENDCODE!]
...
#define SIUL2_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION_C             4
#define SIUL2_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION_C             0
#define SIUL2_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION_C             2
