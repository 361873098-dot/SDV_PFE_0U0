...
#define USDHC_SW_PATCH_VERSION_IP_CFG                   2
...
#define USDHC_IP_DEV_ERROR_DETECT                     [!IF "./*[1]/EepUsdhcIpDevErrorDetect"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
/* @brief uSDHC development error detect enable/disable */
#define USDHC_IP_DEV_ASSERT(x)                        [!IF "./*[1]/EepUsdhcIpDevErrorDetect"!]DevAssert((x))[!ENDIF!]

/*! @brief Enable/disable cache synchronization */
#define USDHC_IP_SYNCRONIZE_CACHE                     [!IF "./*[1]/EepSynchronizeCache"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
#define USDHC_MCORE_ENABLED                           ([!IF "../AutosarExt/EepMCoreEnable"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!IF "../AutosarExt/EepMCoreEnable = 'true'"!]
#define USDHC_MCORE_SEMA4_HARDWARE_INSTANCE           ([!"num:inttohex(substring-after(node:value(node:ref(../AutosarExt/EepMCoreSemaphoreLogicChannel)/Sema42HardwareInstance), 'SEMA42_INSTANCE'))"!]U)
#define USDHC_MCORE_SEMA4_HARDWARE_CHANNEL            ([!"num:inttohex(node:value(node:ref(../AutosarExt/EepMCoreSemaphoreLogicChannel)/Sema42HardwareChannel))"!]U)
[!ENDIF!][!//
...
[!NOCODE!][!//
    [!IF "node:value(./*[1]/EepTimeoutMethod) = 'OSIF_COUNTER_SYSTEM'"!]
        ...
        [!CODE!][!//
            ...
            #endif
        [!ENDCODE!][!//
    [!ELSEIF "node:value(./*[1]/EepTimeoutMethod) = 'OSIF_COUNTER_CUSTOM'"!]
