...
#define ADC_SAR_IP_SW_PATCH_VERSION_TYPES               2
...
==================================================================================================*/
/*!
 * @brief Macros for conversion chain selection
 *
 * These macros are used to configure type of the conversion (Adc_Sar_Ip_ConvChainType)
 */
#define ADC_SAR_IP_CONV_CHAIN_NORMAL                0x00000000U      /*!< Selects the "Normal" Conversion Chain */
#define ADC_SAR_IP_CONV_CHAIN_INJECTED              0x00000001U      /*!< Selects the "Injected" Conversion Chain */
#define ADC_SAR_IP_CONV_CHAIN_CTU                   0x00000002U      /*!< Selects the "CTU" Conversion Chain */
 ...
 *
 * This type definition is used to configure type of the conversion
 * 
 * Implements : Adc_Sar_Ip_ConvChainType_Class
 */
typedef uint32 Adc_Sar_Ip_ConvChainType;
