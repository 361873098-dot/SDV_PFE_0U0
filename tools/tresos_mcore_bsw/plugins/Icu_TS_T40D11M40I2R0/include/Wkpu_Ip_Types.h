...
#define WKPU_IP_TYPES_SW_PATCH_VERSION              2
...
/* @brief  The pull value of wake-up pads. */   
typedef enum
{
    WKPU_IP_HIGH_IMPEDANCE       = 0U,    /*!< The WKPU field configuration will controls the pull value of wake-up pads: High-impedance */
    WKPU_IP_PULL_UP              = 1U,    /*!< The WKPU field configuration will controls the pull value of wake-up pads: Pull up */
    WKPU_IP_PULL_DOWN            = 2U     /*!< The WKPU field configuration will controls the pull value of wake-up pads: Pull down */
} Wkpu_Ip_PullType;
#endif
#endif
/*==================================================================================================
...
typedef struct
{
...
#if (defined(WKPU_IP_SUPPORT_PULL_CONTROL) && (WKPU_IP_SUPPORT_PULL_CONTROL == STD_ON))
    Wkpu_Ip_PullType        pullValue;                 /**< @brief The pull value of wake-up pads.*/
#endif
    ...
    boolean                 bootSel;                  /**< @brief WKPU select boot mode. 
                                                        *  If true, Long boot execution by boot software after wakeup from STANDBY mode.
                                                        *  otherwise Short boot execution by boot software after wakeup from STANDBY mode.*/
...
typedef struct
{
    ...
    /** @brief Pointer to channels configuration */
    Wkpu_Ip_NmiCfgType             (*pNMIChannelsConfig)[]; 
#endif
    /** @brief Number of channels in configuration */
    uint8                           numChannels;
#if (defined(WKPU_IP_SUPPORT_PULL_CONTROL) && (WKPU_IP_SUPPORT_PULL_CONTROL == STD_ON))
    /** @brief Selects one of two methods to control the WKUP pins */
    boolean                         pullOverrideEn;                
#endif
    /** @brief Pointer to channels configuration */
