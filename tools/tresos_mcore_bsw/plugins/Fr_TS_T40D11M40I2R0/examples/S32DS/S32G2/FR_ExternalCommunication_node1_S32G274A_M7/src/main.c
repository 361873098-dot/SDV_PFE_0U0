...
int main(void)
{
    ...
    while (bPass == FALSE && count-- )
    {
        ...
        {
            WaitForTime(FrConf_FrController_FrController_0, FrConf_FrAbsoluteTimer_FrAbsoluteTimer_0 , cycle, 0U);

            Fr_TransmitTxLPdu(FrConf_FrController_FrController_0, 0U , &TxData[0], 20U , &Fr_Tx_SlotAssignment);

            Fr_CheckTxLPduStatus(FrConf_FrController_FrController_0, 0U, &TxStatus1, &Fr_Tx_CheckStatus);

            WaitForTime(FrConf_FrController_FrController_0, FrConf_FrAbsoluteTimer_FrAbsoluteTimer_0, cycle, 4444U);

            Fr_CheckTxLPduStatus(FrConf_FrController_FrController_0, 0U, &TxStatus2, &Fr_Tx_CheckStatus);
