...
static uint8_t hif_nocpy_timer_ownership = 0U;
...
{
    return hal_read32(base_va + HIF_NOCPY_RX_BDP_ADDR);
}
...
{
    return hal_read32(base_va + HIF_NOCPY_TX_BDP_ADDR);
}
...
errno_t pfe_hif_nocpy_cfg_set_emac_timer_ownership(pfe_ct_phy_if_id_t emac, bool_t value)
{
    ...
    switch (emac)
    {
        ...
        {
            hif_nocpy_timer_ownership &= ~HIF_NOCPY_TIMER_OWNERSHIP_EMAC0(1);
            hif_nocpy_timer_ownership |= HIF_NOCPY_TIMER_OWNERSHIP_EMAC0(value);
            break;
        }
        case PFE_PHY_IF_ID_EMAC1:
        {
            hif_nocpy_timer_ownership &= ~HIF_NOCPY_TIMER_OWNERSHIP_EMAC1(1);
            hif_nocpy_timer_ownership |= HIF_NOCPY_TIMER_OWNERSHIP_EMAC1(value);
            break;
        }
        case PFE_PHY_IF_ID_EMAC2:
        {
            hif_nocpy_timer_ownership &= ~HIF_NOCPY_TIMER_OWNERSHIP_EMAC2(1);
            hif_nocpy_timer_ownership |= HIF_NOCPY_TIMER_OWNERSHIP_EMAC2(value);
            break;
        }
        default:
        {
...
bool_t pfe_hif_nocpy_cfg_get_emac_timer_ownership(pfe_ct_phy_if_id_t emac)
{
    ...
    switch (emac)
    {
        case PFE_PHY_IF_ID_EMAC0:
        {
            val = (0U == (hif_nocpy_timer_ownership & HIF_NOCPY_TIMER_OWNERSHIP_EMAC0(1))) ? FALSE : TRUE;
            break;
        }
        case PFE_PHY_IF_ID_EMAC1:
        {
            val = (0U == (hif_nocpy_timer_ownership & HIF_NOCPY_TIMER_OWNERSHIP_EMAC1(1))) ? FALSE : TRUE;
            break;
        }
        case PFE_PHY_IF_ID_EMAC2:
        {
            val = (0U == (hif_nocpy_timer_ownership & HIF_NOCPY_TIMER_OWNERSHIP_EMAC2(1))) ? FALSE : TRUE;
            break;
        }
        default:
        {
