1. Example Description
    ...
    The application includes an EB Tresos project that configures the Rm, Base, Dem, EcuC, Os, Fls, Rte, Memif and Resource drivers.
    ...
    1.1 The application software functionalities
            - Mcu_Init
                    ...
                    + QSPI_2X_CLK = 266 MHz
                    + QSPI_1X_CLK = QSPI_2X_CLK/2 = 133 MHz
