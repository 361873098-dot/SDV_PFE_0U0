...
Not considering init_data_bss_core2 for cloning; -fipa-cp-clone disabled.
...
__INDEX_COPY_CORE2/4 (__INDEX_COPY_CORE2) @06eb33f0
  Type: variable
  ...
  Varpool flags:
__ZERO_TABLE/3 (__ZERO_TABLE) @06eb3000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
__INIT_TABLE/2 (__INIT_TABLE) @06e34f78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
init_data_bss_core2/1 (init_data_bss_core2) @06e2fee0
  ...
  Called by: 
  Calls: 
init_data_bss/0 (init_data_bss) @06e2fc40
  Type: function definition analyzed
  Visibility: externally_visible public
...
;; Function init_data_bss (init_data_bss, funcdef_no=0, decl_uid=5423, cgraph_uid=1, symbol_order=0)
...
init_data_bss ()
{
  ...
  # DEBUG BEGIN_STMT
  len_45 = MEM[(const uintptr *)&__INIT_TABLE];
  # DEBUG len => len_45
  # DEBUG BEGIN_STMT
  ...
  *_16 = _17;
  ...
  <bb 9> [local count: 118111596]:
  # DEBUG BEGIN_STMT
  i_57 = i_32 + 1;
  # DEBUG i => i_57

  <bb 10> [local count: 132709658]:
  # i_32 = PHI <0(2), i_57(9)>
  # DEBUG i => i_32
  # DEBUG BEGIN_STMT
  if (i_32 < len_45)
  ...
  # DEBUG BEGIN_STMT
  len_46 = MEM[(const uintptr *)&__ZERO_TABLE];
  # DEBUG len => len_46
  # DEBUG BEGIN_STMT
  ...
  # DEBUG BEGIN_STMT
  _18 = i_33 * 8;
  _19 = &MEM[(void *)&__ZERO_TABLE + 4B] + _18;
...
;; Function init_data_bss_core2 (init_data_bss_core2, funcdef_no=1, decl_uid=5425, cgraph_uid=2, symbol_order=1)
...
init_data_bss_core2 ()
{
  ...
  # DEBUG initTable_Ptr => &__INIT_TABLE
  # DEBUG BEGIN_STMT
  len_28 = MEM[(const uintptr *)&__INIT_TABLE];
  # DEBUG len => len_28
  # DEBUG BEGIN_STMT
  # DEBUG initTable_Ptr => &MEM[(void *)&__INIT_TABLE + 4B]
  # DEBUG BEGIN_STMT
