...
==================================================================================================*/
/**
*   @file @file Flexray_Ip_HwAccess.h
*
...
#ifndef FLEXRAY_IP_HWACCESS_H
#define FLEXRAY_IP_HWACCESS_H
...
#define FLEXRAY_IP_HWACCESS_SW_MAJOR_VERSION                 4
#define FLEXRAY_IP_HWACCESS_SW_MINOR_VERSION                 0
#define FLEXRAY_IP_HWACCESS_SW_PATCH_VERSION                 2

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Flexray_Ip.h header file are of the same vendor */
#if(FLEXRAY_IP_HWACCESS_VENDOR_ID != FLEXRAY_IP_VENDOR_ID)
    #error "Flexray_Ip_HwAccess.h and Flexray_Ip.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_Ip.h header file are of the same Autosar version */
#if((FLEXRAY_IP_HWACCESS_AR_RELEASE_MAJOR_VERSION    != FLEXRAY_IP_AR_RELEASE_MAJOR_VERSION) || \
    (FLEXRAY_IP_HWACCESS_AR_RELEASE_MINOR_VERSION    != FLEXRAY_IP_AR_RELEASE_MINOR_VERSION) || \
    (FLEXRAY_IP_HWACCESS_AR_RELEASE_REVISION_VERSION != FLEXRAY_IP_AR_RELEASE_REVISION_VERSION))
    #error "Software Version Numbers of Flexray_Ip_HwAccess.h and Flexray_Ip.h are different"
#endif
/* Check if current file and Flexray_Ip.h header file are of the same software version */
#if((FLEXRAY_IP_HWACCESS_SW_MAJOR_VERSION != FLEXRAY_IP_SW_MAJOR_VERSION) || \
    (FLEXRAY_IP_HWACCESS_SW_MINOR_VERSION != FLEXRAY_IP_SW_MINOR_VERSION) || \
    (FLEXRAY_IP_HWACCESS_SW_PATCH_VERSION != FLEXRAY_IP_SW_PATCH_VERSION))
    #error "Autosar Version Numbers of Flexray_Ip_HwAccess.h and Flexray_Ip.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
#define FLEXRAY_MAXIMUM_PAYLOAD_LENGTH 127U /* Maximum of 254 bytes (127 half-words) of data. */
...
==================================================================================================*/
typedef uint8 Flexray_Ip_HeaderDataType[FRAME_HEADER_SIZE];
...
#include "Fr_MemMap.h"
void Flexray_PackMessageBufferHeader(Flexray_Ip_HeaderDataType * pHeaderData, Flexray_Ip_FrameHeaderType* pFrameHdr);
void Flexray_UnpackMessageBufferHeader (Flexray_Ip_HeaderDataType * pHeaderData, Flexray_Ip_FrameHeaderType* pFrameHdr);
void Flexray_calCrc(uint8 payloadLength, uint16 frameID, boolean startupFrameIndicator, boolean syncFrameIndicator, uint16* headerCrc);
 ...
 */
void FLEXRAY_SetFiFoRangeFilter(FLEXRAY_Type* base, uint8 filterNum, const Flexray_Ip_RangeFilterType *filterCfg);
 ...
 */
static inline boolean FLEXRAY_IsEnabled(const FLEXRAY_Type * pBase)
{
 ...
 */
static inline void FLEXRAY_SetMBEnableMode(FLEXRAY_Type *base, uint8 index, boolean enable)
{
 ...
 */
static inline void FLEXRAY_SetMBLockMode(FLEXRAY_Type *base, uint8 index, boolean lock)
{
    uint16 regValue = base->MB[index].CCSR;
 ...
 */
static inline void FLEXRAY_SetMBTrasmitReady(FLEXRAY_Type *base, uint8 index, boolean isReady)
{
    uint16 regValue = base->MB[index].CCSR;
 ...
 * @param[in]   isReady Be ready or be not ready (True: ready/False: Not ready)
 */
static inline boolean FLEXRAY_GetMBTrasmitReady(const FLEXRAY_Type *base, uint8 index)
{
 ...
 */
static inline boolean FLEXRAY_GetMBLockStatus(const FLEXRAY_Type *base, uint8 index)
{
 ...
 */
static inline void FLEXRAY_SetMBRepeat(FLEXRAY_Type *base, uint8 index, boolean repeat)
{
 ...
 */
static inline void FLEXRAY_SetMBChn(FLEXRAY_Type *base, uint8 index, boolean isChnA, boolean isChnB)
{
    uint16 regValue = base->MB[index].CCFR;
 ...
 * @param[in]   isChnB  Assign channel B (True: assigned/False: not assigned)
 */
static inline void FLEXRAY_GetMBChn(const FLEXRAY_Type* base,uint8 index, boolean* isChnA, boolean* isChnB)
{
    uint16 regValue = base->MB[index].CCFR;
 ...
 */
static inline void FLEXRAY_SetShadowBufferIdx(FLEXRAY_Type *base, uint16 phyIdx, uint8 sel)
{
 ...
 */
static inline void FLEXRAY_SetCycleCountFilter(FLEXRAY_Type * base, uint8 index, boolean isEnable, uint8 value, uint8 mask)
{
    uint16 regValue = base->MB[index].CCFR;
 ...
 */
static inline void FLEXRAY_SetMBFrameId(FLEXRAY_Type* base, uint8 index, uint16 id)
{
 ...
 */
static inline uint16 FLEXRAY_GetMBFrameId(const FLEXRAY_Type* base, uint16 index)
{
 ...
 */
static inline void FLEXRAY_SetPhyMBIndex(FLEXRAY_Type* base, uint8 index, uint16 phyIdx)
{
 ...
 */
static inline uint16 FLEXRAY_GetPhyMBIndex(const FLEXRAY_Type* base, uint8 index)
{
 ...
 */
static inline void FLEXRAY_SetMBDirection(FLEXRAY_Type* base, uint8 index, boolean isTx)
{
    uint16 regValue = base->MB[index].CCSR;
 ...
 */
static inline boolean FLEXRAY_IsMBTx(const FLEXRAY_Type* base, uint8 index)
{
 ...
 */
static inline void FLEXRAY_SetMBInterrupt(FLEXRAY_Type* base, uint8 index, boolean isEnable)
{
    uint16 regValue =base->MB[index].CCSR;
 ...
 */
static inline void FLEXRAY_SetMBDataOffset(FLEXRAY_Type* base, uint16 phyIdx, uint32 dataOffset)
{
 ...
 */
static inline uint16 FLEXRAY_GetMBDataOffset(const FLEXRAY_Type* base, uint16 phyIdx)
{
 ...
 */
static inline boolean FLEXRAY_GetMBEnableStatus(const FLEXRAY_Type* base, uint8 index)
{
 ...
 */
static inline boolean FLEXRAY_GetPOCStatus(const FLEXRAY_Type *base)
{
 ...
 */
static inline void FLEXRAY_SetFiFoWatermark(FLEXRAY_Type* base, boolean isChnB, uint8 watermarkValue)
{
 ...
 * @param[in]   isChnB              True: Channel B/False: Channel A
 */
static inline void FLEXRAY_SetFiFoChn(FLEXRAY_Type* base, boolean isChnB)
{
    uint16 regValue = base->RFWMSR;
    uint8 setChn = convertBoolInt(isChnB);
 ...
 */
static inline void FLEXRAY_SetFiFoRejFilter(FLEXRAY_Type* base, uint16 rejValue, uint16 rejMark)
{
 ...
 */
static inline void FLEXRAY_SetFiFoAcceptFilter(FLEXRAY_Type* base, uint16 acceptValue, uint16 acceptMark)
{
 ...
 */
static inline void FLEXRAY_SetFiFoPos(FLEXRAY_Type* base, uint16 startIdx, uint32 dataOffset)
{
 ...
 */
static inline uint16 FLEXRAY_GetFiFoStartIdx(const FLEXRAY_Type* base)
{
 ...
 */
static inline uint16 FLEXRAY_GetFiFoDataOffset(const FLEXRAY_Type* base)
{
 ...
 */
static inline void FLEXRAY_SetFiFoSize(FLEXRAY_Type* base, uint8 entrySize, uint8 depth)
{
 ...
 */
static inline uint8 FLEXRAY_GetFiFoEntrySize(const FLEXRAY_Type* base)
{
 ...
 */
static inline void FLEXRAY_SetProtocolControlCommand(FLEXRAY_Type *base, Flexray_Ip_ChiCmdType cmd)
{
 ...
 */
static inline void FLEXRAY_SetModuleConfiguration(FLEXRAY_Type *base, const Flexray_Ip_CcConfigType * ccConfig)
{
 ...
 */
static inline boolean FLEXRAY_GetMemLayout(const FLEXRAY_Type *base)
{
 ...
 */
static inline void FLEXRAY_SetSysMemBaseAddr(FLEXRAY_Type *base, uint32 baseMemAddr)
{
 ...
 */
static inline uint32 FLEXRAY_GetSysMemBaseAddr(const FLEXRAY_Type *base)
{
 ...
 */
static inline void FLEXRAY_SetRxFiFoSysMemBaseAddr(FLEXRAY_Type *base, uint32 fifobaseMemAddr)
{
 ...
 * @return system memory base address
 */
static inline uint32 FLEXRAY_GetRxFiFoSysMemBaseAddr(const FLEXRAY_Type *base)
{
 ...
 */
static inline void FLEXRAY_EnableCC(FLEXRAY_Type *base, boolean isEnable)
{
 ...
 */
static inline void FLEXRAY_SetSegmentSize(FLEXRAY_Type *base, uint8 seg1Size, uint8 seg2Size)
{
 ...
 */
static inline uint8 FLEXRAY_GetSegment1Size(const FLEXRAY_Type *base)
{
 ...
 */
static inline void FLEXRAY_SetSegmentBuffSize(FLEXRAY_Type *base, uint8 seg1BuffSize, uint8 seg2BuffSize)
{
 ...
 */
static inline uint8 FLEXRAY_GetSegment1BufferSize(const FLEXRAY_Type *base)
{
 ...
 */
static inline uint8 FLEXRAY_GetSegment2BufferSize(const FLEXRAY_Type *base)
{
 ...
 */
static inline uint16 FLEXRAY_GetNumbOfStaticSlots(const FLEXRAY_Type *base)
{
 ...
 * @return the key slot
 */
static inline uint16 FLEXRAY_GetKeySlot(const FLEXRAY_Type *base)
{
 ...
 */
static inline uint8 FLEXRAY_GetPayloadLengthStatic(const FLEXRAY_Type *base)
{
 ...
 */
static inline uint8 FLEXRAY_FillLevelFiFo(const FLEXRAY_Type * base, boolean isChnB)
{
    uint8 fillLevel = 0U;
    if (isChnB)
    {
 ...
 * @return the fill level
 */
static inline void FLEXRAY_PopCountFiFo(FLEXRAY_Type * base, boolean isChnB, uint8 popCount)
{
    if (isChnB)
    {
...
buffer
 */
static inline uint16 FLEXRAY_ReceiveFiFoAReadIdx(const FLEXRAY_Type *base)
{
...
buffer
 */
static inline uint16 FLEXRAY_ReceiveFiFoBReadIdx(const FLEXRAY_Type *base)
{
 ...
 *
 */
static inline void FLEXRAY_SetFiFoTimerDuration(FLEXRAY_Type *base, uint16 timerDuration)
{
 ...
 *
 */
static inline void FLEXRAY_SetSysMemAccessTimeout(FLEXRAY_Type *base, uint32 timeoutVal)
{
 ...
 */
void FLEXRAY_InitPE(uint8 instNum, const Flexray_Ip_PeConfigType* peConfig);
 ...
 * @param[in]   index               Index of message buffer
 */
static inline void FLEXRAY_ClearMBFlag(FLEXRAY_Type* base, uint8 index)
{
    uint8 one = 1U;
 ...
 * @param[in]   index               Index of message buffer
 */
static inline boolean FLEXRAY_GetMBFlag(const FLEXRAY_Type* base, uint8 index)
{
 ...
 * @param[in]   index               Index of message buffer
 */
static inline boolean FLEXRAY_GetMBInterruptEnable(const FLEXRAY_Type* base, uint8 index)
{
 ...
 * @param[in]   index               Index of message buffer
 */
static inline boolean FLEXRAY_GetMBDataUpdate(const FLEXRAY_Type* base, uint8 index)
{
 ...
 */
static inline uint8 FLEXRAY_GetSlotStatus(const FLEXRAY_Type* base, uint8 slotIdx, boolean isChnA)
{
    uint8 slotStatus;
 ...
 */
static inline void FLEXRAY_SetOffsetCorrection(FLEXRAY_Type* base, Flexray_Ip_ExtClkCorrectType correctType)
{
 ...
 * @param[in]   correctType    Correction type
 */
static inline void FLEXRAY_SetRateCorrection(FLEXRAY_Type* base, Flexray_Ip_ExtClkCorrectType correctType)
{
 ...
 */
static inline void FLEXRAY_SetMTSFilterChnA(FLEXRAY_Type* base,
 ...
 */
static inline void FLEXRAY_SetMTSFilterChnB(FLEXRAY_Type* base,
 ...
 * @param[in]   index               Index of message buffer
 */
static inline uint8 FLEXRAY_GetNMVLength(const FLEXRAY_Type* base)
{
 ...
 */
static inline uint16 FLEXRAY_GetNMV(const FLEXRAY_Type* base, uint8 regIndex)
{
 ...
 */
static inline void FLEXRAY_StartTimer1(FLEXRAY_Type *base, boolean isStart)
{
 ...
 * @param[in]   isStart        true: start/false: no effect
 */
static inline void FLEXRAY_StartTimer2(FLEXRAY_Type *base, boolean isStart)
{
    uint16 regValue = base->TICCR;
    uint8 start = convertBoolInt(isStart);
 ...
 */
static inline void FLEXRAY_StopTimer1(FLEXRAY_Type *base, boolean isStop)
{
    uint16 regValue = base->TICCR;
 ...
 * @param[in]   isStop         true: stop/false: no effect
 */
static inline void FLEXRAY_StopTimer2(FLEXRAY_Type *base, boolean isStop)
{
    uint16 regValue = base->TICCR;
    uint8 stop = convertBoolInt(isStop);
 ...
 */
void FLEXRAY_ConfigureTimer1(FLEXRAY_Type *base, const Flexray_Ip_TimerConfigType* timerCfg);
 ...
 * @param[in]   timeCfg        Pointer to timer configuration structure
 */
void FLEXRAY_ConfigureTimer2(FLEXRAY_Type *base, const Flexray_Ip_TimerConfigType* timerCfg);
 ...
 */
static inline void FLEXRAY_SetTxMBInterrupt(FLEXRAY_Type *base, boolean isEnable)
{
 ...
 * @param[in]   isEnable       true: enabled/false: disable
 */
static inline void FLEXRAY_SetRxMBInterrupt(FLEXRAY_Type *base, boolean isEnable)
{
    uint16 regValue = base->GIFER;
    uint8 enb = convertBoolInt(isEnable);
 ...
 * @param[in]   base           The Flexray base address
 */
static inline uint32 FLEXRAY_GetAllProtocolInterruptFlag(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline uint32 FLEXRAY_GetAllProtocolInterruptEnable(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_ClearAllProtocolInterruptFlag(FLEXRAY_Type *base)
{
    base->PIFR0 = 0xFFFFU;
    base->PIFR1 = 0xFF30U;
}
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_DisableAllProtocolInterrupt(FLEXRAY_Type *base)
{
    base->PIER0 = 0x00U;
    base->PIER1 = 0x00U;
}
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_DisableAllGlobalInterrupt(FLEXRAY_Type *base)
{
    base->GIFER = 0x00U;
}
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_DisableAllRangeFilter(FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetWUPInterruptEnable(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetCHIInterruptEnable(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetFIFOAInterruptEnable(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetFIFOBInterruptEnable(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetWUPInterruptFlag(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetFifoAInterruptFlag(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetFifoBInterruptFlag(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_ClearFifoAInterruptFlag(FLEXRAY_Type *base)
{
    uint8 one = 1U;
    uint16 regValue = base->GIFER;
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_ClearFifoBInterruptFlag(FLEXRAY_Type *base)
{
    uint8 one = 1U;
    uint16 regValue = base->GIFER;
    regValue &= ~((uint16)(FLEXRAY_GIFER_WUPIF_MASK | FLEXRAY_GIFER_FAFBIF_MASK | FLEXRAY_GIFER_FAFAIF_MASK));
 ...
 * @param[in]   base           The Flexray base address
 */
static inline uint16 FLEXRAY_GetAllCHIErrorInterruptFlag(const FLEXRAY_Type *base)
{
    return (base->CHIERFR);
}
 ...
 * @param[in]   base           The Flexray base address
 */
static inline void FLEXRAY_ClearAllCHIErrorInterruptFlag(FLEXRAY_Type *base)
{
 ...
 *
 */
static inline void FLEXRAY_SetTimebaseModeTimer2(FLEXRAY_Type *base, boolean isRelative)
{
    uint16 regValue = base->TICCR;
 ...
 *
 */
static inline void FLEXRAY_SetMTS(FLEXRAY_Type *base, boolean isChnA, boolean enable)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetTxChnAConflict(const FLEXRAY_Type *base)
{
 ...
 * @param[in]   base           The Flexray base address
 */
static inline boolean FLEXRAY_GetTxChnBConflict(const FLEXRAY_Type *base)
{
