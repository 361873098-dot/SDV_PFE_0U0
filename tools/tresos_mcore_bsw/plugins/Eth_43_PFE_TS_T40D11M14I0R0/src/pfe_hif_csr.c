...
uint32_t pfe_hif_cfg_get_tx_fifo_fill_level(addr_t base_va)
{
    ...
    uint32_t tmp = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_DXR_TX_FIFO_CNT));
...
{
#if (FALSE == PFE_HIF_CFG_USE_BD_POLLING)
    hal_write32(RX_BDP_CH_START, ADDR_BASE_OFFSET(base_va,  HIF_RX_CHn_START(channel_id)));
#else
    (void)base_va;
    (void)channel_id;
#endif /* PFE_HIF_CFG_USE_BD_POLLING */
...
{
#if (FALSE == PFE_HIF_CFG_USE_BD_POLLING)
    hal_write32(0U, ADDR_BASE_OFFSET(base_va,  HIF_RX_CHn_START(channel_id)));
#else
    (void)base_va;
    (void)channel_id;
#endif /* PFE_HIF_CFG_USE_BD_POLLING */
...
{
#if (FALSE == PFE_HIF_CFG_USE_BD_POLLING)
    hal_write32(TX_BDP_CH_START, ADDR_BASE_OFFSET(base_va,  HIF_TX_CHn_START(channel_id)));
#else
    (void)base_va;
    (void)channel_id;
#endif /* PFE_HIF_CFG_USE_BD_POLLING */
...
{
#if (FALSE == PFE_HIF_CFG_USE_BD_POLLING)
    hal_write32(0U, ADDR_BASE_OFFSET(base_va,  HIF_TX_CHn_START(channel_id)));
#else
    (void)base_va;
    (void)channel_id;
#endif /* PFE_HIF_CFG_USE_BD_POLLING */
...
void pfe_hif_chnl_cfg_set_rx_bd_ring_addr(addr_t base_va, uint32_t channel_id, const void *rx_ring_pa)
{
    ...
    {
        hal_write32((uint32_t)((addr_t)rx_ring_pa & 0xffffffffU), ADDR_BASE_OFFSET(base_va,  HIF_RX_BDP_RD_LOW_ADDR_CHn(channel_id)));
...
void pfe_hif_chnl_cfg_set_rx_wb_table(addr_t base_va, uint32_t channel_id, const void *wb_tbl_pa, uint32_t tbl_len)
{
    ...
    {
        hal_write32((uint32_t)((addr_t)wb_tbl_pa & 0xffffffffU), ADDR_BASE_OFFSET(base_va,  HIF_RX_BDP_WR_LOW_ADDR_CHn(channel_id)));
...
void pfe_hif_chnl_cfg_set_tx_bd_ring_addr(addr_t base_va, uint32_t channel_id, const void *tx_ring_pa)
{
    ...
    {
        hal_write32((uint32_t)((addr_t)tx_ring_pa & 0xffffffffU), ADDR_BASE_OFFSET(base_va,  HIF_TX_BDP_RD_LOW_ADDR_CHn(channel_id)));
...
void pfe_hif_chnl_cfg_set_tx_wb_table(addr_t base_va, uint32_t channel_id, const void *wb_tbl_pa, uint32_t tbl_len)
{
    ...
    {
        hal_write32((uint32_t)((addr_t)wb_tbl_pa & 0xffffffffU), ADDR_BASE_OFFSET(base_va,  HIF_TX_BDP_WR_LOW_ADDR_CHn(channel_id)));
...
{
    uint32_t ena = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_INT_COAL_EN_CHn(channel_id)));
 ...
 */
void pfe_hif_chnl_cfg_set_master_up(addr_t base_va, uint32_t channel_id, bool_t value)
{
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
 ...
 */
bool_t pfe_hif_chnl_cfg_get_master_up(addr_t base_va, uint32_t channel_id)
{
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
 ...
 */
void pfe_hif_chnl_cfg_set_hif_occupied(addr_t base_va, uint32_t channel_id, bool_t value)
{
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
 ...
 */
bool_t pfe_hif_chnl_cfg_get_hif_occupied(addr_t base_va, uint32_t channel_id)
{
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
 ...
 */
errno_t pfe_hif_chnl_cfg_set_emac_timer_ownership(addr_t base_va, uint32_t channel_id, pfe_ct_phy_if_id_t emac, bool_t value)
{
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
    errno_t ret = EOK;
 ...
 */
bool_t pfe_hif_chnl_cfg_get_emac_timer_ownership(addr_t base_va, uint32_t channel_id, pfe_ct_phy_if_id_t emac)
{
    bool_t val = FALSE;
    uint32_t reg = hal_read32(ADDR_BASE_OFFSET(base_va,  HIF_LTC_MAX_PKT_CHn_ADDR(channel_id)));
 ...
 */
uint32_t pfe_hif_chnl_cfg_get_rx_bdp_rd_fifo_cnt(addr_t base_va, uint32_t channel_id)
{
