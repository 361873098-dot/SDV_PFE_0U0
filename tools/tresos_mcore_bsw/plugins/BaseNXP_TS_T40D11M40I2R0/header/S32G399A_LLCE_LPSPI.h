/*
** ###################################################################
**     Processor:           S32G99A_LLCEM0
**     Compiler:            Keil ARM C/C++ Compiler
**     Reference manual:    S32G3xx_LLCE Rev 1 Draft F
**     Version:             rev. 1.0, 2022-06-09
**     Build:               b220609
**
**     Abstract:
**         Peripheral Access Layer for S32G3xx_LLCEM0
**
...
/*!
 * @file S32G399A_LLCE_LPSPI.h
 * @version 1.0
 * @date 2022-06-09
 * @brief Peripheral Access Layer for S32G399A_LLCE_LPSPI
 *
...
#if !defined(S32G399A_LLCE_LPSPI_H_)  /* Check if memory map has not been already included */
#define S32G399A_LLCE_LPSPI_H_
...
/** LLCE_LPSPI - Size of Registers Arrays */
#define LLCE_LPSPI_TDBR_COUNT                     128u
#define LLCE_LPSPI_RDBR_COUNT                     128u
...
typedef struct {
  ...
  __O  uint32_t TDBR[LLCE_LPSPI_TDBR_COUNT];       /**< Transmit Data Burst, array offset: 0x400, array step: 0x4 */
  __I  uint32_t RDBR[LLCE_LPSPI_RDBR_COUNT];       /**< Receive Data Burst, array offset: 0x600, array step: 0x4 */
...
#define LLCE_LPSPI_CFGR0_HRDIR_MASK              (0x8U)
#define LLCE_LPSPI_CFGR0_HRDIR_SHIFT             (3U)
#define LLCE_LPSPI_CFGR0_HRDIR_WIDTH             (1U)
#define LLCE_LPSPI_CFGR0_HRDIR(x)                (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CFGR0_HRDIR_SHIFT)) & LLCE_LPSPI_CFGR0_HRDIR_MASK)
...
#define LLCE_LPSPI_CFGR1_PARTIAL_MASK            (0x10U)
#define LLCE_LPSPI_CFGR1_PARTIAL_SHIFT           (4U)
#define LLCE_LPSPI_CFGR1_PARTIAL_WIDTH           (1U)
#define LLCE_LPSPI_CFGR1_PARTIAL(x)              (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CFGR1_PARTIAL_SHIFT)) & LLCE_LPSPI_CFGR1_PARTIAL_MASK)
...
#define LLCE_LPSPI_CCR1_SCKSET_MASK              (0xFFU)
#define LLCE_LPSPI_CCR1_SCKSET_SHIFT             (0U)
#define LLCE_LPSPI_CCR1_SCKSET_WIDTH             (8U)
#define LLCE_LPSPI_CCR1_SCKSET(x)                (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CCR1_SCKSET_SHIFT)) & LLCE_LPSPI_CCR1_SCKSET_MASK)

#define LLCE_LPSPI_CCR1_SCKHLD_MASK              (0xFF00U)
#define LLCE_LPSPI_CCR1_SCKHLD_SHIFT             (8U)
#define LLCE_LPSPI_CCR1_SCKHLD_WIDTH             (8U)
#define LLCE_LPSPI_CCR1_SCKHLD(x)                (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CCR1_SCKHLD_SHIFT)) & LLCE_LPSPI_CCR1_SCKHLD_MASK)

#define LLCE_LPSPI_CCR1_PCSPCS_MASK              (0xFF0000U)
#define LLCE_LPSPI_CCR1_PCSPCS_SHIFT             (16U)
#define LLCE_LPSPI_CCR1_PCSPCS_WIDTH             (8U)
#define LLCE_LPSPI_CCR1_PCSPCS(x)                (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CCR1_PCSPCS_SHIFT)) & LLCE_LPSPI_CCR1_PCSPCS_MASK)

#define LLCE_LPSPI_CCR1_SCKSCK_MASK              (0xFF000000U)
#define LLCE_LPSPI_CCR1_SCKSCK_SHIFT             (24U)
#define LLCE_LPSPI_CCR1_SCKSCK_WIDTH             (8U)
#define LLCE_LPSPI_CCR1_SCKSCK(x)                (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_CCR1_SCKSCK_SHIFT)) & LLCE_LPSPI_CCR1_SCKSCK_MASK)
/*! @} */
...
#define LLCE_LPSPI_RDROR_DATA_MASK               (0xFFFFFFFFU)
#define LLCE_LPSPI_RDROR_DATA_SHIFT              (0U)
#define LLCE_LPSPI_RDROR_DATA_WIDTH              (32U)
#define LLCE_LPSPI_RDROR_DATA(x)                 (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_RDROR_DATA_SHIFT)) & LLCE_LPSPI_RDROR_DATA_MASK)
/*! @} */

/*! @name TCBR - Transmit Command Burst */
/*! @{ */

#define LLCE_LPSPI_TCBR_DATA_MASK                (0xFFFFFFFFU)
#define LLCE_LPSPI_TCBR_DATA_SHIFT               (0U)
#define LLCE_LPSPI_TCBR_DATA_WIDTH               (32U)
#define LLCE_LPSPI_TCBR_DATA(x)                  (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_TCBR_DATA_SHIFT)) & LLCE_LPSPI_TCBR_DATA_MASK)
/*! @} */

/*! @name TDBR - Transmit Data Burst */
/*! @{ */

#define LLCE_LPSPI_TDBR_DATA_MASK                (0xFFFFFFFFU)
#define LLCE_LPSPI_TDBR_DATA_SHIFT               (0U)
#define LLCE_LPSPI_TDBR_DATA_WIDTH               (32U)
#define LLCE_LPSPI_TDBR_DATA(x)                  (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_TDBR_DATA_SHIFT)) & LLCE_LPSPI_TDBR_DATA_MASK)
/*! @} */

/*! @name RDBR - Receive Data Burst */
/*! @{ */

#define LLCE_LPSPI_RDBR_DATA_MASK                (0xFFFFFFFFU)
#define LLCE_LPSPI_RDBR_DATA_SHIFT               (0U)
#define LLCE_LPSPI_RDBR_DATA_WIDTH               (32U)
#define LLCE_LPSPI_RDBR_DATA(x)                  (((uint32_t)(((uint32_t)(x)) << LLCE_LPSPI_RDBR_DATA_SHIFT)) & LLCE_LPSPI_RDBR_DATA_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G399A_LLCE_LPSPI_H_) */
