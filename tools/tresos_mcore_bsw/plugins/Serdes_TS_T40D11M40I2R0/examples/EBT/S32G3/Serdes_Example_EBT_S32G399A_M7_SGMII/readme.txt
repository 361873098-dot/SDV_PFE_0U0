1 Introduction
==============
This example application demonstrates the usage of the Serdes driver for S32G3 in SGMII mode.
...
On S32G3 platform there are 4 MACs and all of them support SGMII.

S32G3 mapping to XPCS:
+--------+-------+-------+
| SerDes | XPCS0 | XPCS1 |
+--------+-------+-------+
|      0 | GMAC  | PFE2  |
