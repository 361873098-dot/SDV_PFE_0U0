...
#define HIF_NOCPY_TIMER_OWNERSHIP_EMAC0(x)     ((!!(x)) ? (1UL << 4U) : 0U)
#define HIF_NOCPY_TIMER_OWNERSHIP_EMAC1(x)     ((!!(x)) ? (1UL << 5U) : 0U)
#define HIF_NOCPY_TIMER_OWNERSHIP_EMAC2(x)     ((!!(x)) ? (1UL << 6U) : 0U)
