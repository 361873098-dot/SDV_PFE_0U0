...
#define ADC_SW_PATCH_VERSION_CFGDEFINES               2
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
[!LOOP "AdcConfigSet/AdcHwUnit/*"!][!//
  ...
  [!// The current ADC Hw unit has at least 1 Group is HW triggered which trigger source comes from CTU
    [!IF "node:value(./AdcTransferType)='ADC_INTERRUPT'"!][!//
[!CODE!][!//
#define ADC_CTU_FIFO_[!"$AdcPhysicalId"!]_OF_ISR_USED
[!ENDCODE!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
[!ENDLOOP!][!//
