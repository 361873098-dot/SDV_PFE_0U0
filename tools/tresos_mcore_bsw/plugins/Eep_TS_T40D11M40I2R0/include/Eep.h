...
#define EEP_SWITCHPARTITIONACCESS_ID 0x0CU
...
*
* @api
* @param[in]    PartitionAccess partition to switch
...
*
* @param[in]    ConfigPtr must not be NULL_PTR if precompile is not support.
* @param[int]   BootBlockCount Number of boot blocks.
