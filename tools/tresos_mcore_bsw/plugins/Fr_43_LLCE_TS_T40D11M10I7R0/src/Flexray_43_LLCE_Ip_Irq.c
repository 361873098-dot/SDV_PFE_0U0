...
#define FLEXRAY_IP_IRQ_SW_MAJOR_VERSION_C                 1
#define FLEXRAY_IP_IRQ_SW_MINOR_VERSION_C                 0
#define FLEXRAY_IP_IRQ_SW_PATCH_VERSION_C                 7
...
/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same vendor */
    ...
    #error "Flexray_43_LLCE_Ip_Irq.c and Flexray_43_LLCE_Ip_Irq.h have different Vendor IDs"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Flexray_43_LLCE_Ip_Irq.c and Flexray_43_LLCE_Ip_Irq.h are different"
#endif
/* Check if current file and Flexray_43_LLCE_Ip_Irq.h header file are of the same software version */
    ...
    #error "Software Version Numbers of Flexray_43_LLCE_Ip_Irq.c and Flexray_43_LLCE_Ip_Irq.h are different"
#endif
/*==================================================================================================
...
#include "Fr_43_LLCE_MemMap.h"
    ...
    #endif /* (FLEXRAY_43_LLCE_INSTANCE_COUNT > 0U) */

    #if (FLEXRAY_43_LLCE_INSTANCE_COUNT > 1U)
    ...
    #endif /* (FLEXRAY_43_LLCE_INSTANCE_COUNT > 1U) */
#endif
