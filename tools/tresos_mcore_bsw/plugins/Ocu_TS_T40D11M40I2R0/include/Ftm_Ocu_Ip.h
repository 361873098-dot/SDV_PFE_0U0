...
#include "Ftm_Ocu_Ip_TrustedFunctions.h"
...
#define FTM_OCU_IP_SW_MAJOR_VERSION                4
#define FTM_OCU_IP_SW_MINOR_VERSION                0
#define FTM_OCU_IP_SW_PATCH_VERSION                2
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
#if (FTM_OCU_IP_VENDOR_ID != FTM_OCU_IP_TRUSTEDFUNCTIONS_VENDOR_ID)
    #error "Ftm_Ocu_Ip.h and Ftm_Ocu_Ip_TrustedFunctions.h have different vendor ids"
#endif

/* Check if  header file and Ftm_Ocu_Ip_TrustedFunctions.h file are of the same Autosar version */
#if ((FTM_OCU_IP_AR_RELEASE_MAJOR_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_OCU_IP_AR_RELEASE_MINOR_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (FTM_OCU_IP_AR_RELEASE_REVISION_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Ftm_Ocu_Ip.h and Ftm_Ocu_Ip_TrustedFunctions.h are different"
#endif

/* Check if header file and Ftm_Ocu_Ip_TrustedFunctions.h file are of the same Software version */
#if ((FTM_OCU_IP_SW_MAJOR_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (FTM_OCU_IP_SW_MINOR_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (FTM_OCU_IP_SW_PATCH_VERSION != FTM_OCU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION))
    #error "Software Version Numbers of Ftm_Ocu_Ip.h and Ftm_Ocu_Ip_TrustedFunctions.h are different"
#endif
