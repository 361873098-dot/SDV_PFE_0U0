...
#define RM_XRDC_IP_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MAJOR_VERSION_C              4
#define RM_XRDC_IP_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_MINOR_VERSION_C              0
#define RM_XRDC_IP_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_C              2
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
[!IF "contains($MrcList, concat($MrcInstance, ','))"!]
    [!VAR "tempMrcIndex"="0"!]
    [!VAR "tempDesc"="''"!]
...
[!ENDCODE!][!//
        ...
        [!CODE!][!WS "8"!](uint32)[!"num:inttohex(bit:shr(./XrdcStartAddress,4))"!]UL,[!CR!][!ENDCODE!]
        [!CODE!][!WS "8"!]/*End address for [!"./XrdcMrcInstance"!] controller and descriptor [!"num:i($MrcDescriptor)"!] */[!CR!][!ENDCODE!]
        [!CODE!][!WS "8"!](uint32)[!"num:inttohex(bit:shr(./XrdcEndAddress,4))"!]UL,[!CR!][!ENDCODE!]
