...
#define GPT_IPW_SW_PATCH_VERSION_VS_0_PBCFG_C             2
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_VS_0_PBcfg.c and Pit_Ip_VS_0_PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_VS_0_PBcfg.c and Stm_Ip_VS_0_PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
...
/* Check if the header files are of the same Software version */
    ...
    #error "Gpt_Ipw_VS_0_PBcfg.c and Rtc_Ip_VS_0_PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
...
Gpt_Ipw_HwChannelConfigType Gpt_Ipw_ChannelConfig_PB_VS_0[2U] =
{
    ...
    /** @brief GptChannelConfiguration_1 */
    {
        ...
        /** @brief IP channel pointer */
        {
            &PIT_1_ChannelConfig_PB_VS_0[1U],
            NULL_PTR,
            NULL_PTR,
            NULL_PTR
        }
