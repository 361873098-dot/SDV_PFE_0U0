...
Jump functions:
  Jump functions of caller  Power_Ip_CM7_EnableSleepOnExit/16:
  Jump functions of caller  Power_Ip_CM7_DisableSleepOnExit/15:
...
Power_Ip_CM7_EnableSleepOnExit/16 (Power_Ip_CM7_EnableSleepOnExit) @079c6ee0
  Type: function
  ...
  Calls: 
Power_Ip_CM7_DisableSleepOnExit/15 (Power_Ip_CM7_DisableSleepOnExit) @079c6e00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: Mcu_Ipw_SleepOnExit/7 (536870913 (estimated locally),0.50 per call) 
  Calls: 
Power_Ip_GetResetRawValue/14 (Power_Ip_GetResetRawValue) @079c6c40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Power_Ip_GetResetReason/13 (Power_Ip_GetResetReason) @079c6a80
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Power_Ip_SetMode/12 (Power_Ip_SetMode) @079c68c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_GetPllStatus/11 (Clock_Ip_GetPllStatus) @079c6700
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_DistributePll/10 (Clock_Ip_DistributePll) @079c6540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_InitClock/9 (Clock_Ip_InitClock) @079c6380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Power_Ip_Init/8 (Power_Ip_Init) @079c61c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Mcu_Ipw_SleepOnExit/7 (Mcu_Ipw_SleepOnExit) @079c27e0
  ...
  Called by: 
  Calls: Power_Ip_CM7_EnableSleepOnExit/16 (536870913 (estimated locally),0.50 per call) Power_Ip_CM7_DisableSleepOnExit/15 (536870913 (estimated locally),0.50 per call) 
Mcu_Ipw_GetResetRawValue/6 (Mcu_Ipw_GetResetRawValue) @079c22a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_GetResetReason/5 (Mcu_Ipw_GetResetReason) @079c2ee0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_SetMode/4 (Mcu_Ipw_SetMode) @079c2c40
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_GetPllStatus/3 (Mcu_Ipw_GetPllStatus) @079c29a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_DistributePllClock/2 (Mcu_Ipw_DistributePllClock) @079c2700
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_InitClock/1 (Mcu_Ipw_InitClock) @079c2460
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
Mcu_Ipw_Init/0 (Mcu_Ipw_Init) @079c21c0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function Mcu_Ipw_Init (Mcu_Ipw_Init, funcdef_no=0, decl_uid=7316, cgraph_uid=1, symbol_order=0)
...
;; Function Mcu_Ipw_InitClock (Mcu_Ipw_InitClock, funcdef_no=1, decl_uid=7320, cgraph_uid=2, symbol_order=1)
...
;; Function Mcu_Ipw_DistributePllClock (Mcu_Ipw_DistributePllClock, funcdef_no=2, decl_uid=7322, cgraph_uid=3, symbol_order=2)
...
;; Function Mcu_Ipw_GetPllStatus (Mcu_Ipw_GetPllStatus, funcdef_no=3, decl_uid=7324, cgraph_uid=4, symbol_order=3)
...
;; Function Mcu_Ipw_SetMode (Mcu_Ipw_SetMode, funcdef_no=4, decl_uid=7318, cgraph_uid=5, symbol_order=4)
...
;; Function Mcu_Ipw_GetResetReason (Mcu_Ipw_GetResetReason, funcdef_no=5, decl_uid=7326, cgraph_uid=6, symbol_order=5)
...
;; Function Mcu_Ipw_GetResetRawValue (Mcu_Ipw_GetResetRawValue, funcdef_no=6, decl_uid=7328, cgraph_uid=7, symbol_order=6)
...
;; Function Mcu_Ipw_SleepOnExit (Mcu_Ipw_SleepOnExit, funcdef_no=7, decl_uid=7330, cgraph_uid=8, symbol_order=7)
