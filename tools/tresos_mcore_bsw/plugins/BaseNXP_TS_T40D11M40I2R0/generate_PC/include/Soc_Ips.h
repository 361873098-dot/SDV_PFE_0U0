...
[!//
[!IF "(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32g2') or contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32r45'))"!][!//
/**
...
* @details e050705 GMAC: Head-Of-Line blocking error due to incorrect packet size when gates of gate control list (GCL) are closed.
*/
#define ERR_IPV_GMAC_E050705    (STD_ON)

[!IF "(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32g2'))"!][!//
/**
...
/**
* @brief Hardware errata for GMAC: (e050109)
* @details e050109 GMAC:  VLAN RX Hash filtering modes cannot be selected.
*/
#define ERR_IPV_GMAC_E050109    (STD_ON)

/**
* @brief Hardware errata for GMAC: (e050176)
* @details e050176 GMAC: Rx Parser provide an additional frame count when Packet flush happens during header status write.
*/
#define ERR_IPV_GMAC_E050176    (STD_ON)
...
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "(contains(node:value(node:fallback(ResourceGeneral/ResourceSubderivative,'')),'s32g3'))"!][!//
/**
