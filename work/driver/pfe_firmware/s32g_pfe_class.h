...
#ifndef S32G_PFE_CLASS_H
#define S32G_PFE_CLASS_H

#include "BasicTypes.h"

/* firmware array size in bytes */
#define PFE_CLASS_FW_BINARY_SIZE 44992U
extern const uint8_t pfe_class_fw_binary[PFE_CLASS_FW_BINARY_SIZE];

#endif /* S32G_PFE_CLASS_H */
