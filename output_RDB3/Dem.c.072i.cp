...
Sys_GetCoreID/7 (Sys_GetCoreID) @06e71460
  Type: function
  ...
  Calls: 
Dem_ReportErrorStatusPreExtData/6 (Dem_ReportErrorStatusPreExtData) @06e71000
...
Dem_SetEventStatus/5 (Dem_SetEventStatus) @06e69700
  Type: function definition analyzed
  Visibility: externally_visible public
...
Dem_numEventErrors/4 (Dem_numEventErrors) @06e6d240
  ...
  Availability: available
  Varpool flags:
Dem_au8ExtendedData/3 (Dem_au8ExtendedData) @06e6d1f8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Dem_OverflowEvent/2 (Dem_OverflowEvent) @06e6d1b0
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  ...
  Availability: available
  Varpool flags:
Dem_EventStatus/1 (Dem_EventStatus) @06e6d168
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Dem_SetEventStatus/5 (write)Dem_SetEventStatus/5 (write)Dem_ReportErrorStatusPreExtData/6 (write)Dem_ReportErrorStatusPreExtData/6 (write)
  Availability: available
  Varpool flags:
Dem_EventId/0 (Dem_EventId) @06e6d120
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Dem_SetEventStatus/5 (write)Dem_SetEventStatus/5 (write)Dem_ReportErrorStatusPreExtData/6 (write)Dem_ReportErrorStatusPreExtData/6 (write)
...
;; Function Dem_SetEventStatus (Dem_SetEventStatus, funcdef_no=0, decl_uid=5653, cgraph_uid=1, symbol_order=5)
...
;; Function Dem_ReportErrorStatusPreExtData (Dem_ReportErrorStatusPreExtData, funcdef_no=1, decl_uid=5658, cgraph_uid=2, symbol_order=6)
