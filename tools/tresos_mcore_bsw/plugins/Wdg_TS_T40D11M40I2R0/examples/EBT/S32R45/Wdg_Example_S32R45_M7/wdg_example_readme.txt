1. Example Description
    ...
    The application includes an EB Tresos project that configures the BaseNXP, Dem, Dio, EcuC, Gpt, Mcu, Os, Platform, Wdg and Resource drivers.
    1.1 The application software functionality
            ...
            - Gpt_Init
                    Initialize the Gpt driver in order to periodically trigger the Wdg servicing routine
            ...
            - Verify that the Wdg counter will not expire while periodically serviced and in case it is not serviced, it will generate an interrupt.
            Note: If the result is correct, the program will go to the end of code without getting stuck in the loop.

2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - Motherboard: X-S32R45-PROC-S PCB RevB RevX5 SCH RevB1
            - Daughter card: S32GRV-PLATEVB PCB RevA SCH RevB
