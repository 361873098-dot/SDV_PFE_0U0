...
const Clock_Ip_ClockConfigType Mcu_aClockConfigPB_VS_0[3U] = {
...

    {
        ...
        /* SELECTOR initialization. */
        {
            ...
            #if CLOCK_IP_SELECTORS_NO > 6U
            {
                ...
                PFE_MAC_0_EXT_REF_CLK,                       /* Name of the selected input source */
            },
            #endif
            ...
            #if CLOCK_IP_SELECTORS_NO > 7U
            {
                ...
                PFE_MAC_1_EXT_REF_CLK,                       /* Name of the selected input source */
            },
            #endif
            ...
            #if CLOCK_IP_SELECTORS_NO > 8U
            {
                ...
                PFE_MAC_2_EXT_REF_CLK,                       /* Name of the selected input source */
            },
            #endif
...

    {
        ...
        /* SELECTOR initialization. */
        {
            ...
            #if CLOCK_IP_SELECTORS_NO > 1U
            {
                ...
                PERIPH_PLL_DFS3_CLK,                       /* Name of the selected input source */
            },
            #endif
