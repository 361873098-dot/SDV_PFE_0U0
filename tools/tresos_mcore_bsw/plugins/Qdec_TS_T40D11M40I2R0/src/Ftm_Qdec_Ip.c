...
#define FTM_QDEC_IP_SW_MAJOR_VERSION_C                4
#define FTM_QDEC_IP_SW_MINOR_VERSION_C                0
#define FTM_QDEC_IP_SW_PATCH_VERSION_C                2
...
#define QDEC_START_SEC_VAR_CLEARED_BOOLEAN
#include "Qdec_MemMap.h"

/** @brief Quadrature ftm initialization state variable */
boolean gQdecFtmInitState = FALSE;

#define QDEC_STOP_SEC_VAR_CLEARED_BOOLEAN
#include "Qdec_MemMap.h"
/*==================================================================================================
