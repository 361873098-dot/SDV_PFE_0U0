...
#endif
    if(timeout < 1) return 1; /*DFS_TIMEOUT*/
    timeout = 0xFFFF; /*reset timeout*/
...
static int Init_MC_CGM(void)
{
   ...
   IP_MC_CGM_0->MUX_9_DC_0 &= ~MC_CGM_MUX_9_DC_0_DIV_MASK;
    ...
    IP_MC_CGM_0->MUX_12_DC_0 |= MC_CGM_MUX_12_DC_0_DIV((2-1));    /*PERIPH_DFS1_CLK[800MHz] -> QSPI_2X_CLK[200,166,133,100,80,66MHz] = 200MHz, QSPI_1X_CLK = 100MHz */
