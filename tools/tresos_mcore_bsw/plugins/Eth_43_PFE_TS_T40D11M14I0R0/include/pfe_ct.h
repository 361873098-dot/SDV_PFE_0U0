 ...
 */
typedef uint32_t pfe_ct_if_m_rules_t;
...
typedef uint8_t pfe_ct_fp_flags_t;
...
typedef uint32_t pfe_ct_if_flags_t;
...
typedef uint8_t pfe_ct_spd_flags_t;
...
*/
typedef uint8_t pfe_ct_feature_flags_t;
...
typedef uint32_t pfe_ct_hif_rx_flags_t;
...
typedef uint8_t pfe_ct_hif_tx_flags_t;
 ...
 */
typedef uint32_t pfe_ct_route_actions_t;
 ...
 */
typedef uint32_t pfe_ct_rtable_flags_t;
 ...
 */
typedef uint8_t pfe_rtable_entry_status_t;
