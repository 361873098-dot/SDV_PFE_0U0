...
#define SPI_VS_0_SW_PATCH_VERSION_PBCFG_C                 2
...
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1105Q, 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1105Q, 4)
#endif
/* Allocate Buffers for IB Channels (if any) */
#if (CPU_TYPE == CPU_TYPE_64)
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1110a, 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1110a, 4)
#endif
/* Allocate Buffers for IB Channels (if any) */
#if (CPU_TYPE == CPU_TYPE_64)
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1110b, 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_BufferDescriptorType Spi_Buffer_VS_0_SpiChannel_SJA1110b, 4)
#endif
/* Allocate Buffers for IB Channels (if any) */
...
/* Channel Configuration of SpiChannel_SJA1105Q*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_SJA1105Q_VS_0 =
{
        /* SpiChannel_SJA1105Q*/
        ...
        &Spi_Buffer_VS_0_SpiChannel_SJA1105Q, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
        &Spi_axSpiChannelState[0U] /* pChannelState pointer */
};
/* Channel Configuration of SpiChannel_SJA1110a*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_SJA1110a_VS_0 =
{
        /* SpiChannel_SJA1110a*/
        EB, /* BufferType IB or EB */
        16U, /* Frame size */
        ...
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        1000U, /* Length (configured in SpiEbMaxLength) */
        &Spi_Buffer_VS_0_SpiChannel_SJA1110a, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
        &Spi_axSpiChannelState[1U] /* pChannelState pointer */
};
/* Channel Configuration of SpiChannel_SJA1110b*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_SJA1110b_VS_0 =
{
        /* SpiChannel_SJA1110b*/
        EB, /* BufferType IB or EB */
        16U, /* Frame size */
        ...
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        1000U, /* Length (configured in SpiEbMaxLength) */
        &Spi_Buffer_VS_0_SpiChannel_SJA1110b, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
        &Spi_axSpiChannelState[2U] /* pChannelState pointer */
};
/* Spi_apChannelConfigList_VS_0 Channel Configuration of Spi*/
static const Spi_ChannelsCfgType Spi_aChannelConfigList_VS_0[3] =
{
    {
    /* SpiChannel_SJA1105Q */
    /* SpiChannel_SJA1105Q */
    &Spi_ChannelConfig_SpiChannel_SJA1105Q_VS_0
    },
    {
    /* SpiChannel_SJA1110a */
    /* SpiChannel_SJA1110a */
    &Spi_ChannelConfig_SpiChannel_SJA1110a_VS_0
    },
    {
    /* SpiChannel_SJA1110b */
    /* SpiChannel_SJA1110b */
    &Spi_ChannelConfig_SpiChannel_SJA1110b_VS_0
    }
...
static const Spi_ChannelType Spi_SpiJob_SJA1105Q_ChannelAssignment_VS_0[1] = {SpiConf_SpiChannel_SpiChannel_SJA1105Q};
static const Spi_ChannelType Spi_SpiJob_SJA1110a_ChannelAssignment_VS_0[1] = {SpiConf_SpiChannel_SpiChannel_SJA1110a};
static const Spi_ChannelType Spi_SpiJob_SJA1110b_ChannelAssignment_VS_0[1] = {SpiConf_SpiChannel_SpiChannel_SJA1110b};

/* Configuration of Jobs */

/* Job Configuration of SpiJob_SJA1105Q*/
static const Spi_JobConfigType Spi_JobConfig_SpiJob_SJA1105Q_VS_0 =
{
        /* SpiJob_SJA1105Q */
        (Spi_ChannelType)1U, /* NumChannels field */
        Spi_SpiJob_SJA1105Q_ChannelAssignment_VS_0, /* List of Channels */
        ...
        SPI_SpiExternalDevice_SJA1105Q, /* External Device */
                &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_SJA1105Q] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
/* Job Configuration of SpiJob_SJA1110a*/
static const Spi_JobConfigType Spi_JobConfig_SpiJob_SJA1110a_VS_0 =
{
        /* SpiJob_SJA1110a */
        (Spi_ChannelType)1U, /* NumChannels field */
        Spi_SpiJob_SJA1110a_ChannelAssignment_VS_0, /* List of Channels */
        ...
        CSIB1, /* HWUnit index */
        /* External Device Settings */
        SPI_SpiExternalDevice_SJA1110a, /* External Device */
                &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_SJA1110a] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
/* Job Configuration of SpiJob_SJA1110b*/
static const Spi_JobConfigType Spi_JobConfig_SpiJob_SJA1110b_VS_0 =
{
        /* SpiJob_SJA1110b */
        (Spi_ChannelType)1U, /* NumChannels field */
        Spi_SpiJob_SJA1110b_ChannelAssignment_VS_0, /* List of Channels */
        ...
        CSIB1, /* HWUnit index */
        /* External Device Settings */
        SPI_SpiExternalDevice_SJA1110b, /* External Device */
                &Spi_aExternalDeviceConfigList_VS_0[SPI_SpiExternalDevice_SJA1110b] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
/* Spi_apJobConfigList_VS_0 Job Configuration of Spi*/
static const Spi_JobsCfgType Spi_aJobConfigList_VS_0[3] =
{
    {
    /* SpiJob_SJA1105Q */
    /* SpiJob_SJA1105Q */
    &Spi_JobConfig_SpiJob_SJA1105Q_VS_0
    },
    {
    /* SpiJob_SJA1110a */
    /* SpiJob_SJA1110a */
    &Spi_JobConfig_SpiJob_SJA1110a_VS_0
    },
    {
    /* SpiJob_SJA1110b */
    /* SpiJob_SJA1110b */
    &Spi_JobConfig_SpiJob_SJA1110b_VS_0
    }
...
static const Spi_JobType Spi_SpiEthSwtSJA1105QSequence_JobAssignment_VS_0[1] = {SpiConf_SpiJob_SpiJob_SJA1105Q};
static const Spi_JobType Spi_SpiSequence_SJA1110a_JobAssignment_VS_0[1] = {SpiConf_SpiJob_SpiJob_SJA1110a};
static const Spi_JobType Spi_SpiSequence_SJA1110b_JobAssignment_VS_0[1] = {SpiConf_SpiJob_SpiJob_SJA1110b};
/* Configuration of Sequences */

/* Sequence Configuration of SpiEthSwtSJA1105QSequence_VS_0 */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiEthSwtSJA1105QSequence_VS_0 =
{
        /* SpiEthSwtSJA1105QSequence */
        (Spi_JobType)1U,
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_SpiEthSwtSJA1105QSequence_JobAssignment_VS_0, /* List of Jobs */
...
/* Sequence Configuration of SpiSequence_SJA1110a_VS_0 */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiSequence_SJA1110a_VS_0 =
{
        /* SpiSequence_SJA1110a */
        (Spi_JobType)1U,
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_SpiSequence_SJA1110a_JobAssignment_VS_0, /* List of Jobs */
        NULL_PTR, /* End Notification */
        (uint8)FALSE /* Interruptible */
                #if ((SPI_DMA_USED == STD_ON) && (SPI_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
        , (boolean)FALSE /* Enable Dma fast transfer */
...
/* Sequence Configuration of SpiSequence_SJA1110b_VS_0 */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiSequence_SJA1110b_VS_0 =
{
        /* SpiSequence_SJA1110b */
        (Spi_JobType)1U,
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_SpiSequence_SJA1110b_JobAssignment_VS_0, /* List of Jobs */
        NULL_PTR, /* End Notification */
        (uint8)FALSE /* Interruptible */
                #if ((SPI_DMA_USED == STD_ON) && (SPI_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
        , (boolean)FALSE /* Enable Dma fast transfer */
...
static const Spi_SeqsConfigType Spi_aSequenceConfigList_VS_0[3] =
{
    {
    /* SpiEthSwtSJA1105QSequence */
    /* SpiEthSwtSJA1105QSequence */
    &Spi_SequenceConfig_SpiEthSwtSJA1105QSequence_VS_0
    },
    {
    /* SpiSequence_SJA1110a */
    /* SpiSequence_SJA1110a */
    &Spi_SequenceConfig_SpiSequence_SJA1110a_VS_0
    },
    {
    /* SpiSequence_SJA1110b */
    /* SpiSequence_SJA1110b */
    &Spi_SequenceConfig_SpiSequence_SJA1110b_VS_0
    }
};
...
{
    3U, /* u16MaxExternalDevice - number of external devices */
