...
[!IF "node:value(../../../MclGeneral/MclDma/MclEnableCrc)"!][!//
    /* boolean EnSwapBit; */               (boolean)[!IF "node:value(dmaLogicInstance_DmaCrc/dmaLogicInstance_DmaCrcEnSwapBit)"!]TRUE[!ELSE!]FALSE[!ENDIF!],
    /* boolean EnSwapByte; */              (boolean)[!IF "node:value(dmaLogicInstance_DmaCrc/dmaLogicInstance_DmaCrcEnSwapByte)"!]TRUE[!ELSE!]FALSE[!ENDIF!],
    /* boolean EnGlobal; */                (boolean)[!IF "node:value(dmaLogicInstance_DmaCrc/dmaLogicInstance_DmaCrcEnGlobal)"!]TRUE[!ELSE!]FALSE[!ENDIF!],
[!ENDIF!][!//
};
...
[!MACRO "Dma_Ip_Logic_Channel_Crc_Config","Type"!][!//
[!NOCODE!][!//
[!CODE!][!//
[!IF "node:value(./MclGeneral/MclDma/MclEnableCrc)"!][!//
[!LOOP "./MclConfig/dmaLogicChannel_Type/*"!][!//
[!IF "node:value(dmaLogicChannel_EnableCrcConfig)"!][!//
/* DMA Logic Channel [!"@index"!] */
const Dma_Ip_CrcConfigType LogicChannel[!"@index"!]CrcConfig[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
{
    /* uint8 HwCrcChId; */      [!"node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_HwCrcChId)"!],
    /* uint8 Mode; */           [!"node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_CrcMode)"!],
    /* uint8 Polynomial; */     [!"node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_CrcPolynomial)"!],
    /* uint32 InitValue; */     [!"num:i(node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_CrcInitialValue))"!],
    /* boolean EnInitSel; */    (boolean)[!IF "node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_CrcEnInitSel)"!]TRUE[!ELSE!]FALSE[!ENDIF!],
    /* boolean EnLogic; */      (boolean)[!IF "node:value(dmaLogicChannel_ConfigType/dmaLogicChannel_CrcConfigType/dmaLogicChannel_CrcEnLogic)"!]TRUE[!ELSE!]FALSE[!ENDIF!],
};
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDIF!][!//
...
[!IF "node:value(../../../MclGeneral/MclDma/MclEnableCrc)"!][!//
    [!IF "node:value(dmaLogicChannel_EnableCrcConfig)"!]&LogicChannel[!"@index"!]CrcConfig[!"$Type"!][!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!][!ELSE!]NULL_PTR[!ENDIF!],
[!ENDIF!][!//
};
[!ENDLOOP!][!//
