...
*/
#define SpiConf_SpiChannel_SpiChannel_SJA1105Q    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_SpiChannel_SJA1110a    ((Spi_ChannelType)1)
#define SpiConf_SpiChannel_SpiChannel_SJA1110b    ((Spi_ChannelType)2)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_SpiJob_SJA1105Q   ((Spi_JobType)0)
#define SpiConf_SpiJob_SpiJob_SJA1110a   ((Spi_JobType)1)
#define SpiConf_SpiJob_SpiJob_SJA1110b   ((Spi_JobType)2)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiEthSwtSJA1105QSequence   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_SJA1110a   ((Spi_SequenceType)1)
#define SpiConf_SpiSequence_SpiSequence_SJA1110b   ((Spi_SequenceType)2)
...
*/
#define SPI_SpiExternalDevice_SJA1105Q  ((Spi_ExternalDeviceType)0u)
#define SPI_SpiExternalDevice_SJA1110a  ((Spi_ExternalDeviceType)1u)
#define SPI_SpiExternalDevice_SJA1110b  ((Spi_ExternalDeviceType)2u)
