...
strcmp/10 (strcmp) @07035d20
  ...
  Calls: 
fs_bytes_left/9 (fs_bytes_left) @070358c0
...
file__index_html/6 (file__index_html) @07036090
...
file__404_html/5 (file__404_html) @06f31e58
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
file__img_sics_gif/4 (file__img_sics_gif) @06f31f78
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__index_html/3 (data__index_html) @06f31ea0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__404_html/2 (data__404_html) @06f31d80
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__img_sics_gif/1 (data__img_sics_gif) @06f31c60
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
...
;; Function fs_open (fs_open, funcdef_no=1, decl_uid=6444, cgraph_uid=2, symbol_order=7)
...
;; Function fs_close (fs_close, funcdef_no=2, decl_uid=6446, cgraph_uid=3, symbol_order=8)
...
;; Function fs_bytes_left (fs_bytes_left, funcdef_no=3, decl_uid=6448, cgraph_uid=4, symbol_order=9)
