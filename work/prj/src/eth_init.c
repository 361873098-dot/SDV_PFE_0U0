...
#ifdef USE_SERDES_DRIVER
    #include "Serdes.h"
#endif /* USE_SERDES_DRIVER */
...
==================================================================================================*/
#ifdef USE_SJA1105P_DRIVER
    extern ISR(Spi_Ip_SPI_4_IRQHandler);
    extern ISR(Spi_Ip_SPI_5_IRQHandler);
#endif /* USE_SJA1105P_DRIVER */
...
{
#ifdef USE_SJA1105P_DRIVER
    sys_registerIsrHandler(89,&Spi_Ip_SPI_4_IRQHandler);
    sys_enableIsrSource(89, 0x0F);

    sys_registerIsrHandler(90,&Spi_Ip_SPI_5_IRQHandler);
    sys_enableIsrSource(90, 0x0F);
#endif /* USE_SJA1105P_DRIVER */
...
/******************************************************************************/
/* MCU - initialize clock muxes to enable SERDES clocks to EMACs            */
/******************************************************************************/
    ...
    NXP_LOG_INFO("Performance measurement of the serdes initialization for RTD serdes driver: %ums\n", (uint_t)time1_ms);
