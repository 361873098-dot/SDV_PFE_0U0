...
2. Installation steps
    2.1 Hardware installation
        ...
        2.2.2 Connections
            N/A
        2.2.3 Debugger
            - The debugger must be connected to J48 20-pin JTAG for S32G Debug connector.
...
3. Building the example application
    ...
    3.3 Running the application on the board
        To execute the example application from your command line to execute: make run. For executing the script in a T32 window already open the paths from run.cmm need to be changed relative to the debug folder instead of the example root folder.
