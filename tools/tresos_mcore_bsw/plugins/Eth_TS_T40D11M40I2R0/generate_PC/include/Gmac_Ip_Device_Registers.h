...
/**
*   @file
*   @implements Gmac_Ip_Device_Registers.h_Artifact
...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    [!IF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32k3')"!][!//
    [!CODE!]
    #define MAC_VLAN_TAG_DATA       MAC_VLAN_TAG.MAC_VLAN_TAG_DATA
    #define MAC_VLAN_TAG_CTRL       MAC_VLAN.MAC_VLAN_TAG_CTRL
    #define MAC_VLAN_INCL           MAC_VLAN_INCL
    [!ENDCODE!]
    [!ELSEIF "contains(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative, 's32g3')"!][!//
    [!CODE!]
    ...
    [!ELSE!][!//
    [!CODE!]
    #define MAC_VLAN_TAG_DATA       MAC_VLAN_TAG_DATA
    #define MAC_VLAN_TAG_CTRL       MAC_VLAN_TAG_CTRL
    #define MAC_VLAN_INCL           MAC_VLAN_INCL
    [!ENDCODE!]
    [!ENDIF!][!//
